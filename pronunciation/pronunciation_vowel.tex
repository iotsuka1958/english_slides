...
\LARGE
\hfill{\tiny 04373}\,{\scriptsize \myaudio{./audio/vowel_ei_01.mp3}}
...
\LARGE
\hfill{\tiny 0513}\,{\scriptsize \myaudio{./audio/vowel_long_o_01.mp3}}
...
\LARGE
\hfill{\tiny 0506}\,{\scriptsize \myaudio{./audio/vowel_ou_01.mp3}}
...
boat（ボート）またはbought（buyの過去形）を発音していきます。どちらを発音したか聞き取って線でつなぎましょう
...
%%%%%%%%%%%%%%%%%%%%%%%%
\begin{frame}[plain]{Quiz 6}\large
coat（コート）またはcaught（catchの過去形）を発音していきます。どちらを発音したか聞き取って線でつなぎましょう

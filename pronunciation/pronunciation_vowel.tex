...
\LARGE
\begin{enumerate}
 \item \visible<2->{cap}\hfill\visible<3->{\textcolor{NavyBlue}{\bfseries T}}\hspace{200pt}\mbox{}
 \item \visible<4->{cup}\hfill\visible<5->{\textcolor{Maroon}{\bfseries F}}\hspace{200pt}\mbox{}
 \item \visible<6->{cat}\hfill\visible<7->{\textcolor{NavyBlue}{\bfseries T}}\hspace{200pt}\mbox{}
\end{enumerate}
\end{frame}
%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
\LARGE
\begin{enumerate}
 \item \visible<2->{map}\hfill\visible<3->{\textcolor{NavyBlue}{\bfseries T}}\hspace{200pt}\mbox{}
 \item \visible<4->{hand}\hfill\visible<5->{\textcolor{NavyBlue}{\bfseries T}}\hspace{200pt}\mbox{}
 \item \visible<6->{come}\hfill\visible<7->{\textcolor{Maroon}{\bfseries F}}\hspace{200pt}\mbox{}
\end{enumerate}
\end{frame}
%%%%%%%%%%%%%%%%%%%%%%%%%%%
% 背景色を黒に変更
...
\LARGE
\begin{enumerate}
 \item \visible<2->{job}\hfill\visible<3->{\textcolor{NavyBlue}{\bfseries T}}\hspace{200pt}\mbox{}
 \item \visible<4->{map}\hfill\visible<5->{\textcolor{Maroon}{\bfseries F}}\hspace{200pt}\mbox{}
 \item \visible<6->{shop}\hfill\visible<7->{\textcolor{NavyBlue}{\bfseries T}}\hspace{200pt}\mbox{}
\end{enumerate}
\end{frame}
%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%

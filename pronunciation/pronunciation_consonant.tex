...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
{
\IfFileExists{./images/fireworls.jpg}{%
...
\setbeamercolor{background canvas}{bg=}
%%%%%%%%%%%%%%%%%%%%%%%%%%
 \begin{frame}[plain]{破擦音\textipa{/tS/と\textipa{/dZ/}}}
...
\Large
{\small \textipa{/tS/}の音を含む英単語}\hfill\myaudio{./audio/consonant_ttextesh_dtextyogh_02.mp3}
...
\Large
{\small \textipa{/dZ/}の音を含む英単語}\hfill\myaudio{./audio/consonant_ttextesh_dtextyogh_03.mp3}
...
\setbeamercolor{background canvas}{bg=}
%%%%%%%%%%%%%%%%%%%%%%%%%%
 \begin{frame}[plain]{破擦音\textipa{/ts/}\,\,\,\textipa{/dz/}}
...
\end{itemize}
\hfill\myaudio{./audio/consonant_ts_dz_01.mp3}
\end{frame}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\begin{frame}[plain]{実際の単語で確認しよう \textipa{/ts/}}
\Large
{\small \textipa{/ts/}の音を含む英単語}\hfill\myaudio{./audio/consonant_ts_dz_02.mp3}
...
\begin{frame}[plain]{実際の単語で確認しよう \textipa{/dz/}}
\Large
{\small \textipa{/dz/}の音を含む英単語}\hfill\myaudio{./audio/consonant_ts_dz_03.mp3}
...
\hfill\myaudio{./audio/consonant_ts_dz_04.mp3}
...
\hfill\myaudio{./audio/consonant_ts_dz_05.mp3}
...
\hfill\myaudio{./audio/consonant_ts_dz_06.mp3}
...
\hfill{\scriptsize \myaudio{./audio/consonant_ts_dz_07.mp3}}
...
\hfill{\scriptsize \myaudio{./audio/consonant_ts_dz_08.mp3}}
...
\textipa{/m/}\hfill{}マ行の子音部が\textipa{/m/} $\longleftarrow$\,たったこれだけ
...
\myaudio{./audio/consonant_m_n_ng_01.mp3}%
\hfill%
\hypertarget{tips}{}
...
\textipa{/n/}\hfill{}ナヌネノの子音部が\textipa{/n/} $\longleftarrow$\,でもニはだめ
...
\myaudio{./audio/consonant_m_n_ng_02.mp3}%
\end{frame}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
 \begin{frame}[plain]{鼻音\,\,\textipa{/m/}\,\,\,\,\textipa{/n/}\,\,\,\,\textipa{/N/}}
...
\myaudio{./audio/consonant_m_n_ng_03.mp3}%
\end{frame}
%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%
\begin{frame}[plain]{Quiz 1}\large

some（いくつかの）とsun（太陽）を発音していきます。どちらを発音したか聞き取って線でつなぎましょう
...
%%%%%%%%%%%
   \begin{column}{.45\textwidth}
    \begin{tabular}{ll}
     \myAnch{a1}{white}{\textbullet}& some\\
     &\\
     \myAnch{a2}{white}{\textbullet}& sun \\
    \end{tabular}
   \end{column}
 \end{columns}
...
\hfill\myaudio{./audio/consonant_m_n_ng_04.mp3}
...
%%%%%%%%%%%
   \begin{column}{.45\textwidth}
    \begin{tabular}{ll}
     \myAnch{a1}{white}{\textbullet}& win\\
     &\\
     \myAnch{a2}{white}{\textbullet}& wing \\
    \end{tabular}
   \end{column}
 \end{columns}

\begin{tikzpicture}[remember picture, overlay]
 \visible<2->{\draw[ultra thick, Maroon, ->] (q1.east) to[out=0, in=180] (a1.west);}
 \visible<3->{\draw[ultra thick, NavyBlue, ->] (q2.east) to[out=0, in=180] (a2.west);}
 \visible<4->{\draw[ultra thick, Maroon, ->] (q3.east) to[out=0, in=180] (a1.west);}
 \visible<5->{\draw[ultra thick, Maroon, ->] (q4.east) to[out=0, in=180] (a1.west);}
 \visible<6->{\draw[ultra thick, NavyBlue, ->] (q5.east) to[out=0, in=180] (a2.west);}
\end{tikzpicture}

\hfill\myaudio{./audio/consonant_m_n_ng_05.mp3}
...
\begin{tikzpicture}[remember picture, overlay]
 \visible<2->{\draw[ultra thick, NavyBlue, ->] (q1.east) to[out=0, in=180] (a2.west);}
 \visible<3->{\draw[ultra thick, Maroon, ->] (q2.east) to[out=0, in=180] (a3.west);}
 \visible<4->{\draw[ultra thick, olive, ->] (q3.east) to[out=0, in=180] (a1.west);}
 \visible<5->{\draw[ultra thick, Maroon, ->] (q4.east) to[out=0, in=180] (a3.west);}
 \visible<6->{\draw[ultra thick, NavyBlue, ->] (q5.east) to[out=0, in=180] (a2.west);}
 \visible<7->{\draw[ultra thick, olive, ->] (q6.east) to[out=0, in=180] (a1.west);}
\end{tikzpicture}

\hfill\myaudio{./audio/consonant_m_n_ng_06.mp3}
...
\setbeamercolor{background canvas}{bg=}
%%%%%%%%%%%%%%%%%%%%%%%%%%
\begin{frame}[plain]{\textipa{/l/}\,\,\,\textipa{/r/}}
...
\begin{description}
 ...
 \item[\textipa{/r/}] 舌を口の中で少し浮かせる（歯に触れない）
\end{description}
\hfill\myaudio{./audio/consonant_r_l_01.mp3}
\end{frame}
%%%%%%%%%%%%%%%%%%%%%%%%%%
\begin{frame}[plain]{実際の単語で確認しよう \textipa{/l/}}
\LARGE
\hfill{\scriptsize \myaudio{./audio/consonant_r_l_02.mp3}}
...
\hfill\makebox[80pt][l]{\textipa{/\textcolor{BurntOrange}{l}\'aIt/}}\hspace{150pt}\mbox{}
 \item \textcolor{NavyBlue}{\bfseries l}ive
\hfill\makebox[80pt][l]{\textipa{/\textcolor{BurntOrange}{l}\'Iv/}}\hspace{150pt}\mbox{}
...
\LARGE
\hfill{\scriptsize \myaudio{./audio/consonant_r_l_03.mp3}}
...
\hfill\makebox[80pt][l]{\textipa{/\textcolor{BurntOrange}{r}\'ON/}}\hspace{150pt}\mbox{}
 \item \textcolor{NavyBlue}{\bfseries r}oom
\hfill\makebox[80pt][l]{\textipa{/\textcolor{BurntOrange}{r}\'u:m/}}\hspace{150pt}\mbox{}

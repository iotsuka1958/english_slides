...
%\setbeamercolor{background canvas}{bg=}
%%%%%%%%%%%%%%%%%
\begin{frame}[plain]{20250225}
 \Large
\centering
\pause
\vfill
きょう$20250225$が素数じゃないのはあきらか\pause
...
\hfill{\scriptsize \myaudio{./audio/consonant_m_n_ng_04.mp3}}
...
\setbeamercolor{background canvas}{bg=}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\begin{frame}[plain]{２つのl}
\hypertarget{tips}{}

 \begin{description}
 \item[\textipa{/l/}] \underLine{l}ook\hspace{1\zw}\underLine{l}ight\hspace{1\zw}\underLine{l}ong\hspace{1\zw}\underLine{l}ake\hspace{1\zw}\underLine{l}ate
 \item[最後の\textipa{/l/}]beautifu\underLine{l}\hspace{1\zw}gir\underLine{l}\hspace{1\zw}peop\underLine{l}e\hspace{1\zw}tab\underLine{l}e\hspace{1\zw}app\underLine{l}e
\end{description}

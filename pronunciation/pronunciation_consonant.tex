...
\raggedleft
 \textcolor{white}{\LARGE\bfseries 2024-09-20}
...
\vfill
\raggedleft
 \textcolor{white}{\Large\bfseries 2024-09-19}
...
\large
発音記号\textipa{/p/}で示した音声が含まれていたらT、含まれていなければFと答えてください
 \begin{enumerate}
...
\begin{frame}[plain]{Quiz}
\large
発音記号\textipa{/b/}で示した音声が含まれていたらT、含まれていなければFと答えてください
 \begin{enumerate}
...
\begin{frame}[plain]{Quiz}
\large
発音記号\textipa{/t/}で示した音声が含まれていたらT、含まれていなければFと答えてください
 \begin{enumerate}
...
\begin{frame}[plain]{Quiz}
\large
発音記号\textipa{/d/}で示した音声が含まれていたらT、含まれていなければFと答えてください
 \begin{enumerate}
...
\begin{frame}[plain]{Quiz}
\large
発音記号\textipa{/k/}で示した音声が含まれていたらT、含まれていなければFと答えてください
 \begin{enumerate}
...
\begin{frame}[plain]{Quiz}
\large
発音記号\textipa{/g/}で示した音声が含まれていたらT、含まれていなければFと答えてください
 \begin{enumerate}
...
\begin{frame}[plain]{Quiz}
\large
発音記号\textipa{/f/}で示した音声が含まれていたらT、含まれていなければFと答えてください
 \begin{enumerate}
...
\begin{frame}[plain]{Quiz}
\large
発音記号\textipa{/v/}で示した音声が含まれていたらT、含まれていなければFと答えてください
 \begin{enumerate}
...
\begin{frame}[plain]{Quiz}
\large
発音記号\textipa{/s/}で示した音声が含まれていたらT、含まれていなければFと答えてください
 \begin{enumerate}
...
\begin{frame}[plain]{Quiz}
\large
発音記号\textipa{/z/}で示した音声が含まれていたらT、含まれていなければFと答えてください
 \begin{enumerate}

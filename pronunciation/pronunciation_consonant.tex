...
%\textcolor{Yellow}{\large\bfseries 可能なら、ティッシュペーパーを用意しておいてください}
\end{frame}
...
\begin{description}
 \item[母音]<2-> \textipa{/\ae/}\hspace{7pt}
\textipa{/A/}\hspace{7pt}
...
\hfill{\tiny 0205}\,{\scriptsize \myaudio{./audio/consonant_p_b_01.mp3}\,01}
...
%\hypertarget{ex}{}
\Large
 {\small \textipa{/p/}の音を含む英単語}\hfill{\tiny 0433}\,{\scriptsize \myaudio{./audio/consonant_p_b_02.mp3}\,02}

\begin{enumerate}
\item \textcolor{NavyBlue}{\bfseries p}ie
\hfill\makebox[80pt][l]{\textipa{/\textcolor{BurntOrange}{p}\'aI/}}\hspace{150pt}\mbox{}
...
\hfill\makebox[80pt][l]{\textipa{/\textcolor{BurntOrange}{p}\'en/}}\hspace{150pt}\mbox{}
 \item \textcolor{NavyBlue}{\bfseries p}eace
\hfill\makebox[80pt][l]{\textipa{/\textcolor{BurntOrange}{p}\'\i:s /}}\hspace{150pt}\mbox{}
 \item cu\textcolor{NavyBlue}{\bfseries p}
\hfill\makebox[80pt][l]{\textipa{/k\'\textturnv\textcolor{BurntOrange}{p}/}}\hspace{150pt}\mbox{}
 \item ma\textcolor{NavyBlue}{\bfseries p}
\hfill\makebox[80pt][l]{\textipa{/m\'\ae\textcolor{BurntOrange}{p}/}}\hspace{150pt}\mbox{}
...
%\hypertarget{ex}{}
\Large
{\small \textipa{/b/}の音を含む英単語}\hfill{\tiny 0506}\,{\scriptsize \myaudio{./audio/consonant_p_b_03.mp3}\,03}
...
\hfill{\tiny 0146}\,{\scriptsize \myaudio{./audio/consonant_p_b_04.mp3}\,04}
\end{frame}
%%%%%%%%%%%%%%%%%%%%%%%%%%
...
\hfill{\tiny 0144}\,{\scriptsize \myaudio{./audio/consonant_p_b_05.mp3}\,05}
\end{frame}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\setbeamercolor{background canvas}{bg=}
%%%%%%%%%%%%%%%%%%%%%%%%%%
...
\begin{enumerate}
 \item<2->  無声音 \textipa{/t/}\hspace{20pt}\visible<4->{\underLine{t}able,\hspace{1\zw}mee\underLine{t},\hspace{1\zw}\underLine{t}oma\underLine{t}o}
 \item<3->  有声音 \textipa{/d/}\hspace{18pt}\visible<5->{\underLine{d}ance,\hspace{1\zw}ba\underLine{d},\hspace{1\zw}\underLine{d}iamon\underLine{d}}
...
\begin{itemize}\setbeamertemplate{items}[circle]
 \item<7-> 舌の先を上の歯茎にしっかりとつける
 \item<8-> そのあとに舌の先を離して、いきおいよく息を口から外へ出す
 \end{itemize}

\visible<9->{\textipa{/t/}はタの子音、}
\visible<10->{\textipa{/d/}はダの子音}

\hfill{\tiny 0207}\,{\scriptsize \myaudio{./audio/consonant_t_d_01.mp3}\,01}

\hfill\hyperlink{ex}{\beamergotobutton{Today's Exercises}}
\end{frame}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\begin{frame}[plain]{実際の単語で確認しよう \textipa{/t/}}
%\hypertarget{ex}{}
\Large
{\small \textipa{/t/}の音を含む英単語}\hfill{\tiny 0504}\,{\scriptsize \myaudio{./audio/consonant_t_d_02.mp3}\,02}
...
\item mee\textcolor{NavyBlue}{\bfseries t} /  mea\textcolor{NavyBlue}{\bfseries t}\hfill\makebox[80pt][l]{\textipa{/m\'\i:\textcolor{BurntOrange}{t}/}}\hspace{150pt}\mbox{} 
...
\hfill{\tiny 0135}\,{\scriptsize \myaudio{./audio/consonant_t_d_04.mp3}\,04}
...
発音記号\textipa{/d/}で示した音声が含まれていたらT、含まれていなければFと答えてください\hfill{}{\scriptsize T: true（正しい）\hspace{5pt} F: false（まちがい）}
 \begin{enumerate}
  ...
  \item \mbox{}\visible<5->{F}\hspace{1\zw}\visible<10->{meet / meat}
  \item \mbox{}\visible<6->{T}\hspace{1\zw}\visible<11->{good}
 \end{enumerate}

\hfill{\tiny 0144}\,{\scriptsize \myaudio{./audio/consonant_t_d_05.mp3}\,05}
\end{frame}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\section{だいじな寄り道}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
\end{enumerate}
\hfill{\tiny 0111}\,{\scriptsize \myaudio{./audio/consonant_jap_accent_01.mp3}\,{\tiny jap\_accent\_01}}

\vspace*{-5pt}

\hfill{\tiny 0225}\,{\scriptsize \myaudio{./audio/consonant_jap_accent_02.mp3}\,{\tiny jap\_accent\_02}}
...
\textipa{/k/} はカ行の子音、\textipa{/g/}はガ行の子音

\hfill\hyperlink{ex}{\beamergotobutton{Today's Exercises}}


\hfill{\tiny 0206}\,{\scriptsize \myaudio{./audio/consonant_k_g_01.mp3}\,{\tiny k\_g\_01}}
\end{frame}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\begin{frame}[plain]{実際の単語で確認しよう}
%\hypertarget{ex}{}
\Large
{\small \textipa{/k/}の音を含む英単語}\hfill{\tiny 0509}\,{\scriptsize \myaudio{./audio/consonant_k_g_02.mp3}\,{\tiny k\_g\_02}}
\pause
...
%\hypertarget{ex}{}
\Large
{\small \textipa{/g/}の音を含む英単語}\hfill{\tiny 0509}\,{\scriptsize \myaudio{./audio/consonant_k_g_03.mp3}\,{\tiny k\_g\_03}}\pause
...
\hfill{\tiny 0146}\,{\scriptsize \myaudio{./audio/consonant_k_g_04.mp3}\,{\tiny k\_g\_04}}
\end{frame}
%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
\hfill{\tiny 0145}\,{\scriptsize \myaudio{./audio/consonant_k_g_05.mp3}\,{\tiny k\_g\_05}}
\end{frame}
%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%
%% /f/ /v/
...
\hfill{}{\scriptsize T: true（正しい）\hspace{5pt} F: false（まちがい）}
 \begin{enumerate}
  \item \mbox{}\visible<2->{T}\hspace{1\zw}\visible<7->{there / their / they're}
...
mouseまたはmouthを発音していきます。どちらを発音したか聞き取って線でつなぎましょう
...
\bigskip
 ...
 \begin{columns}[t]
   \begin{column}{.45\textwidth}
    \begin{tabular}{rlr}
     1& \visible<2->{mouse}&\myAnch{q1}{white}{\textbullet} \\
     2& \visible<3->{mouth}&\myAnch{q2}{white}{\textbullet} \\
     3& \visible<4->{mouse}&\myAnch{q3}{white}{\textbullet} \\
     4& \visible<5->{mouth}&\myAnch{q4}{white}{\textbullet} \\
     5& \visible<6->{mouth}&\myAnch{q5}{white}{\textbullet} \\
     6& \visible<7->{mouse}&\myAnch{q6}{white}{\textbullet} 
    \end{tabular}
   \end{column}
%%%%%%%%%%%
   \begin{column}{.45\textwidth}
    \begin{tabular}{lll}
     \myAnch{a1}{white}{\textbullet}& mouse &\textipa{/m\'aUs/}\\
     &\\
     \myAnch{a2}{white}{\textbullet}& mouth &\textipa{/m\'aUT/}\\
    \end{tabular}
   \end{column}
 \end{columns}
...
\hfill{\tiny 0142}\,{\scriptsize \myaudio{./audio/consonant_mouse_mouth_01.mp3}}
...
freeまたはthreeを発音していきます。どちらを発音したか判断してください
...
\hfill{}{\scriptsize T: true（正しい）\hspace{5pt} F: false（まちがい）}
 \begin{enumerate}
  ...
  \item \mbox{}\visible<3->{F}\hspace{1\zw}\visible<8->{sea / see / C }
...
\hfill{\tiny 0136}\,{\scriptsize \myaudio{./audio/consonant_textesh_textyogh_05.mp3}}
\end{frame}
%%%%%%%%%%%%%%%%%%%%%%%%
\begin{frame}[plain]{Quiz\hspace{10pt}\textipa{/s/} と \textipa{/S/}}
\large

seaまたはsheを発音していきます。どちらを発音したか聞き取りましょう
...
%%%%%%%%%%%
   \begin{column}{.45\textwidth}
    \begin{tabular}{lll}
     \myAnch{a1}{white}{\textbullet}& sea &\textipa{/s\'\i:/}\\
     &\\
...
\hfill{\tiny 0155}\,{\scriptsize \myaudio{./audio/consonant_sea_she_01.mp3}}
...
sitまたはshitを発音していきます。どちらを発音したか判断してください
...
\bigskip
 ...
 \begin{columns}[t]
   \begin{column}{.45\textwidth}
    \begin{tabular}{rlr}
     1& \visible<2->{shit}&\myAnch{q1}{white}{\textbullet} \\
     2& \visible<3->{sit}&\myAnch{q2}{white}{\textbullet} \\
     3& \visible<4->{sit}&\myAnch{q3}{white}{\textbullet} \\
     4& \visible<5->{shit}&\myAnch{q4}{white}{\textbullet} \\
     5& \visible<6->{sit}&\myAnch{q5}{white}{\textbullet} \\
     6& \visible<7->{shit}&\myAnch{q6}{white}{\textbullet} 
    \end{tabular}
   \end{column}
%%%%%%%%%%%
   \begin{column}{.45\textwidth}
    \begin{tabular}{lll}
     \myAnch{a1}{white}{\textbullet}& sit &\textipa{/s\'It/}\\
     &\\
     \myAnch{a2}{white}{\textbullet}& shit& \textipa{/S\'It/}  \\
    \end{tabular}
   \end{column}
 \end{columns}
...
\hfill{\small shitは品のないことばなので、決して口にしないようにしましょう}

\hfill{\tiny 0138}\,{\scriptsize \myaudio{./audio/consonant_sit_shit_01.mp3}}

\end{frame}
%%%%%%%%%%%%%%%%%%%%%%%%%%
\begin{frame}[plain]{Quiz}\large

seat（座席）またはsheet（シーツ）を発音していきます。どちらを発音したか判断しましょう
...
\bigskip
 ...
 \begin{columns}[t]
   \begin{column}{.45\textwidth}
    \begin{tabular}{rlr}
     1& \visible<2->{seat}&\myAnch{q1}{white}{\textbullet} \\
     2& \visible<3->{sheet}&\myAnch{q2}{white}{\textbullet} \\
     3& \visible<4->{seat}&\myAnch{q3}{white}{\textbullet} \\
     4& \visible<5->{sheet}&\myAnch{q4}{white}{\textbullet} \\
     5& \visible<6->{sheet}&\myAnch{q5}{white}{\textbullet} \\
     6& \visible<7->{seat}&\myAnch{q6}{white}{\textbullet} 
    \end{tabular}
   \end{column}
%%%%%%%%%%%
   \begin{column}{.45\textwidth}
    \begin{tabular}{lll}
     ...
     &\\
     \myAnch{a2}{white}{\textbullet}& sheet &\textipa{/S\'\i:t/}\\
    \end{tabular}
   \end{column}
 \end{columns}
...
\hfill{\scriptsize a \textbf{sheet} of paper / two \textbf{sheets} of paper}

\hfill{\scriptsize \myaudio{./audio/consonant_seat_sheet_01.mp3}}
...
suit（スーツ）またはshoot（撃つ）を発音していきます。どちらを発音したか判断してください
...
\bigskip
 ...
 \begin{columns}[t]
   \begin{column}{.45\textwidth}
    \begin{tabular}{rlr}
     1& \visible<2->{shoot}&\myAnch{q1}{white}{\textbullet} \\
     2& \visible<3->{suit}&\myAnch{q2}{white}{\textbullet} \\
     3& \visible<4->{suit}&\myAnch{q3}{white}{\textbullet} \\
     4& \visible<5->{shoot}&\myAnch{q4}{white}{\textbullet} \\
     5& \visible<6->{suit}&\myAnch{q5}{white}{\textbullet} \\
     6& \visible<7->{shoot}&\myAnch{q6}{white}{\textbullet} 
    \end{tabular}
   \end{column}
%%%%%%%%%%%
   \begin{column}{.45\textwidth}
    \begin{tabular}{lll}
     \myAnch{a1}{white}{\textbullet}& suit &\textipa{/s\'u:t/}\\
     &\\
     \myAnch{a2}{white}{\textbullet}& shoot& \textipa{/S\'u:t/}  \\
    \end{tabular}
   \end{column}
 \end{columns}
...
\hfill{\tiny 0140}\,{\scriptsize \myaudio{./audio/consonant_suit_shoot_01.mp3}}
...
\setbeamercolor{background canvas}{bg=}
%%%%%%%%%%%%%%%%%%%%%%%%%%
\begin{frame}[plain,label=slide_ttextesh_dtextyogh]{破擦音\textipa{/tS/と\textipa{/dZ/}}}
...
\begin{itemize}\setbeamertemplate{items}[circle]
 ...
 \item 舌先を歯茎につけてから破裂させます（\textipa{/S/}や\textipa{/Z/}は舌がどこにもつきません）
...
carsまたはcardsを発音していきます。どちらを発音したか判断しましょう
...
\hfill{\tiny 0432}\,{\scriptsize \myaudio{./audio/consonant_m_n_ng_01.mp3}}
\end{frame}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
 \begin{frame}[plain]{鼻音\,\,\textipa{/n/}}
...
\hfill{\tiny 0432}\,{\scriptsize \myaudio{./audio/consonant_m_n_ng_02.mp3}}
%\hfill%
%\hypertarget{tips}{}
\end{frame}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
\end{description}
\hfill{\tiny 0306}\,\myaudio{./audio/consonant_l_r_01.mp3}
\end{frame}
%%%%%%%%%%%%%%%%%%%%%%%%%%
\begin{frame}[plain]{実際の単語で確認しよう \textipa{/l/}}
%\hypertarget{ex}{}
\textipa{/l/}\hspace{20pt}舌先を上の前歯の後ろにベタっとつけます%
\hfill\hfill{\tiny 0431}\,{\scriptsize \myaudio{./audio/consonant_l_r_02.mp3}}
\LARGE
\begin{enumerate}
...
\hfill\hfill{\tiny 0433}\,{\scriptsize \myaudio{./audio/consonant_l_r_03.mp3}}
\LARGE
\begin{enumerate}
...
\hfill\hfill{\tiny 0236}\,{\scriptsize \myaudio{./audio/consonant_l_r_04.mp3}}
...
\hfill\hfill{\tiny 0134}\,{\scriptsize \myaudio{./audio/consonant_l_r_05.mp3}}
...
\Large 
 ...
 \end{enumerate}
\hfill\hfill{\tiny 0237}\,{\scriptsize \myaudio{./audio/consonant_l_r_06.mp3}}
\end{frame}
%%%%%%%%%%%%%%%%%%%%%%%%
\begin{frame}[plain]{Quiz 2}\large
%\hypertarget{ex}{}
...
\hfill\hfill{\tiny 0134}\,\myaudio{./audio/consonant_l_r_07.mp3}
...
\Large 
 ...
 \end{enumerate}
\hfill\hfill{\tiny 0207}\,{\scriptsize \myaudio{./audio/consonant_l_r_08.mp3}}
\end{frame}
%%%%%%%%%%%%%%%%%%%%%%%%
\begin{frame}[plain]{Quiz 3}\large
%\hypertarget{ex}{}
...
\hfill\hfill{\tiny 0137}\,\myaudio{./audio/consonant_l_r_09.mp3}
...
\hfill{\tiny 0712}\,{\scriptsize \myaudio{./audio/consonant_j_01.mp3}}
\end{enumerate}
\end{frame}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
\Huge
\tikz[baseline=(new_ear.base)]{\node[draw, fill=yellow!50] (new_ear) {謹賀新耳};}
\hfill\visible<4->{Happy New ear!}

\visible<2->{\tikz[baseline=(new_year.base)]{\node[draw, fill=yellow!50] (new_year) {謹賀新年};}}
\hfill\visible<3->{Happy New year!}
...
\hfill{\tiny 0204}\,{\scriptsize \myaudio{./audio/consonant_j_02.mp3}}
...
\hfill{\tiny 0150}\,{\scriptsize \myaudio{./audio/consonant_j_03.mp3}}
...
\hfill{\tiny 0708}\,{\scriptsize \myaudio{./audio/consonant_h_01.mp3}}
...
\Large
%\hypertarget{ex}{}
{\small \textipa{/h/}の音を含む英単語}\hfill{\tiny 0543}\,{\scriptsize \myaudio{./audio/consonant_h_02.mp3}}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\begin{frame}[plain]{\textipa{/h/}実際の単語で確認しよう}
{\small \textipa{/h/}の音を含む英単語}\hfill{\tiny 0521}\,{\scriptsize \myaudio{./audio/consonant_h_03.mp3}}
%\hypertarget{ex}{}
...
\begin{frame}[plain]{Quiz}\large
%\hypertarget{ex}{}
heat（熱）またはfeet（足footの複数形）を発音していきます。どちらを発音したか判断してください
...
\bigskip
 ...
 \begin{columns}[t]
   \begin{column}{.45\textwidth}
    \begin{tabular}{rlr}
     1& \visible<2->{heat}&\myAnch{q1}{white}{\textbullet} \\
     2& \visible<3->{feet}&\myAnch{q2}{white}{\textbullet} \\
     3& \visible<4->{heat}&\myAnch{q3}{white}{\textbullet} \\
     4& \visible<5->{feet}&\myAnch{q4}{white}{\textbullet} \\
     5& \visible<6->{feet}&\myAnch{q5}{white}{\textbullet} \\
     6& \visible<7->{heat}&\myAnch{q6}{white}{\textbullet} 
    \end{tabular}
   \end{column}
%%%%%%%%%%%
   \begin{column}{.45\textwidth}
    \begin{tabular}{ll@{　　}l}
     \myAnch{a1}{white}{\textbullet}& heat &\textipa{/h\'\i:t/}\\
     &\\
     \myAnch{a2}{white}{\textbullet}& feet &\textipa{/f\'\i:t/}\\
    \end{tabular}
   \end{column}
 \end{columns}
...
\hfill{\tiny 0127}\,{\scriptsize \myaudio{./audio/consonant_heat_feet_01.mp3}}
\end{frame}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\begin{frame}[plain]
 
\includegraphics[height=1.01\textheight]{./images/nanobanana-output/hoodie_new.png}
...
\begin{frame}[plain]{Quiz}\large
%\hypertarget{ex}{}
hood（頭巾、フード）またはfood（食べ物）を発音していきます。どちらを発音したか判断してください
...
\bigskip
 ...
 \begin{columns}[t]
   \begin{column}{.45\textwidth}
    \begin{tabular}{rlr}
     1& \visible<2->{food}&\myAnch{q1}{white}{\textbullet} \\
     2& \visible<3->{hood}&\myAnch{q2}{white}{\textbullet} \\
     3& \visible<4->{hood}&\myAnch{q3}{white}{\textbullet} \\
     4& \visible<5->{food}&\myAnch{q4}{white}{\textbullet} \\
     5& \visible<6->{hood}&\myAnch{q5}{white}{\textbullet} \\
     6& \visible<7->{food}&\myAnch{q6}{white}{\textbullet} 
    \end{tabular}
   \end{column}
%%%%%%%%%%%
   \begin{column}{.45\textwidth}
    \begin{tabular}{lll}
     \myAnch{a1}{white}{\textbullet}& hood& \textipa{/h\'Ud/}\\
     &\\
     \myAnch{a2}{white}{\textbullet}& food& \textipa{/f\'u:d/}  \\
    \end{tabular}
   \end{column}
 \end{columns}
...
\hfill{}\visible<8->{hoodie \textipa{/h\'Udi/}}



\hfill{\tiny 0128}\,{\scriptsize \myaudio{./audio/consonant_hood_food_01.mp3}}
...
\kenten{わ}たしは、毎日、本\kenten{を}読みます
\pause
...
\begin{enumerate}
 \item 現代の日本語でwの音はワだけ\\
（厳密にいうと日本語のワの子音$=$\textipa{[\textsublhalfring{w}]}
$\longrightarrow$つまり英語の\textipa{/w/}じゃない！）\pause
 \item \textipa{/w/}は唇突き出して丸くすぼめる（はずかしがらないで）\pause
 \item 特に\textipa{/w/}に\kenten{ウ}の類の母音が続くときがやっかい
\end{enumerate}
\end{frame}
%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%
...
\begin{enumerate}
 ...
 \item 口笛を吹くときの要領
\hfill{\tiny 0544}\,{\scriptsize \myaudio{./audio/consonant_w_01.mp3}}

\begin{textblock*}{0.4\linewidth}(250pt,70pt)
\visible<1->{\begin{tikzpicture}
\penguin[
scale=1.6,
speech={\scriptsize \textipa{/w/}},
signpost=\scalebox{0.6}{
\parbox{3cm}{\color{black}
\centering 恥ずかしがらない！\\それがだいじ}},
signcolour= brown!70!gray,
signback=white!80!brown
]
\end{tikzpicture}}
...
\hfill{\tiny 0617}\,{\scriptsize \myaudio{./audio/consonant_dark_l_00.mp3}}

\end{frame}
%%%%%%%%%%%%%%%%%%%%%%%%%%
\begin{frame}[plain]{発音記号}

\underLine{L}ook at the tab\underLine{l}e. 
\hspace{40pt}\visible<2->{どちらのLも同じ発音記号なの？}


 \begin{description}[単語の最後の/l/]
 \item<3->[明るいL] \textipa{/l/} 
 \item<4->[暗いL]   \textipa{/\textltilde/}
\end{description}

\vspace{30pt}

\visible<5->{でも辞書では、明るいLも暗いLも同じ発音記号\textipa{/l/}で表記するのがふつうです}
...
\begin{enumerate}
 \item 唇を丸めて終わる
 \item オとかウみたいな感じ
\hfill{\tiny 0545}\,{\scriptsize \myaudio{./audio/consonant_dark_l_01.mp3}}
...
\begin{enumerate}
 \item 唇を丸めて終わる
 \item オとかウみたいな感じ
\hfill{\tiny 0543}\,{\scriptsize \myaudio{./audio/consonant_dark_l_02.mp3}}
...
\hfill{\tiny 0205}\,{\scriptsize \myaudio{./audio/consonant_time_pie_01.mp3}}

\end{frame}
%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%
\begin{frame}[plain]{Quiz \textipa{/s/ or \textipa{/T/}?}}\large
%\hypertarget{today}{}
singまたはthingを発音していきます。どちらを発音したか判断しましょう
...
\hfill{\tiny 0242}\,{\scriptsize \myaudio{./audio/consonant_sing_thing_01.mp3}}

\end{frame}
%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%
\begin{frame}[plain]{Quiz \textipa{/f/ or \textipa{/T/}?}}\large
%\hypertarget{today}{}
freeまたはthreeを発音していきます。どちらを発音したか判断しましょう
...
\tikzset{hoge/.style = {line width=4pt, ->, opacity=.6}}
 \visible<2->{\draw[hoge, Maroon] (q1.east) to[out=0, in=180] (a2.west);}
 \visible<3->{\draw[hoge, NavyBlue] (q2.east) to[out=0, in=180] (a1.west);j}
 \visible<4->{\draw[hoge, NavyBlue] (q3.east) to[out=0, in=180] (a1.west);}
 \visible<5->{\draw[hoge, Maroon] (q4.east) to[out=0, in=180] (a2.west);}
 \visible<6->{\draw[hoge, NavyBlue] (q5.east) to[out=0, in=180] (a1.west);}
 \visible<7->{\draw[hoge, Maroon] (q6.east) to[out=0, in=180] (a2.west);}
...
\hfill{\tiny 0245}\,\myaudio{./audio/consonant_free_three_01.mp3}

\end{frame}
%%%%%%%%%%%%%%%%%%%%%%%%%%
\begin{frame}[plain]{Quiz \textipa{/S/} or \textipa{/s/}}\large
%\hypertarget{today}{}
sheまたはsea (see / Cと同じ)を発音していきます。どちらを発音したか判断しましょう
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%
\begin{frame}[plain,label=ichiran]{英語の子音}
%\hypertarget{today}{}
\pause

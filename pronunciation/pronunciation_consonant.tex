...
\setbeamercolor{background canvas}{bg=}
%%%%%%%%%%%%%%%%%%%
\begin{frame}[plain]{20241127}
 \Huge
\centering
\pause
\vfill
きょう$20241127$は素数\pause{}ではない！\pause

$23^{2}\times{}83\times{}461$\pause
...
\begin{enumerate}
 \item  無声音 \textipa{/ts/}\hspace{20pt}ca\underLine{ts}\hspace{1\zw}ea\underLine{ts}\hspace{1\zw}si\underLine{ts}
 \item  有声音 \textipa{/dz/}\hspace{20pt}car\underLine{ds}\hspace{1\zw}bir\underLine{ds}\hspace{1\zw}clou\underLine{ds}\hspace{1\zw}soun\underLine{ds}\hspace{1\zw}frien\underLine{ds}\hspace{1\zw}rea\underLine{ds}
\end{enumerate}

...
\begin{description}
 ...
 \item[\textipa{/r/}] 舌を口の中で少し浮かせる（舌はどこにもに触れない）
\end{description}
...
\end{frame}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\begin{frame}[plain]{ear（耳）とyear（年）を区別しよう}
\Large
...
\end{tikzpicture}
 ...
 \begin{enumerate}
  \item ear \textipa{/\'I\textrhookschwa /}
  \item year \textipa{/j\'I\textrhookschwa /}

 \end{enumerate}

\hfill\myaudio{./audio/consonant_j_02.mp3}

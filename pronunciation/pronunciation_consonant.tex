...
\begin{enumerate}
 \item<2-> 無声音 \textipa{/p/}\hspace{20pt}\underLine{p}ig,\hspace{1\zw}cu\underLine{p},\hspace{1\zw}\underLine{p}a\underLine{p}er
 \item<3->  有声音 \textipa{/b/}\hspace{20pt}\underLine{b}ig,\hspace{1\zw}jo\underLine{b},\hspace{1\zw}num\underLine{b}er
\end{enumerate}
...
\begin{itemize}\setbeamertemplate{items}[circle]
 \item<5-> しっかりと口を閉じて、空気が口の外へ漏れないように
 \item<6-> 一気に唇を離して空気をいきおいよく口の外へ出す
 \item<7-> \textipa{/p/と\textipa{/b/}}のちがいは声の有無だけ（口の動きはまったく同じ）
\end{itemize}
}

\bigskip

\visible<2->{\textipa{/p/} はパ行の子音、}\visible<3->{\textipa{/b/} はバ行の子音}

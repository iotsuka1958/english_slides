...
\end{itemize}
\hfill\myaudio{./audio/consonant_textesh_01.mp3}
\end{frame}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\begin{frame}[plain]{実際の単語で確認しよう \textipa{/S/}}
\Large
{\small \textipa{/S/}の音を含む英単語}\hfill\myaudio{./audio/consonant_textesh_02.mp3}
...
\Large
{\small \textipa{/Z/}の音を含む英単語}\hfill\myaudio{./audio/consonant_textesh_03.mp3}
...
\hfill\myaudio{./audio/consonant_textshe_04.mp3}
\end{frame}
%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%
\begin{frame}[plain]{Quiz \textipa{/Z/}}
...
\hfill\myaudio{./audio/consonant_textesh_04.mp3}
\end{frame}
%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%

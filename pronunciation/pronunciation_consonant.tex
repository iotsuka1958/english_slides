...
\setbeamercolor{background canvas}{bg=}
%%%%%%%%%%%%%%%%%%%
\begin{frame}[plain]{20241211}
 \Large
\centering
\pause
\vfill
きょう$20241211$は素数\pause{}です！\pause

%$20241203=17\times{}61\times{}131\times{}149$\pause
...
\begin{tikzpicture}[remember picture, overlay]
 \visible<2->{\draw[thick, orange, ->] (q1.east) to[out=0, in=180] (a2.west);}
 \visible<3->{\draw[thick, olive, ->] (q2.east) to[out=0, in=180] (a1.west);}
 \visible<4->{\draw[thick, olive, ->] (q3.east) to[out=0, in=180] (a1.west);}
 \visible<5->{\draw[thick, orange, ->] (q4.east) to[out=0, in=180] (a2.west);}
 \visible<6->{\draw[thick, olive, ->] (q5.east) to[out=0, in=180] (a1.west);}
\end{tikzpicture}

\hypertarget{ex}{}
\hyperlink{tips}{\beamerreturnbutton{Back to Tips}}\hfill\myaudio{./audio/consonant_ts_dz_05.mp3}
...
\textipa{/s/} $\rightarrow$ \textipa{/z/}

\textipa{/ts/} $\rightarrow$ \textipa{/dz/}

 \begin{enumerate}
  \item rose \textipa{/r\'oU\textcolor{Maroon}{z}/}

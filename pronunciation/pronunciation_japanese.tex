...
\hspace{18pt}\visible<5->{\textipa{/\textltailn /}}

\vspace{20pt}

\normalsize

\visible<2->{\textipa{/m/}じゃない}\\
\visible<3->{\textipa{/N/}じゃない}\\
\visible<4->{\textipa{/n/}じゃない}
 \end{column}
...
\end{frame}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\begin{frame}[plain,t]{\textipa{/\textltailn /}って発音する\Circled{ん}}

\large

\begin{enumerate}[<+->]
 \item こ\Circled{ん}にゃく
 \item 侵入（し\Circled{ん}にゅう）
 \item 筋肉（き\Circled{ん}にく）
 \item 杏仁豆腐（あ\Circled{ん}にんどうふ）
\end{enumerate}

\visible<5->{舌の（先でなく）全体が面として口の天井にべったりくっつく}



\vspace{30pt}

\visible<6->{ちなみに「杏仁豆腐」の二番目の\Circled{ん}は\textipa{/n/}}
...
\hspace{40pt}\visible<7>{{\small 鼻母音\textipa{/\~@/}}}

\vspace{20pt}

\visible<2->{\textipa{/n/}だったら「せねん」}

\visible<3->{\textipa{/m/}だったら「せめん」}

\visible<4->{\textipa{/N/}だったら「せん\scalebox{.5}{げ}ん」}

\vspace{10pt}


\visible<5->{唇はくっつかないし、\\舌はどこにも触れない}
...
\end{frame}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\begin{frame}[plain,t]{鼻母音\textipa{/\~@/}って発音する\Circled{ん}}

\large

\begin{enumerate}[<+->]
 \item 恋愛（れ\Circled{ん}あい）
 \item 単位（た\Circled{ん}い）
 \item 暗雲（あ\Circled{ん}うん）
 \item 禁煙（き\Circled{ん}えん）
 \item 嫌悪（け\Circled{ん}お）
\end{enumerate}

\visible<6->{唇はくっつかないし、舌はどこにも触れない。鼻に抜ける感じ}

\visible<7->{直後が母音だと鼻母音\textipa{/\~@/}になります}
...
\end{frame}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\begin{frame}[plain,t]{\textipa{/\textscn /}って発音する\Circled{ん}}
 
\begin{enumerate}[<+->]
 \item パ\Circled{ン}
 \item プリ\Circled{ン}
 \item トムヤムク\Circled{ン}
 \item ラーメ\Circled{ン}
 \item うど\Circled{ん}
\end{enumerate}

実は\textipa{/m/}でも\textipa{/n/}でも、意思の疎通には問題ない

でも、ふつうは、唇も舌先も、どこにもつかない音
\end{frame}

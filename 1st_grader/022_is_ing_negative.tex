...
否定を表すことば： {\LARGE\bfseries not}\hspace{20pt}\visible<2->{\textipa{/n\'At/}}
...
\end{enumerate}
 \end{frame}
%%%%%%%%%%%%%%%%%%%%%%
\section{Listen, Then Read\,\,\,\,\,{\tiny 0029}\,{\scriptsize \myaudio{./audio/022_is_ing_negative_reading.mp3}}}
%%%%%%%%%%%%%%%%%%%%%%
\begin{frame}[plain,t]{Exercises --- True or False? ---} 
\vspace*{-8pt}
\begin{tcolorbox}[colframe=ForestGreen, colback=NavyBlue!10!white, colbacktitle=NavyBlue!40!white,
 coltitle=black, %fonttitle=\bfseries,
 before upper={\setlength{\parindent}{1.25em}},
 title={A Quiet Sunday at Home\hfill{\tiny 0029}\quad{\scriptsize \myaudio{./audio/022_is_ing_negative_reading.mp3}}} ]
\noindent{}It is Sunday afternoon, and it is raining outside.

Ken is in the living room.
 He is not playing video games today.
He is drawing a picture of his dog.

His sister, Emma, is not watching TV in her room.
She is writing a letter to her grandmother.

Their parents are not cooking dinner in the kitchen now.
They are drinking hot tea and reading books quietly.

Everyone is enjoying the peaceful afternoon.
...
% \vspace{-11pt}
 \begin{enumerate}
\setlength{\itemsep}{-3.4pt}
 \item<2-> Ken is playing video games in the living room.\hfill\visible<3->{F}
 \item<2-> Ken is drawing a picture of his dog.\hfill\visible<4->{T}
 \item<2-> Emma is watching TV in her room.\hfill\visible<5->{F}
 \item<2-> Emma is writing a letter to her grandmother.\hfill\visible<6->{T}
 \item<2-> The parents are cooking dinner in the kitchen now.\hfill\visible<7->{F}
 \end{enumerate}
 \end{frame}
%%%%%%%%%%%%%%%%%%%%%%%%%
...
\includegraphics[width=1.01\textwidth]{./infographic/022_is_ing_negative_infographic.png}
\hfill{\tiny audio\_overview 1725}\,{\scriptsize \myaudio{./audio/overview/022_is_ing_negative_audio_overview.m4a}}%
\hfill{\tiny eduop\_boys 0257}\,{\scriptsize \myaudio{./audio/manzai/022_is_ing_negative_manzai.mp3}}
\end{frame}
%%%%%%%%%%%%%%%%%%%%%%確認問題は次のセクション（疑問文）とセットで行うのでこのせくしょんではなし

...
\visible<5->{($=$ They \textcolor{Maroon}{\bfseries aren't} {\itshape studying} now.)}
...
\Circled[fill color = white]{\,\,$\text{be動詞} + \text{\textcolor{Maroon}{\bfseries not}} + \text{---ing}$\,\,}
 \visible<6->{\item 短縮形aren't ---ing, isn't ---ingが使われることもあります} \end{itemize}
      \end{exampleblock}
...
\hfill{}\onslide<3->{be動詞の直後に\textcolor{Maroon}{\bfseries not}がくるのは、どちらも同じです\hspace{1\zw}}
\end{frame}
\end{document}

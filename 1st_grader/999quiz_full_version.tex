...
%% G
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\setbeamercolor{background canvas}{bg=pink!75}
\begin{frame}[plain]{Quiz}
\hypertarget{today_g}{}
...
\scalebox{6}{\twemoji{elephant}}&
\scalebox{6}{\twemoji{crescent moon}}&
...
\end{frame}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\begin{frame}[plain]{ところで、これは？}
%
\raggedleft
%
\includegraphics[height=.95\textheight]{./nanobanana-output/a_piece_of_watering_hose_waterco.png}
...
\scalebox{6}{\twemoji{cheese wedge}}&
...
\raggedleft
%
\includegraphics[height=.95\textheight]{./nanobanana-output/colorful_and_delicious_ice_cream.png}

\vspace*{-30pt}

\pause
\large
\textcolor{white}{ice cream  \textipa{/\`aIskr\'\i:m/} \textipa{/\'aIskr\`\i:m/}}
...
\scalebox{3}{\faCoffee}&
%\scalebox{3.3}{{\COE \Italy}}&
\scalebox{6}{\twemoji{kite}}&
\scalebox{6}{\twemoji{key}}%
%\fcKiteA{.1}{gray!80}{.2}&
%\fcKey{.1}{gray!80}{.2}%
\\
(a)&(b)&(c)&(d)
...
聞こえたアルファベットを順番に小文字で書いてください。ある単語になります。
その意味を表すものを選びましょう
}
...
これからアルファベットを5つ順番に読みあげます。
聞こえたアルファベットを順番に小文字で書いてください。ある単語になります。
その意味を表すものを選びましょう\hfill{\tiny 0054}\,{\scriptsize \myaudio{./audio/quiz/quiz_t.mp3}}%
}
...
\visible<7->{\textipa{/t\'aIg\textrhookschwa /}}
...
\visible<10->{\textipa{/2mbr\'el@/}}

\vspace{-30pt}

\hfill{\tiny 0039}\,{\scriptsize \myaudio{./audio/quiz/answer_u.mp3}}
\end{frame}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%% V
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
聞こえたアルファベットを順番に小文字で書いてください。ある単語になります。
その意味を表すものを選びましょう
}\hfill{\tiny 0117}\,{\scriptsize \myaudio{./audio/quiz/quiz_v.mp3}}
...
\visible<11->{\textipa{/v\'edZt@bl/}}

\vspace{-30pt}

\hfill{\tiny 0039}\,{\scriptsize \myaudio{./audio/quiz/answer_v.mp3}}
\end{frame}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%% W
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
聞こえたアルファベットを順番に小文字で書いてください。ある単語になります。
その意味を表すものを選びましょう}
\hfill{\tiny 0055}\,{\scriptsize \myaudio{./audio/quiz/quiz_w.mp3}}
...
\visible<7->{\textipa{/w\'AtS/}}

\vspace{-30pt}

\hfill{\tiny 0038}\,{\scriptsize \myaudio{./audio/quiz/answer_w.mp3}}
\end{frame}
%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%% X
...
もっとも関係があるものを選びましょう
}\hfill{\tiny 0048}\,{\scriptsize \myaudio{./audio/quiz/quiz_x.mp3}}
...
\visible<8->{\textipa{/kr\'Ism@s/}}\hfill%
...
聞こえたアルファベットを順番に小文字で書いてください。ある単語になります。
その意味を表すものを選びましょう}%
\hfill{\tiny 0101}\,{\scriptsize \myaudio{./audio/quiz/quiz_y.mp3}}
...
\visible<8->{\textipa{/j\'eloU/}}

\vspace{-30pt}

\hfill{\tiny 0038}\,{\scriptsize \myaudio{./audio/quiz/answer_y.mp3}}
\end{frame}
...
聞こえたアルファベットを順番に小文字で書いてください。ある単語になります。
その意味を表すものを選びましょう}%
\hfill{\tiny 0048}\,{\scriptsize \myaudio{./audio/quiz/quiz_z.mp3}}
...
\visible<6->{\textipa{/z\'IroU/}}

\vspace{-30pt}

\hfill{\tiny 0038}\,{\scriptsize \myaudio{./audio/quiz/answer_z.mp3}}
\end{frame}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\scalebox{.5}{\begin{tikzpicture}
\clip (0,0) rectangle (6,4);

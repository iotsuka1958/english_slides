...
\pause
\begin{itemize}
 \item 「AとBのどちら」と聞くとき$\longrightarrow$\,\,\,\textcolor{Maroon}{\bfseries Which}  is 〜, \textcolor{Maroon}{\bfseries A or B} ?
\end{itemize}
     \end{exampleblock}
}
...
\visible<6->{\myAnch{WH2}{orange}{Which} \myEmph[6-]{Maroon}{do you like}, spring \textcolor{Maroon}{\bfseries or} summer?}\hfill\visible<7->{{\small AとBのどちら}}
...
\mbox{}\hfill\myaudio{./audio/016_which_07.mp3}

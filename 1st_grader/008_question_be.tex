...
\mbox{}\hspace{40pt}$\left\{\begin{array}{l}
         \text{Yes, \myAnch{he1}{orange}{he} is.}\\\pause
         \text{No, \myAnch{he2}{orange}{he} is not($=\text{isn't}$).}
        \end{array}\right.$
...
\begin{tikzpicture}[remember picture,overlay]
 \draw[->,thick,orange] (john.south) -- (he1.north);
\end{tikzpicture}

\end{column}
\pause
\begin{column}{.475\textwidth}
Is Emily from Sydney?

\pause

\mbox{}\hspace{40pt}$\left\{\begin{array}{l}
         \text{Yes, she is.}\\\pause
         \text{No, she is not($=\text{isn't}$).}
        \end{array}\right.$

...
\begin{itemize}\setbeamertemplate{items}[square]
 \item<8->  \textcolor{Maroon}{\bfseries do not\,($=\text{don't)} + \text{原形}$}\hfill{}do not \textipa{/d\'u: n\'At/}%
\hspace{10pt}don't \textipa{/d\'oUnt/}
 \item<9->  主語が3人称単数のときは\textcolor{Maroon}{\bfseries does not\,($=\text{doesn't)} + \text{原形}$}\\
\hfill{*He doesn't live\Circled[fill color=white]{s} in Paris.}\\
\hfill{}does not \textipa{/d\'\textturnv z n\'At/}\hspace{10pt}doesn't \textipa{/d\'\textturnv znt/}
\end{itemize}
      \end{block}
}
\end{frame}
...
\mbox{}\hfill\visible<6->{\footnotesize 現在形の否定文は、主語によって\textcolor{Maroon}{\bfseries do not\,($=$ don't)}と\textcolor{ForestGreen}{\bfseries does not\,($=$ doesn't)}を使い分け}
       \end{enumerate}
 \item \begin{enumerate}
...
\hfill{* He did not live\Circled[fill color=white]{d} in Boston.}\\
...
{\small つぎの各文を否定文にしましょう}

\begin{enumerate}
 \item \visible<1->{We listened to the radio after dinner.}\hfill{\scriptsize listen to～を聞く \textipa{/l\'Isn/}}\\
...
\visible<3->{$\rightarrow$\,I didn't\,($=$ did not)\,\,\,play the piano last night.}
 \item \visible<1->{He cooked this morning.}\hfill{\scriptsize cook \textipa{/k\'Uk/} 料理する}\\
\visible<4->{$\rightarrow$\,He didn't\,($=$ did not)\,\,\,cook this morning.}
 \item \visible<1->{She walked to work every day.}\hfill{\scriptsize work \textipa{/w\'\textrhookschwa :k/} 職場}\\
\visible<5->{$\rightarrow$\,She didn't\,($=$ did not)\,\,\,walk to work every day.}
 \item \visible<1->{They lived in London two years ago.}\hfill{\scriptsize ago \textipa{/@g\'oU/} 前に}\\
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\begin{frame}[plain]{--edで終わるが、ちょっぴり注意が必要な動詞（復習）}
...
\begin{itemize}\setbeamertemplate{items}[square]\small
 \item 原形の最後が\,\Circled[fill color=white]{\,子音字\,} $+$ y のとき、最後のyをiに変えてedをつけます%\\
%\hfill{}(結果的に--iedとなります)
...
\visible<2->{\rowcolors{2}{NavyBlue!40}{yellow!40}
\begin{tabular}{lll}\toprule
{\small 原形}&{\small (意味)}&{\small 過去形}\\\midrule
{go}&{{\small (行く)}}&{went}\\
{come}&{{\small (来る)}}&{came}\\
...
\end{frame}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\section{Listen, Then Read\,\,\,\,\,{\tiny 0031}\,{\scriptsize \myaudio{./audio/026_past_ddnot_reading.mp3}}}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
before upper={\setlength{\parindent}{1.25em}},
 title={A Quiet Day at Home\hfill{\tiny 0032}\quad{\scriptsize \myaudio{./audio/026_past_didnot_reading.mp3}}}
]
\noindent{}Yesterday was Sunday, but I did not go out. The weather was rainy and windy.

In the morning, I wanted to play tennis with my brother, but we didn't play. We stayed home and watched TV.
My father cooked lunch, but he didn't make sandwiches. He made warm soup and noodles.

In the afternoon, I did not study math. I read a comic book and listened to music. I did not meet my friends, but I had a relaxing time.
\end{tcolorbox}
...
\item<2-> The speaker went out on Sunday.\hfill\visible<3->{F}
\item<2-> The speaker and his brother played tennis in the morning.\hfill\visible<4->{F}
\item<2-> The father cooked soup and noodles for lunch.\hfill\visible<5->{T}
\item<2-> The speaker studied math in the afternoon.\hfill\visible<6->{F}
\item<2-> The speaker had a relaxing time at home.\hfill\visible<7->{T}
\end{enumerate}
\end{frame}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
\includegraphics[width=1.01\textwidth]{./infographic/026_past_didnot_infographic.png}
\hfill{\tiny audio\_overview 1840}\,{\scriptsize \myaudio{./audio/overview/026_past_didnot_audio_overview.m4a}}%
\hfill{\tiny eduop\_boys 0453}\,{\scriptsize \myaudio{./audio/manzai/026_past_didnot_manzai.mp3}}
\end{frame}
%%%%%%%%%%%%%%%%%%%%%%
...
\begin{columns}
 \begin{column}{0.4\textwidth}
  \includegraphics[width=1.1\textwidth]{./test_forms/026_past_didnot_test.png}
 \end{column}
...
\url{https://forms.gle/8vhvWxfqNWVbcwUs8}
\end{frame}
%%%%%%%%%%%%%%%%%%%
\end{document}

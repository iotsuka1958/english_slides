...
\begin{enumerate}
 ...
 \item international \textipa{/\`Int\textrhookschwa n\'\ae Sn@l/} $\longrightarrow$ \textipa{/\`Int\textrhookschwa n\'\ae Sn@l/}
 \item internet \textipa{/\'Int\textrhookschwa n\`et/} $\longrightarrow$ \textipa{/\'In\textrhookschwa n\`et/}
\end{enumerate}
\hfill{\tiny 0218}\,{\scriptsize \myaudio{./audio/041_would_like_08d.mp3}}
...
want\liaison[Maroon]to
  ...
  \begin{itemize}\setbeamertemplate{items}[square]\small
   \item \textipa{/w\'Ant t@/} $\longrightarrow$ \textipa{/w\'Ant@/}
   \item さらに \textipa{/wAn@/} と発音されることがあります
  \end{itemize}
 \end{block}


\hfill{\tiny 0039}\,{\scriptsize \myaudio{./audio/041_would_like_09.mp3}}

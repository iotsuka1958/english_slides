...
\begin{enumerate}
 \item \begin{enumerate}
	\item He \textbf{walks} to work every day.\hfill{}S$+$V
	\item He \textbf{walks} his dog every day.\hfill{}S$+$V$+$O
       \end{enumerate}
 \item \begin{enumerate}
	\item There are \textbf{some} apples on the table.
	\item \textbf{Some} people like cats. \textbf{Some} people like dogs.
          \end{enumerate}
 \end{enumerate}
\end{frame}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%

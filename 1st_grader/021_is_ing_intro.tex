...
\visible<2->{They \fbox{\bfseries\textcolor{Maroon}{are} play\textcolor{Maroon}{ing}} baseball in the park now.\hspace{32pt}{\small now: 今、たった今}}
...
\,\,\,\,\,\,\,$\longleftarrow$\,\,\,\,現在進行形\Circled[fill color = white]{\,\,$\text{be動詞}+\text{---ing}$\,\,}
}
...
\begin{itemize}\small
 ...
 \item 現在進行形$\longrightarrow$今この瞬間に起こっていること\hfill{}「～している」\,\,\,\,
\end{itemize}
     \end{exampleblock}
}
\visible<1->{%
...
I \alt<2->{(\,\,\textcolor{Maroon}{\bfseries am}\,\,)}{(\phantom{\,\,am\,\,})} reading a book now.
 \item 彼女は、いま歌を歌っています。\\
She \alt<3->{(\,\,\textcolor{Maroon}{\bfseries is}\,\,)}{(\phantom{\,\,is\,\,})} singing a song now.
 \item わたしたちは、いま宿題をしています。\\
We \alt<4->{(\,\,\textcolor{Maroon}{\bfseries are}\,\,)}{(\phantom{\,\,are\,\,})} doing homework now.
 \item わたしたちのネコは、いまベッドの上で寝ています。\\
Our cat \alt<5->{(\,\,\textcolor{Maroon}{\bfseries is}\,\,)}{(\phantom{\,\,is\,\,})} sleeping on the bed now.
\end{enumerate} 

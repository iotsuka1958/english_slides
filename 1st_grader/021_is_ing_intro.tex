...
\begin{enumerate}
 \item<2-> sit\,\,\,\,\,\,\visible<3->{\textipa{/s\'It/} {\small 短い母音}\textipa{/I/}} \visible<4->{$\longrightarrow$ si\textbf{tt}ing}
 \item<2-> eat\,\,\,\visible<5->{\textipa{/\'\i:t/}\, {\small 長い母音}\textipa{/i:/}} \visible<6->{$\longrightarrow$\, ea\textbf{t}ing}\hfill{}\visible<5->{\textipa{:}\,\,\,{\scriptsize 長音記号}}
\end{enumerate}

...
\begin{enumerate}
 \item<2-> sit\,\,\,\,\,\, \textipa{/s\'It/} 短い母音\textipa{/I/} $\longrightarrow$ sitting
 \item<3-> eat\,\,\, \textipa{/\'\i:t/}\, 長い母音\textipa{/i:/} $\longrightarrow$\, eating\hfill{}\textipa{:}\,\,\,{\scriptsize 長音記号}
\end{enumerate}

\bigskip

\hfill\visible<4->{\scriptsize \dbend\,\,\dbend\,\,最後の1文字を重ねるのは\,\,\Circled{\,\,$\text{短い母音}+\text{子音字}$\,\,}\,\,で終わる動詞のときです}%
\end{frame}

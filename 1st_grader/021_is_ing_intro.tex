...
\end{frame}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\section{Listen, Then Read\,\,\,\,\,{\tiny 0030}\,{\scriptsize \myaudio{./audio/021_is_ing_intro_06.mp3}}}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\begin{frame}[plain]
...
\noindent{}Look! It is noon\footnotemark{} now.
...
He likes books very much.
 ...
 Two students are doing homework together, but they are not \tikzmark{clue4}studying Spanish.
...
\begin{enumerate}\scriptsize\setlength{\itemsep}{-2pt}
 ...
 \item<2-> Mr. Brown likes books very much. He is reading a newspaper.\tikzmark{q3}\hfill\visible<8->{F}
...
\begin{tikzpicture}[remember picture,overlay]
 ...
 \visible<7->{\draw[<-,opacity=.4,line width=2pt] ([xshift=18pt,yshift=-2pt]pic cs:clue3) to[in=60,out=-90] ([xshift=2pt, yshift=2pt] pic cs:q3);}
...
\includegraphics[width=1.01\textwidth]{./infographic/021_is_ing_intro_infographic.png}
\hfill{\tiny audio\_overview 1830}\,{\scriptsize \myaudio{./audio/overview/021_is_ing_intro_audio_overview.m4a}}%
\hfill{\tiny eduop\_boys 0309}\,{\scriptsize \myaudio{./audio/manzai/021_is_ing_intro_manzai.mp3}}
\end{frame}
%%%%%%%%%%%%%%%%%%%%%%
...
\begin{columns}
 \begin{column}{0.4\textwidth}
  \includegraphics[width=1.1\textwidth]{./test_forms/021_is_ing_intro_test.png}
 \end{column}
...
\url{https://forms.gle/SgnwzE6SfeV8Smcg7}
\end{frame}
%%%%%%%%%%%%%%%%%%%
\end{document}

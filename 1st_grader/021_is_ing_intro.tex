...
\begin{itemize}
 \visible<3->{\item 「状態」をあらわす動詞の例： know, have, likeなど}
...
\begin{itemize}
 \visible<5->{\item ほとんどは「動作」をあらわす動詞\hfill{}eat, drink, study, run, walk \ldots}
 \visible<6->{\item 「状態」を表す動詞はknow, have, like \ldots}\\

...
\begin{exampleblock}{Topics for Today}
\begin{itemize}
 \item<14->  一般動詞の否定は\hspace{50pt}\textcolor{Maroon}{do not($=\text{don't)} + \text{動詞(原形)}$}
 \item<15->  主語が3人称単数のときは\hspace{8pt}\textcolor{Maroon}{does not($=\text{doesn't)} + \text{動詞(原形)}$}\\
...
\begin{enumerate}
 ...
 \item Sue ( is not / do not / \alt<6->{\Circled[outer color=BurntOrange]{does not}}{does not}  ) play tennis on Sundays.\hspace{10pt}{\footnotesize on Sundays:} \makebox[0pt][l]{\tiny 日曜日に}
\end{enumerate}

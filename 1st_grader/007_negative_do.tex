...
\begin{enumerate}
 \item I ( am not / do not / not ) a baseball fan.\hspace{10pt}{\footnotesize fan:}{\tiny ファン}
 \item He ( is not / do not / does not ) from New Zealand.\hspace{10pt}{\footnotesize New Zealand:}{\tiny  ニュージーランド}
 \item They ( are not / do not / does not ) speak French.\hspace{10pt}{\footnotesize French:} {\tiny フランス語}
 \item I ( am not / do not / not ) have a dog.
 \item Naomi ( is not / do not / does not ) play tennis on Sundays.\hspace{10pt}{\footnotesize on Sundays:} \makebox[0pt][l]{\tiny 日曜日には}
\end{enumerate}

...
\end{frame}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\section{Listen, Then Read\,\,\,\,\,{\tiny 0031}\,{\scriptsize \myaudio{./audio/007_negative_do_reading.mp3}}}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
before upper={\setlength{\parindent}{1.25em}},
 title={Cooking Dinner with Dad\hfill{\tiny 0031}\quad{\scriptsize \myaudio{./audio/007_negative_do_reading.mp3}}}
]
\noindent{}Today is Saturday. Ken and his father cook dinner at home. Ken wants to make curry. His father likes spicy food, but Ken does not like spicy food.

Ken washes the vegetables. He does not cut the onions because they hurt his eyes. His father cuts the onions and the meat. They do not eat beef, so they use chicken.

Ken's sister comes to the kitchen. She does not cook, but she sets the table. The curry is ready. It smells delicious!
\end{tcolorbox}
...
\item<2-> Ken and his father cook dinner on Saturday.\hfill\visible<3->{T}
\item<2-> Ken likes spicy food.\hfill\visible<4->{F}
\item<2-> Ken cuts the onions for the curry.\hfill\visible<5->{F}
\item<2-> They use chicken for the curry.\hfill\visible<6->{T}
\item<2-> Ken's sister sets the table.\hfill\visible<7->{T}
\end{enumerate}
\end{frame}
%%%%%%%%%%%%%%%%%%%%%
\section{一般動詞の否定（まとめ）}
...
\includegraphics[width=1.01\textwidth]{./infographic/007_negative_do_infographic.png}
\hfill{\tiny audio\_overview 1900}\,{\scriptsize \myaudio{./audio/overview/007_negative_do_audio_overview.m4a}}%
\hfill{\tiny eduop\_boys 0351}\,{\scriptsize \myaudio{./audio/manzai/041_as_as_manzai.mp3
}}
\end{frame}
%%%%%%%%%%%%%%%%%%%%%%
...
\begin{columns}
 \begin{column}{0.4\textwidth}
  \includegraphics[width=1.1\textwidth]{./test_forms/007_negative_do_test.png}
 \end{column}
...
\url{https://forms.gle/oMZaBDneugXM4Hjd7}
\end{frame}
%%%%%%%%%%%%%%%%%%%%%%%%%%%
\end{document}

...
\hfill\textipa{/d\'u: n\'At/}\hspace{5pt}\textipa{/d\'oUnt/}
\end{itemize}
      \end{exampleblock}
}
\end{frame}
...
\begin{enumerate}
 \item I play soccer after school.\hfill{\scriptsize after school: 放課後に}
	 ...
	 \item I \textcolor{orange}{\bfseries do not} play soccer after school.
	  \item I \textcolor{orange}{\bfseries don't} play soccer after school.
	\end{itemize}}
 \item You study math at night.\hfill{\scriptsize study: 勉強する　math: 数学　at night: 夜に}
       \visible<3->{\begin{itemize}
	\item You \textcolor{orange}{\bfseries do not} study math at night.\\
	\item You \textcolor{orange}{\bfseries don't} study math at night.
       \end{itemize}}
 \item We eat meat at home.\hfill{\scriptsize eat: 食べる　meat: 肉　at home: 家で}
\visible<4->{\begin{itemize}
 \item We \textcolor{orange}{\bfseries do not} eat meat at home.\\
 \item We \textcolor{orange}{\bfseries don't} eat meat at home.
\end{itemize}}
 \item They like horror movies.\hfill{\scriptsize horror movie: ホラー映画}
\visible<5->{\begin{itemize}
 \item They \textcolor{orange}{\bfseries do not} like horror movies.\\
...
\hfill{}{\scriptsize \dbend\,\,{}*He does not live\Circled[fill color = white]{s} in Paris.}\\
...
\begin{enumerate}
 ...
 \item They ( are not / \alt<4->{\Circled[outer color=BurntOrange]{do not}}{do not}  / not ) speak French.\hfill{\scriptsize French:} {\tiny フランス語}

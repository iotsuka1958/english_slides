...
%\usepackage{figchild}%%%tikzducks.styやworldflags.styと衝突するのでコメントアウトした
\usepackage{twemojis}
\usepackage{utfsym}
\usepackage{bclogo}
\usepackage{marvosym}
...
% \item   文末に`?'をつける
 \item \textbf{do} \textipa{/d@/}\hspace{50pt}\textbf{does} \textipa{/d@z/}
\end{itemize}
     \end{block}
...
つぎの文を疑問文にしましょう
 ...
 \begin{enumerate}
  ...
  \item<1-> They live in Boston.\hspace{47.5pt}%
        \onslide<3->{$\longrightarrow$\,\,\,\,\, Do they live in Boston?}\hfill\worldflag[width=5mm]{US}
...
\textbf{do}と\textbf{does}には、実は2とおりの発音がある！\pause{}\kenten{弱形}と\kenten{強形}\pause
...
\begin{enumerate}
 \item do\hspace{45pt}\textipa{/d@/}\hspace{55pt}\textipa{/d\'u:/}\pause
 \item does\hspace{30pt}\textipa{/d@z/}\hspace{50pt}\textipa{/d\'2z/}
\end{enumerate}
\pause
...
Do you like sushi?\hspace{110pt}{\textipa{/d@/}}\hfill\scalebox{2}{\twemoji{sushi}}\pause
...
Does he walk to school?\hfill{\textipa{/d@z/}}
...
\mbox{}\hfill
\visible<3->{$\left\{\begin{tabular}{ll}
         \visible<3->{Yes, \myAnch{he1}{orange}{he} does.}&\visible<3->{\text{\scriptsize\textipa{/d\'2z/}}}\\
         \visible<4->{No, \myAnch{he2}{orange}{he} does not.}&\visible<4->{\text{\scriptsize\textipa{/d@z n\'At/}}}\\
         \visible<5->{\text{(}$=$ \text{No, he doesn't.)}}&\visible<5->{\text{\scriptsize\textipa{/d\'2znt/}}}
        \end{tabular}\right.$}
...
Do they sing well?\hspace{20pt}{\textipa{/d@/}}
...
\mbox{}\hspace{100pt}$\left\{\begin{tabular}{ll}
         Yes, they do.&\text{\scriptsize\textipa{/d\'u:/}}\\\pause
         No, they do not.&\text{\scriptsize\textipa{/d@ n\'At/}}\\\pause
          \text{(}$=$ \text{No, they don't.)}&\text{\scriptsize\textipa{/d\'oUnt/}}
        \end{tabular}\right.$
\vspace{10pt}
...
\hfill{\tiny 0159}\,{\scriptsize\myaudio{./audio/011_answer_do_04.mp3}}
\end{frame}
%%%%%%%%%%%%%%%%%%%%%%%%%
...
\mbox{}\hspace{100pt}%
\visible<3->{$\left\{\begin{tabular}{ll}
         \visible<3->{Yes, \myAnch{they4}{orange}{they} do.}&\visible<3->{\text{\textipa{/d\'u:/}}}\\
         \visible<4->{No, \myAnch{they5}{orange}{they} do not.}&\visible<4->{\text{\textipa{/d@ n\'At/}}}\\
         \visible<5->{\text{(}$=$ \text{No, they don't.)}}&\visible<5->{\text{\textipa{/d\'oUnt/}}}
       \end{tabular}\right.$}
...
\end{frame}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\section{Listen, Then Read 1\,\,\,\,\,{\tiny 0207}\,{\scriptsize \myaudio{./audio/011_answer_do_07.mp3}}}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\begin{frame}[plain]
...
\begin{tcolorbox}
Hi, I'm Jennifer.
I live in London and I'm in junior high school.
My parents don't eat meat, but they really like fish.
I also enjoy sushi.
We often go to Japanese restaurants.
\end{tcolorbox}
...
\end{frame}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\section{Listen, Then Read 2\,\,\,\,\,{\tiny 0038}\,{\scriptsize \myaudio{./audio/011_answer_do_reading.mp3}}}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
before upper={\setlength{\parindent}{1.25em}},
 title={Do You Play Sports?\hfill{\tiny 0038}\quad{\scriptsize \myaudio{./audio/011_answer_do_reading.mp3}}}
]
\noindent{}Ken and Tom are good friends.
They talk after school every day.

``Do you play soccer, Ken?'' asks Tom.
``Yes, I do. I play soccer in the park,'' says Ken.
``Do you play baseball too?''
``No, I don't,'' answers Ken.
``I like soccer very much.
Do you like sports, Tom?''
``Yes, I do,'' says Tom.
``I like basketball.
Do you want to play basketball with me on Sunday?''
``Yes, I do!
...
\item<2-> Ken and Tom talk after school every day.\hfill\visible<3->{T}
\item<2-> Ken plays baseball in the park.\hfill\visible<4->{F}
\item<2-> Ken likes soccer very much.\hfill\visible<5->{T}
\item<2-> Tom does not like sports.\hfill\visible<6->{F}
\item<2-> Ken and Tom will play basketball on Sunday.\hfill\visible<7->{T}
\end{enumerate}
\end{frame}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\section{まとめ}
...
\begin{itemize}\setbeamertemplate{items}[square]
 \item   先頭にDoまたはDoes\hspace{10pt}---主語(S)が3人称単数のときは\,\Circled[fill color=white]{\,\,Does\,\,}\,---\\
	 \Circled[fill color = white]{\,\,Do\,\,}\,$+$\,S\,$+$\,V{\scriptsize ($=$\,原形)} \ldots\,\,\,? \textipa{/d@/}\hfill{}\textbf{Do} you like sushi?\\
	 \Circled[fill color = white]{\,\,Does\,\,}\,$+$\,S\,$+$\,V{\scriptsize ($=$\,原形)} \ldots\,\,\,? \textipa{/d@z/}\hfill{}\textbf{Does} she play the guitar?\\
...
% do \textipa{/d@/}\,\,\textipa{/d\'u:/}\hspace{15pt}does \textipa{/d@z/}\,\,\textipa{/d\'2z/}\hfill{}not \textipa{/n\'At/}\hfill{}don't \textipa{/d\'oUnt/}\hfill{}doesn't \textipa{/d\'2znt/}
%\end{block}
\vspace{-8pt}
...
\includegraphics[width=1.01\textwidth]{./infographic/011_answer_do_infographic.png}
\hfill{\tiny audio\_overview 1819}\,{\scriptsize \myaudio{./audio/overview/011_answer_do_audio_overview.mp4}}%
\hfill{\tiny eduop\_boys 0313}\,{\scriptsize \myaudio{./audio/manzai/011_answer_do_manzai.mp3}}
\end{frame}
%%%%%%%%%%%%%%%%%%%%%%
...
\begin{columns}
 \begin{column}{0.4\textwidth}
  \includegraphics[width=1.1\textwidth]{./test_forms/011_answer_do_test.png}
 \end{column}
...
\url{https://forms.gle/3iiREbQAJPYHvK1c6}
\end{frame}
%%%%%%%%%%%%%%%%%%%
\end{document}

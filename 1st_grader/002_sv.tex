...
{\tiny audio\_overview 1047}\,{\scriptsize \myaudio{./audio/overview/002_sv_audio_overview.m4a}}\\
{\tiny eduop\_boys 0417}\,{\scriptsize \myaudio{./audio/manzai/002_sv_manzai.mp3}}
\end{frame}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\begin{frame}[plain]
 
\includegraphics[width=1.01\textwidth]{./infographic/002_sv_infographic.png}
\hfill{\tiny audio\_overview 1519}\,{\scriptsize \myaudio{./audio/overview/002_sv_audio_overview.m4a}}%
\hfill{\tiny eduop\_boys 0244}\,{\scriptsize \myaudio{./audio/manzai/002_sv_manzai.mp3
}}
\end{frame}
%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%
...
\begin{columns}
 \begin{column}{0.4\textwidth}
  \includegraphics[width=1.1\textwidth]{./test_forms/002_sv_test.png}
 \end{column}
...
\url{https://forms.gle/KtBDPEq5xNhMf2zcA}
\end{frame}
%%%%%%%%%%%%%%%%%%%
\end{document}

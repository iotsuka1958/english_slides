...
\end{frame}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\begin{frame}[plain]{doがあったりなかったり}
 \begin{enumerate}
...
\begin{enumerate}
 \item \begin{enumerate}
		 ...
		 \end{enumerate}
 \item \begin{enumerate}
	\item Carelessness causes accidents.\hfill{\scriptsize cause \textipa{/k\'O:z/} 引き起こす}
	\item What causes accidents?\hfill{\scriptsize carelessness \textipa{/k\'e\textrhookschwa l@sn@s/} 不注意}

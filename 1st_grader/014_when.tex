...
\centering
    ...
    \begin{overlayarea}{\textwidth}{4cm}
        ...
        \begin{tikzpicture}[
            ...
            \node<1->[number] (twenty) at (0,0) {20};
            \node<1->[number, right=0.5cm of twenty] (twentysix) {26};


            % --- Slide 2: 波かっこを表示 (<2-> 2枚目以降で表示) ---
            
            % 英語テキストと分離するため、ここでは draw コマンドのみにします
            \draw<2->[brace] (twenty.south west) -- (twenty.south east);
            ...
            \node<3->[label] at ([yshift=-15pt]twenty.south) {twenty};

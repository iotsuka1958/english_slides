...
\end{frame}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\section{Listen, Then Read\,\,\,\,\,{\tiny 0037}\,{\scriptsize \myaudio{./audio/014_when_reading.mp3}}}
%%%%%%%%%%%%%%%%%%%%%%
\begin{frame}[plain]
...
\mbox{}\hfill{\tiny 0244}\,{\scriptsize \myaudio{./audio/014_when_11.mp3}}
...
\end{enumerate}
\mbox{}\hfill{\tiny 0345}\,{\scriptsize \myaudio{./audio/014_when_12.mp3}}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\begin{frame}[plain]{}
\includegraphics[width=1.01\textwidth]{./infographic/014_when_infographic.png}


 {\tiny audio\_overview 1208}\,{\scriptsize \myaudio{./audio/overview/014_when_audio_overview.m4a}}%
\hfill {\tiny audio\_overview 0236}\,{\scriptsize \myaudio{./audio/manzai/014_when_manzai.mp3}}
\end{frame}
%%%%%%%%%%%%%%%%%%%
...
\begin{columns}
 \begin{column}{0.4\textwidth}
  \includegraphics[width=1.1\textwidth]{./test_forms/014_when_test.png}
 \end{column}
...
\url{https://forms.gle/LE7X2HPwNibZN6vi9}
\end{frame}
%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%
\end{document}

...
\begin{enumerate}
 ...
 \item 1789\hfill\visible<3->{\makebox[80pt][l]{seventeen eighty-nine}}\hspace{200pt}\mbox{}
 \item 1853\hfill\visible<4->{\makebox[80pt][l]{eighteen fifty-three}}\hspace{200pt}\mbox{}
 \item 1861\hfill\visible<5->{\makebox[80pt][l]{eighteen sixty-one}}\hspace{200pt}\mbox{}
 \item 1999\hfill\visible<6->{\makebox[80pt][l]{nineteen ninety-nine}}\hspace{200pt}\mbox{}
\end{enumerate}
\end{frame}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\begin{frame}[plain]{Exercises}
...
\visible<5->{ややこしいのは2000年以降}

\Large
\begin{enumerate}
 \item 1900\hfill\visible<2->{\makebox[80pt][l]{nineteen hundred}}\hspace{200pt}\mbox{}
 \item 1901\hfill\visible<3->{\makebox[80pt][l]{nineteen oh one}}\hspace{200pt}\mbox{}
 \item 1910\hfill\visible<4->{\makebox[80pt][l]{nineteen ten}}\hspace{200pt}\mbox{}
 \item 2000\hfill\visible<6->{\makebox[80pt][l]{two thousand}}\hspace{200pt}\mbox{}
 \item 2003\hfill\visible<7->{\makebox[80pt][l]{two thousand three}}\hspace{200pt}\mbox{}
 \item 2010\hfill\visible<8->{\makebox[80pt][l]{two thousand ten / twenty ten}}\hspace{200pt}\mbox{}
 \item 2020\hfill\visible<9->{\makebox[80pt][l]{two thousand twenty / twenty twenty}}\hspace{200pt}\mbox{}
\end{enumerate}
\end{frame}
%%%%%%%%%%%%%%%%%%
\begin{frame}[plain]

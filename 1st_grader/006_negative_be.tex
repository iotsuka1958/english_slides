...
\end{frame}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\section{Listen, Then Read\,\,\,\,\,{\tiny 0034}\,{\scriptsize \myaudio{./audio/006_negative_be_reading.mp3}}}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
before upper={\setlength{\parindent}{1.25em}},
 title={A Visit to the City Zoo\hfill{\tiny 0034}\quad{\scriptsize \myaudio{./audio/006_negative_be_reading.mp3}}}
]
\noindent{}Today is Sunday.
 Leo and his sister are at the city zoo.
 Leo is excited, but his sister is not. She is tired.

They look at the pandas.
 The pandas are not awake.
 They are fast asleep under the trees.
 The lions are not active either.

Leo is not sad.
 The penguins are in the water. 
They are very fast and cute. ``I am not bored now!'' says his sister with a big smile.
\end{tcolorbox}
...
\item<2-> Leo and his sister are at the city zoo on Sunday.\hfill\visible<3->{T}
\item<2-> Leo's sister is excited at first.\hfill\visible<4->{F}
\item<2-> The pandas are awake and active.\hfill\visible<5->{F}
\item<2-> The penguins are in the water.\hfill\visible<6->{T}
\item<2-> Leo's sister is still bored at the end.\hfill\visible<7->{F}
\end{enumerate}
\end{frame}
%%%%%%%%%%%%%%%%%%%%%%%%%%
\section{まとめ}
...
\includegraphics[width=1.01\textwidth]{./infographic/006_negative_be_infographic.png}
\hfill{\tiny audio\_overview 1431}\,{\scriptsize \myaudio{./audio/overview/006_nagative_be_audio_overview.m4a}}%
\hfill{\tiny eduop\_boys 0301}\,{\scriptsize \myaudio{./audio/manzai/006_negativae_be_manzai.mp3
}}
\end{frame}
%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%
...
\begin{columns}
 \begin{column}{0.4\textwidth}
  \includegraphics[width=1.1\textwidth]{./test_forms/006_negative_be_test.png}
 \end{column}
...
\url{https://forms.gle/x54UTnLxNfV7hw8x7}
\end{frame}
%%%%%%%%%%%%%%%%%%%
\end{document}

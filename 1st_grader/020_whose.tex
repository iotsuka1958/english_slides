...
\hfill{}\Circled[fill color=white]{\,\,名詞 $+$ 's\,\,}\hfill\mbox{}
\end{itemize}
     \end{block}
...
\end{frame}
%%%%%%%%%%%%%%%%%%%%%%
\section{Listen, Then Read\,\,\,\,\,{\tiny 0032}\,{\scriptsize \myaudio{./audio/020_whose_reading.mp3}}}
%%%%%%%%%%%%%%%%%%%%%%
\begin{frame}[plain]
...
\hfill{\tiny 0032}\,{\scriptsize \myaudio{./audio/020_whose_reading.mp3}}
...
before upper={\setlength{\parindent}{1.25em}},
 title={{}Sharing and Finding Lost Items}{}\hfill{\tiny 0032}\,{\scriptsize \myaudio{./audio/020_whose_reading.mp3}}
]
\noindent{}Many students lose things at school.

Look at this blue school bag.
Whose bag is this?
Is it yours or his?
Ken says, ``It is not mine. My bag is green. Is it Jennifer's?''
Lisa looks at the books inside and says, ``These books are her mother's, so this bag is hers!''

 Students often share things too. Sometimes they mix up pencils.
``Is this pen yours?''
``No, it is theirs.''
...
\begin{description}[　　]
 \item[Q]<1-> つぎの英文のandは何と何を接続していますか。looksの主語は何ですか。\\またsaysの主語は何ですか\\[10pt]
Lisa looks at the books inside and says, ``These books are her mother's.''\\
　
 \item[A]<2->  \mbox{}\\
Lisa\only<3->{($=$ S)} \,\, $\left\{ 
\begin{tabular}{l}
 looks\only<3->{($=$ V$_1$)}\,\, at the books inside\\
 and\\
 says\only<3->{($=$ V$_2$)},\,\ ``These books are her mother's.''\\
\end{tabular}
\right\}$

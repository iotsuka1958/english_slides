...
\mbox{}\hfill{}{\tiny 0242}\,{\scriptsize \myaudio{./audio/001_alphabet_01.mp3}}
\end{frame}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%\againframe{upper}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
\begin{itemize}\setbeamertemplate{items}[square]
 ...
 \item 大文字と小文字があります\pause
	...
	\item 大文字小文字を区別して書けるようになろう\pause
        \item 大文字を使うのは\pause
              \begin{itemize}
	       \item 文の先頭\hfill{}\textbf{S}he is very kind.\pause
	       \item \textrm{I}\,\,(わたしは)\hfill{}Can \textbf{I} Ihelp you?\pause
	       \item 人名、地名など$\longrightarrow$ 「固有名詞」といいます\hfill{}\textbf{G}eorge lives in \textbf{L}ondon.\pause
	      \end{itemize}
       \end{itemize}
...
\scalebox{1.23}{\begin{tabular}{p{.95\textwidth}}
ABCDEFGHIJKLMNOPQRSTUVWXYZ\\
%小文字:& a b c d e f g h i j k l m n o p q r s t u v w x y z
\end{tabular}}
...
\scalebox{1.028}{\begin{tabular}{p{.95\textwidth}}
%ABCDEFGHIJKLMNOPQRSTUVWXYZ\\
a b c d e f \rotatebox{12.5}{{\itshape g}} h i j k l m n o p q r s t u v w x y z
\end{tabular}}\pause
...
\begin{tikzpicture}[remember picture,overlay]
 ...
 \draw[fill=black] ([xshift=25pt,yshift=10pt]pic cs:right_eye) circle (.1);\end{tikzpicture}
\end{frame}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\begin{frame}[plain]{まぎらわしいもの}
...
\end{frame}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\againframe<3>[plain]{write_lower}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%\againframe<1>{upper}
%\againframe<1>{lower}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
\mbox{}\hfill{\tiny 0342}\,{\scriptsize \myaudio{./audio/001_alphabet_011.mp3}}
...
\mbox{}\hfill{\tiny 0221}\,{{\scriptsize \myaudio{./audio/001_alphabet_012.mp3}}}
...
\mbox{}\hfill\tiny 0134{}{\scriptsize {\myaudio{./audio/001_alphabet_02.mp3}}}

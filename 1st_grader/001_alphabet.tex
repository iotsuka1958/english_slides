...
\visible<3->{\alt<4->{\textcolor{ForestGreen}{\textbf M}}{M}y name is \alt<5->{\textcolor{Maroon}{\textbf G}}{G}eorge \alt<5->{\textcolor{Maroon}{\textbf S}}{S}mith.}\pause\hfill{}\visible<5->{人の名前}
...
\mbox{}\hfill\visible<1->{\myaudio{./audio/001_alphabet_011.mp3}}
...
\mbox{}\hfill\visible<1->{\myaudio{./audio/001_alphabet_012.mp3}}
...
\mbox{}\hfill{\myaudio{./audio/001_alphabet_02.mp3}}

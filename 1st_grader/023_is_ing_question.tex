...
\end{frame}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\section{Listen, Then Read\,\,\,\,\,{\tiny 0033}\,{\scriptsize \myaudio{./audio/023_is_ing_question_reading.mp3}\,07a}}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
before upper={\setlength{\parindent}{1.25em}},
 title={Sunday Afternoon in the Park\hfill{\tiny 0033}\quad{\scriptsize \myaudio{./audio/023_is_ing_question_reading.mp3}}}
]
\noindent{}It is Sunday afternoon, and many people are in the park.

Is Ken playing soccer with his friends? No, he is not.
He is riding his new bicycle near the lake.

Are Amy and Lisa playing tennis? Yes, they are having fun together.

Look at Mr. Smith under the big tree. Is he sleeping on the bench?
No, he is reading an interesting book about animals.

Everyone is enjoying their time in the park.
\end{tcolorbox}
...
\item<2-> Ken is riding a bicycle near the lake.\hfill\visible<3->{T}
\item<2-> Amy and Lisa are playing soccer.\hfill\visible<4->{F}
\item<2-> Mr. Smith is sleeping on the bench.\hfill\visible<5->{F}
\item<2-> Mr. Smith is reading an interesting book.\hfill\visible<6->{T}
\item<2-> Everyone is enjoying their time in the park.\hfill\visible<7->{T}
\end{enumerate}
\end{frame}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\section{現在進行形のまとめ}
...
\includegraphics[width=1.01\textwidth]{./infographic/023_is_ing_question_infographic_2.png}

{\tiny audio\_overview 0647}\,{\scriptsize \myaudio{./audio/overview/023_is_ing_question_audio_overview.m4a}}%
\hfill\tiny eduop\_boys 0257\,{\scriptsize \myaudio{./audio/manzai/023_is_ing_question_manzai.mp3}}
\end{frame}
%%%%%%%%%%%%%%%%%%%%%%確認問題は前のセクション（否定文）とセットで行う
\begin{frame}[plain]{Check for Understanding}
 
\begin{columns}
 \begin{column}{0.4\textwidth}
  \includegraphics[width=1.1\textwidth]{./test_forms/023_is_ing_question_test.png}
 \end{column}
...
\url{https://forms.gle/2Nm3gDUrY2PVsjCC7}
\end{frame}
%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\end{document}
...
\mbox{}\hfill{\tiny 0157}\,{\scriptsize \myaudio{./audio/overview/023_is_ing_audio_overview.m4a}}
\end{frame}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\end{document}

...
\mbox{}\hfill\visible<6>{\myaudio{./audio/023_is_ing_question_01.mp3}}
\end{frame}
...
\visible<6>{%
\mbox{}\hfill\visible{\myaudio{./audio/023_is_ing_question03.mp3}}
}
...
\end{column}
\begin{column}{.425\textwidth}
\visible<4->{{\small 現在進行形のとき}}

\visible<5->{Is he studying?}
...
\mbox{}\hfill\visible<9>{\myaudio{./audio/023_is_ing_question_04.mp3}}
\end{frame}
...
\footnote{\visible<9->{No, they aren't.やNo they're not.も\scalebox{1.4}{\twemoji{OK button}}}}\\
...
\mbox{}\hfill\visible<21->{\myaudio{./audio/023_is_ing_05.mp3}}
\end{frame}

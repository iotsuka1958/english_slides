...
\hfill\Circled[fill color = white]{\,\,$\text{S}+\text{be動詞}\,\,$}\,\,$\rightarrow$\,\,\Circled[fill color = white]{\,\,$\text{be動詞}+\text{S}\,\,$}\,\,? 
...
\begin{enumerate}
 ...
 \item Are you ( \alt<4->{\Circled[outer color=orange]{listening}}{listening} / listen / playing ) to music now?\hfill{\scriptsize listen to ～: ～を聞く}

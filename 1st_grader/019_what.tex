...
\visible<2->{What is his name?}
 \item ( is / this box / what / in) ? --- A new computer is in it.\\
\visible<3->{{What is in this box?}}
...
\begin{enumerate}
 \visible<1->{\item \myAnch{adj}{orange}{What\raisebox{5pt}{$\curvearrowright$}time} is it?\hfill{}{\small cf. It is ten forty.}\\
 {\small 何時}}
 \visible<2->{\item \myAnch{adj}{orange}{What\raisebox{5pt}{$\curvearrowright$}sport} do you like?\\ {\small 何のスポーツ}}
\end{enumerate}

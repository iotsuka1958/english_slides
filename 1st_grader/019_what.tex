...
\vspace{-10pt}
\visible<1->{%
\mbox{}\hfill{\scriptsize \myaudio{./audio/019_what_01.mp3}}
}
\end{frame}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\subsection{一般動詞のとき}
...
\visible<5->{%
\begin{tikzpicture}[remember picture, overlay]
 \draw[line width=3pt, opacity=.5, orange, ->] (focus2.south) to[out=-90, in=90] node[sloped,above,text=black,font=\tiny,pos=.667]{先頭へ} (WH2.north);
\end{tikzpicture}
}
...
\pause
\begin{itemize}\setbeamertemplate{items}[square]\small
 \item 「何を」とたずねるときは、\Circled[fill color=white]{\,\,What\,\,}\,\,を先頭に置いて疑問文のかたちを続ける\\
\hfill{}What do you  〜? / What does he 〜?
 \item   文末に`?'をつける（イントネーションは\myDownwardPitch{}\,\,）
\end{itemize}
     \end{exampleblock}
}
\mbox{}\hfill{\scriptsize \myaudio{./audio/019_what_02.mp3}}
...
\mbox{}\hfill{\scriptsize \myaudio{./audio/019_what_03.mp3}}
...
\pause
\begin{itemize}\small
 \item \fcolorbox{black}{white}{$\text{What} + \text{名詞}$}\,\,がひとかたまりになって「何の〜、どんな～」の意味で使うことがあります
 \item \fcolorbox{black}{white}{$\text{What} + \text{名詞}$}\,\,も文の先頭にきます
\end{itemize}
     \end{exampleblock}

\mbox{}\hfill{\scriptsize \myaudio{./audio/019_what_04.mp3}}
...
\end{enumerate}
\mbox{}\hfill{\scriptsize \myaudio{./audio/019_what_05.mp3}}

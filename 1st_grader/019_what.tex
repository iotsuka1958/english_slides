...
\begin{itemize}\setbeamertemplate{items}[square]\small
 ...
 \item \fcolorbox{black}{white}{$\text{What} + \text{名詞}$}\,\,も文の先頭にきます
\end{itemize}
     \end{block}
...
\visible<2->{What movies do you watch?}
 \item ( books / you / read / what / do ) ? --- I read mystery novels.\hfill{\scriptsize novel \textipa{/n\'Avl/}}\\
...
\mbox{}\hfill{\tiny 0322}\,{\scriptsize \myaudio{./audio/019_what_05.mp3}}

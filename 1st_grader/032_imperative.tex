...
\item<2-> 一般動詞のとき
	...
	\item<5-> \myEmph[5-]{NavyBlue}{Have} a good day.\hfill\myaudio{./audio/032_imperative_01.mp3}
 ...
 \item<6-> be動詞のとき
	...
	\item<9-> \myEmph[9-]{Maroon}{Be} nice to others.\hfill\myaudio{./audio/032_imperative_02.mp3}
...
\hfill\myaudio{./audio/032_imperative_03.mp3}
\end{frame}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\begin{frame}[plain]{Exercises}
...
\hfill\myaudio{./audio/032_imperative_05.mp3}
\end{frame}
%%%%%%%%%%%%%%%%%%%%%%%%%%
\begin{frame}[plain]{Exercises}

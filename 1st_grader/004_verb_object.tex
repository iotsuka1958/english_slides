...
\begin{enumerate}
 \item \begin{enumerate}
	\item He plays tennis \fbox{with his friends}.%
\hfill{}plays $\longleftarrow$  \fbox{with his friends}
	\item He plays tennis \fbox{in the park}.%
\hfill{}plays $\longleftarrow$  \fbox{in the park}
       \end{enumerate}
 \item \begin{enumerate}
	\item I know a girl \fbox{with long hair}.
\hfill{}a girl $\longleftarrow$  \fbox{with long hair}
	\item The soup \fbox{in this cup} is hot.
\hfill{}The soup $\longleftarrow$  \fbox{in this cup}
       \end{enumerate}
\end{enumerate}
...
{\small つぎの英文の\,\fbox{前置詞$+$名詞}\,はどこを修飾していますか。前置詞と名詞のかたまりを黒い四角で囲み、その四角から修飾先に矢印をつけてみましょう。また、各文の\,\fbox{前置詞$+$名詞}\,は副詞の働きなのか、形容詞の働きなのか、確認しましょう}%
\hfill{\tiny 03436}\,{\scriptsize \myaudio{./audio/004_verb_object_7.mp3}\,7}

\begin{enumerate}
 \item She is a doctor at our hospital.
 \item I want a picture of Paris.
 \item The cat under the chair is cute.
 \item The flowers on the table are beautiful.
 \item The woman in the car is my mother.
 \item He reads a book before bed.
 \item We live in Boston.
 \item They go to work by bus.
\end{enumerate}

...
\begin{enumerate}\small
 ...
 \item \alt<14->{\Circled[outer color=Maroon]{I}}{I} \alt<15->{\Circled[outer color=NavyBlue]{write}}{write} \alt<24->{\fbox{a letter}}{a letter}. {\footnotesize わたしは手紙\alt<24->{\kenten{を}}{を}書きます。}\hfill\visible<33->{SVO}
     \item \alt<16->{\Circled[outer color=Maroon]{They}}{They} \alt<17->{\Circled[outer color=NavyBlue]{like}}{like} \alt<25->{\fbox{music}}{music}.  {\footnotesize 彼らは音楽\alt<25->{\kenten{を}}{を}好む。}\hfill\visible<34->{SVO}
\end{enumerate}
...
%
\vspace*{-8pt}
{\tiny 0323}\,{\scriptsize \myaudio{./audio/004_verb_object_1.mp3}\,1}

\end{column} 
\begin{column}{.44\textwidth}
 \begin{block}<26->{新しい記号を覚えよう}\small
...
{\tiny 0335}\,{\scriptsize \myaudio{./audio/004_verb_object_2.mp3}\,2}
\hfill\visible<23->{%
...
\begin{frame}[plain]{副詞}
 \begin{enumerate}
  \item Dogs swim  \alt<2->{\Circled[fill color=gray, outer color=gray, inner color=white]{\bfseries well}}{well}.\hfill{\tiny 0311}\,{\scriptsize \myaudio{./audio/004_verb_object_3.mp3}\,3}
...
\hfill{\tiny 0234}\,{\scriptsize \myaudio{./audio/004_verb_object_4.mp3}\,4}
 \begin{enumerate}
...
{\small 日本語の意味になるよう(~~~~~)内の語句を並べ替えましょう。なお、1語不足しているので、解答作成に当たっては不足している1語を補ってください。また文の構造をS, V, Oの記号を用いて示してください}
 \begin{enumerate}
...
\visible<3->{\,\,\,(S$+$V$+$O)}
  \item {\small 彼は夕食の前に本を読む。}\hfill%
	...
	\visible<4->{He reads a book \myEmph[2-]{Maroon}{before} dinner.}%
\visible<5->{\,\,\,(S$+$V$+$O)}
  \item {\small 放課後、彼らは川で泳ぐ。}\hfill%
	They ( after / the river / swim ) school.\\
	\visible<6->{They swim \myEmph[2-]{Maroon}{in} the river after school.}%
\visible<7->{\,\,\,(S$+$V)}
  \item {\small わたしは両親といっしょにボストンに住んでいる。}\\
	\hfill{}I ( parents / live /  my ) in Boston.\\
	\visible<8->{I live \myEmph[2-]{Maroon}{with} my parents in Boston.}%
\visible<9->{\,\,\,(S$+$V)}
...
\end{enumerate}
\vspace{-10pt}
\hfill{\tiny 0207}\,{\scriptsize \myaudio{./audio/004_verb_object_5.mp3}\,5}
\end{frame}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\begin{frame}[plain]{文中での\,\,\fbox{$\text{前置詞}+\text{名詞}$}\,\,の働き}
 
\begin{enumerate}
 \item<2-> \begin{enumerate}
	\item<2-> He plays tennis \fbox{with his friends}.%
\hfill{}\visible<3->{plays $\longleftarrow$  \fbox{with his friends}}
	\item<4-> He plays tennis \fbox{in the park}.%
\hfill{}\visible<5->{plays $\longleftarrow$  \fbox{in the park}}
       \end{enumerate}
 \item<6-> \begin{enumerate}
	\item<6-> I know a girl \fbox{with long hair}.
\hfill{}\visible<7->{a girl $\longleftarrow$  \fbox{with long hair}}
	\item<8-> The soup \fbox{in this cup} is hot.
\hfill{}\visible<9->{The soup $\longleftarrow$  \fbox{in this cup}}
       \end{enumerate}
\end{enumerate}

\begin{block}<10->{Topics for Today}
 \Circled[fill color=white]{\,\,前置詞$+$名詞\,\,}\,\,の2つの働き

\begin{itemize}\setbeamertemplate{items}[square]
 \item<11-> 動詞を修飾する：つまり\kenten{副詞}の働き%
\hfill{}{\scriptsize cf. He plays tennis \textbf{well}.}\\[-2pt]
\hfill{}{\scriptsize plays $\longleftarrow$ well}
 \item<12-> 名詞を修飾する：つまり\kenten{形容詞}の働き
\hfill{}{\scriptsize cf. I know a \textbf{smart} girl.}\\[-2pt]
\hfill{}{\scriptsize smart $\longrightarrow$ girl}
\end{itemize}

\hfill\visible<13->{{\scriptsize \raisebox{5pt}{\dbend}\,\,\,\,1語の形容詞が前から後ろの名詞を修飾するのと対照的ですね}}
\end{block}

\vspace{-12pt}

\hfill{\tiny 0206}\,{\scriptsize \myaudio{./audio/004_verb_object_6.mp3}\,6}

\end{frame}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\begin{frame}[plain]{Exercises}
 
{\small つぎの英文の\,\fbox{前置詞$+$名詞}\,はどこを修飾していますか。
%前置詞と名詞のかたまりを黒い四角で囲み、その四角から修飾先に矢印をつけてみましょう。
また、各文の\,\fbox{前置詞$+$名詞}\,は副詞の働きなのか、形容詞の働きなのか、確認しましょう}%
\hfill{\tiny 03436}\,{\scriptsize \myaudio{./audio/004_verb_object_7.mp3}\,7}

\begin{enumerate}
 \item She is a doctor at our hospital.\hfill\visible<2->{{\scriptsize doctor $\longleftarrow$ \fbox{at our hospital}}}
 \item I want a picture of Paris.\hfill\visible<3->{{\scriptsize picture $\longleftarrow$ \fbox{of Paris}}}
 \item The cat under the chair is cute.\hfill\visible<4->{{\scriptsize cat $\longleftarrow$ \fbox{under the chair}}}
 \item The flowers on the table are beautiful.\hfill\visible<5->{{\scriptsize flowers $\longleftarrow$ \fbox{on the table}}}
 \item The woman in the car is my mother.\hfill\visible<6->{{\scriptsize woman $\longleftarrow$ \fbox{in the car}}}
 \item He reads a book before bed.\hfill\visible<7->{{\scriptsize reads $\longleftarrow$ \fbox{before bed}}}
 \item We live in Boston.\hfill\visible<8->{{\scriptsize live $\longleftarrow$ \fbox{in Boston}}}
 \item They go to work by bus.\hfill\visible<9->{{\scriptsize go $\longleftarrow$ \fbox{to work}}}\\
\hfill\visible<10->{{\scriptsize go $\longleftarrow$ \fbox{by bus}}}
\end{enumerate}
...
\begin{block}{文中での\,\,\fbox{$\text{前置詞}+\text{名詞}$}\,\,の働き}
 \Circled[fill color=white]{\,\,前置詞$+$名詞\,\,}\,\,は

\begin{itemize}\setbeamertemplate{items}[square]
 \item 動詞を修飾する場合：つまり\kenten{副詞の働き}\\
\hfill{}He plays tennis \fbox{with his friends}.\\
\hfill{}He plays tennis \fbox{in the park}.

 \item 名詞を修飾する場合：つまり\kenten{形容詞の働き}\\
\hfill{I know a girl \fbox{with a long hair}.\\
\hfill{}The soup \fbox{in this cup} is hot.}
\end{itemize}
\end{block}
...
\hfill{\tiny 0410}\,{\tiny\myaudio{./audio/004_verb_object_word.mp3}\,word}
\pause
\vspace{-10pt} 
\large
\begin{enumerate}[<+- |alert@+>]
 \item bird \textipa{/b\'\textrhookschwa :d/}\hfill\visible<2->{{\scriptsize \Circled{\,名\,} 鳥}}
 \item letter \textipa{/l\'et\textrhookschwa /}\hfill\visible<3->{{\scriptsize \Circled{\,名\,} 手紙}}
 \item music \textipa{/mj\'u:zIk/}\hfill\visible<4->{{\scriptsize \Circled{\,名\,} 音楽}}
 \item in the morning \textipa{/In D@ m\'O\textrhookschwa nIN/}\hfill\visible<5->{{\scriptsize 午前中に }}
 \item well \textipa{/w\'el/}\hfill\visible<6->{{\scriptsize \Circled{\,副\,} 上手に、うまく}}
 \item fast \textipa{/f\'\ae st/}\hfill\visible<7->{{\scriptsize \Circled{\,副\,} 速く\,She runs \textbf{fast}.}}
 \item slowly \textipa{/sl\'oUli/}\hfill\visible<8->{{\scriptsize \Circled{\,副\,} ゆっくりと}}
 \item here \textipa{/h\`I\textrhookschwa /}\hfill\visible<9->{{\scriptsize \Circled{\,副\,} ここに、ここで、ここへ}}
 \item there \textipa{/D\'e\textrhookschwa /}\hfill\visible<10->{{\scriptsize \Circled{\,副\,} そこに、そこで、そこへ}}
 \item before \textipa{/b\'IfO\textrhookschwa /}\hfill\visible<11->{{\scriptsize \Circled{\,前\,} ～の前に\,\,\,before dinner}}
 \item after \textipa{/\'\ae ft\textrhookschwa /}\hfill\visible<12->{{\scriptsize \Circled{\,前\,} ～の後で\,\,\,after lunch}}
\end{enumerate}
\end{frame}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\begin{frame}[plain]
 
\includegraphics[width=1.01\textwidth]{./infographic/004_verb_object_infographic.png}
\hfill{\tiny audio\_overview 1429}\,{\scriptsize \myaudio{./audio/overview/004_verb_object_audio_overview.m4a}}%
\hfill{\tiny eduop\_boys 0351}\,{\scriptsize \myaudio{./audio/manzai/004_verb_object_manzai.mp3
}}
\end{frame}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
\begin{columns}
 \begin{column}{0.4\textwidth}
  \includegraphics[width=1.1\textwidth]{./test_forms/004_verb_object_test.png}
 \end{column}
...
\url{https://forms.gle/XiQcbHpHv6jNbweR6}
\end{frame}
%%%%%%%%%%%%%%%%%%%
\end{document}

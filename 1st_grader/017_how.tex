...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\begin{frame}[plain]
\hyperlink{today}{\beamergotobutton{Let's begin.}}%%todayにジャンプ
\end{frame}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\section*{授業の流れ}
\begin{frame}[plain]
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\section{How \textipa{/h\'aU/}をbe動詞とともに}
...
\begin{itemize}\setbeamertemplate{items}[square]\small
 ...
 \item {\bfseries How}の後ろは疑問文の語順
\hfill$\HighlightFormula{\text{How} + \text{be動詞} + \text{S ?}}$\\
\hfill{\scriptsize \textbf{How} are your parents?}
%$\longrightarrow$\,\,\,{\bfseries How is} S($=$ 単数形)\,? / {\bfseries How are} S($=$ 複数形)\,?
 \item   文末に`?'をつける / イントネーションは\myDownwardPitch{}
 \item 短縮形 {\bfseries How are} $\longrightarrow$ {\bfseries How're} \textipa{/h\'aU\textrhookschwa /}\hfill{\scriptsize \textbf{How're} your parents?}
\end{itemize}
     \end{block}
...
\begin{frame}[plain]{Exercises 1}
 ...
 {\small 日本語の意味になるように、語句を並べ替えましょう。疑問符は補ってください。先頭にくる語は大文字で書き始めてください}
\begin{enumerate}
...
\end{frame}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\section{How \textipa{/h\'aU/}を一般動詞とともに}
...
\end{frame}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\section{\fbox{How $+$ X} どれくらい（程度）}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\begin{frame}[plain]{\fbox{How $+$ X} どれくらい（程度）}
 \begin{enumerate}
...
\begin{block}<7->{Topics for Today}\small
\begin{itemize}\setbeamertemplate{items}[square]\small
 \item<7-> 「どのくらい」と`程度'をたずねるとき$\longrightarrow$\,\,\,\fcolorbox{black}{white}{\bfseries How $+$ X\,}\,\,\,\ldots{}\,\,\,?
 \item<8-> \fcolorbox{black}{white}{\bfseries How $+$ X\,}\,\,の後は疑問文と同じ語順になります\hfill{\bfseries How old} is the building?\\
\hfill{}{\bfseries How many} comics do you have?
 \item<9->   {\bfseries How much}は「いくら」と`値段'をたずねるときの決まり文句です
\end{itemize}
     \end{block}
\vspace{-11pt}
...
\hfill\visible<8->{\scriptsize often \textipa{/\'O:f(t)n/} しばしば}

\hfill\visible<8->{\textbf{How often} do you study math? --- Every day.}

\hfill\visible<8->{\textbf{How often} do you wash your car? --- Once a month.}

\hfill{\tiny 0209}\,{\scriptsize\myaudio{./audio/017_how_06a.mp3}}
...
\begin{frame}[plain]{回数}
 ...
 \begin{enumerate}
  \item<1-> George washes his car \textcolor{Maroon}{\bfseries once} a week.
  \item<2-> My mother visits her father \textcolor{Maroon}{\bfseries twice} a month.
  \item<3-> Brush your teeth \textcolor{Maroon}{\bfseries three times} a day.\hfill{\scriptsize  teeth \textipa{/t\'\i:T/} $<$ tooth \textipa{/t\'u:T/}}
  \item<4-> I listen to this song \textcolor{Maroon}{\bfseries many times}.
\end{enumerate}

%\vspace{-20pt}

\begin{block}<5->{「何回」という表現}
\small
...
\end{tabular}}
      \end{block}
\hfill{\tiny 0213}\,{\scriptsize\myaudio{./audio/017_how_06b.mp3}}
\end{frame}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\begin{frame}[plain]{回数}
...
\hfill{}\textdbend\,\,\,twenty dollar\textbf{s} / twenty yen (*yen\textbf{s}ではないことに注意)
\hypertarget{today}{}
\end{frame}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%

%%%%%%%%%%%%%%%%%%%%%%
\section{Listen, Then Read\,\,\,\,\,{\tiny 0047}\,{\scriptsize \myaudio{./audio/017_how_reading.mp3}}}
%%%%%%%%%%%%%%%%%%%%%%
\begin{frame}[plain]
 
\includegraphics[width=1.01\textwidth]{./images/nanobanana-output/017_how_reading.png}

\vspace{-15pt}

\hfill{\tiny 0047}\,{\scriptsize \myaudio{./audio/017_how_reading.mp3}}
...
before upper={\setlength{\parindent}{1.25em}},
 title=A Letter from Ken\mbox{}\hfill{\tiny 0047}\,{\scriptsize \myaudio{./audio/017_how_reading.mp3}}
]
...
In Boston, it is sunny today. 

How do you go to school?
I usually go to school by bus.
The bus ticket is 2 dollars.
...
\item<2-> Ken lives in Boston.\hfill\visible<3->{T}
 \item<2-> It is rainy in Boston today.\hfill\visible<4->{F}
 \item<2-> Ken goes to school on foot.\hfill\visible<5->{F}
 \item<2-> The bus ticket is 2 dollars.\hfill\visible<6->{T}
 \item<2-> Ken studies English every day.\hfill\visible<7->{T}
\end{enumerate}
...
\large
\begin{enumerate}
 \item weather \textipa{/w\'eD\textrhookschwa /}\hfill\visible<2->{{\scriptsize \Circled{\,名\,} 天気、天候}}
 \item sunny \textipa{/s\'2ni/}\hfill\visible<3->{{\scriptsize \Circled{\,形\,} 晴れた}}
 \item usually \textipa{/j\'u:\textyogh u@li/}\hfill\visible<4->{{\scriptsize \Circled{\,副\,} ふつうは、いつもは}}
 \item by bus \textipa{/baI b\'2s/}\hfill\visible<5->{{\scriptsize \Circled{\,前\,} $+$ \Circled{\,名\,} バスで}}
 \item ticket \textipa{/t\'IkIt/}\hfill\visible<6->{{\scriptsize \Circled{\,名\,} 切符、チケット}}
 \item dollar \textipa{/d\'Al\textrhookschwa /}\hfill\visible<7->{{\scriptsize \Circled{\,名\,} ドル}}
\end{enumerate}

\hfill{\tiny 0227}\,{\scriptsize \myaudio{./audio/017_how_07a.mp3}}
...
　 こんにちは！お元気ですか？僕の名前はケンです。ボストンに住んでいます。あなたの町の天気はどうですか？今日のボストンは晴れています。

　あなたはどのように学校へ行きますか？僕はいつもバスで学校に行きます。バスのチケットは2ドルです。あなたの町ではいくらですか？

　僕には2人の兄弟がいます。あなたには何人の兄弟がいますか？僕は13歳です。あなたは何歳ですか？僕は毎日英語を勉強しています。あなたはどのくらいの頻度で勉強しますか？すぐにお返事をお願いします！
\end{tcolorbox}
\end{frame}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
\includegraphics[width=1.01\textwidth]{./infographic/017_how_infographic.png}


 {\tiny audio\_overview 0959}\,{\scriptsize \myaudio{./audio/overview/017_how_audio_overview.m4a}}%
\hfill{\tiny eduop\_boys 0248}\,{\scriptsize \myaudio{./audio/manzai/017_how_manzai.mp3}}

\end{frame}
%%%%%%%%%%%%%%%%%%%%%%%%%%
\begin{frame}[plain]
 
\includegraphics[width=1.01\textwidth]{./infographic/017_how_infographic_2.png}
...
\begin{columns}
 \begin{column}{0.4\textwidth}
  \includegraphics[width=1.1\textwidth]{./test_forms/017_how_test.png}
 \end{column}
...
\url{https://forms.gle/rHhe5yhCoat9hRi16}

...
\mbox{}\hspace{50pt}Your farther is  \alt<3->{\myAnch{FOCUS}{orange}{fine}}{\myAnch{focus}{white}{fine}}.
...
\pause
\begin{itemize}\small
 \item 「〜はどうですか」と聞くとき$\longrightarrow$\,\,\,How is 〜?
...
\pause
\begin{itemize}\small
 \item 「〜はどうですか」と聞くとき$\longrightarrow$\,\,\,How is 〜? / How are 〜?(Howの後ろは疑問文のかたち)
 \item   文末に`?'をつける（イントネーションは\myDownwardPitch{}\,\,）
...
\visible<3->{How are you?}
 \item ( is / in / how / the weather / Boston )
ボストンの天気はどうですか？\\
\visible<4->{How is the weather in Boston?}
\visible<5->{---\begin{tabular}[t]{l@{\,\,\,}ll}
	      It's& sunny. &(晴れ) \\
                  & cloudy.&(曇り)\\
                  & rainy.&(雨)\\
                  & snowy.&(雪)
	     \end{tabular}}
\end{enumerate}
\hfill\myaudio{./audio/017_how_03.mp3}
\end{frame}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
\visible<5->{%
\begin{tikzpicture}[remember picture, overlay]
 \draw[thick, orange, ->] (focus_3.south) to[out=-90, in=90] (WH_3.north);
\end{tikzpicture}
}

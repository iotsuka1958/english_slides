...
\mbox{}\hfill\visible<1->{\myaudio{./audio/quiz/quiz_f.mp3}}
...
\large
\mbox{}\hfill\visible<1->{\myaudio{./audio/quiz/answer_f.mp3}}
\end{frame}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%% G
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
\mbox{}\hfill\visible<1->{\myaudio{./audio/quiz/quiz_g.mp3}}
...
\large
\mbox{}\hfill\visible<1->{\myaudio{./audio/quiz/answer_g.mp3}}
\end{frame}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%% H
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
\mbox{}\hfill\visible<1->{\myaudio{./audio/quiz/quiz_h.mp3}}
...
\large
\mbox{}\hfill\visible<1->{\myaudio{./audio/quiz/answer_h.mp3}}
\end{frame}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%% I
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
%% I
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\begin{frame}<1,5>[plain,label=quiz_i]{Quiz}
 \large
\visible<1->{%
...
\mbox{}\hfill\visible<1->{\myaudio{./audio/quiz/quiz_i.mp3}}
...
\large
\mbox{}\hfill\visible<1->{\myaudio{./audio/quiz/answer_i.mp3}}
\end{frame}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%% J
...
\mbox{}\hfill\visible<1->{\myaudio{./audio/quiz/quiz_j.mp3}}
...
\large
\mbox{}\hfill\visible<1->{\myaudio{./audio/quiz/answer_j.mp3}}
\end{frame}
%%%%%%%%%%%%%%%%%%%%%%%%%%%
%\begin{frame}[plain]{これはchessです}
%
%\raggedleft
%
%\includegraphics[height=.9\textheight]{./images/chess.jpg}
%
%\vspace*{-8pt}
%\tiny
%
%``Chess Match on Courthouse Square -- `Charge at First Light'\,'' by Jack W. Pearce is licensed under CC BY-SA 2.0. To view a copy of this license,\\
% visit \url{https://creativecommons.org/licenses/by-sa/2.0/?ref=openverse}.
%\end{frame}
%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
\mbox{}\hfill\visible<1->{\myaudio{./audio/quiz/quiz_m.mp3}}
...
\large
\mbox{}\hfill\visible<1->{\myaudio{./audio/quiz/answer_m.mp3}}
\end{frame}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%% N
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
\mbox{}\hfill\visible<1->{\myaudio{./audio/quiz/quiz_p.mp3}}
...
\mbox{}\hfill\visible<1->{\myaudio{./audio/quiz/quiz_s.mp3}}
...
\large
\mbox{}\hfill\visible<1->{\myaudio{./audio/quiz/answer_s.mp3}}
\end{frame}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%% T
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
\mbox{}\hfill\visible<1->{\myaudio{./audio/quiz/quiz_u.mp3}}
...
\large
\mbox{}\hfill\visible<1->{\myaudio{./audio/quiz/answer_u.mp3}}
\end{frame}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%% V
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\begin{frame}<1,10>[plain]{Quiz}
 \large
\visible<1->{%
...
\mbox{}\hfill\visible<1->{\myaudio{./audio/quiz/quiz_v.mp3}}
...
\large
\mbox{}\hfill\visible<1->{\myaudio{./audio/quiz/answer_v.mp3}}
\end{frame}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%% W
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
\mbox{}\hfill\visible<1->{\myaudio{./audio/quiz/quiz_w.mp3}}
...
\large
\mbox{}\hfill\visible<1->{\myaudio{./audio/quiz/answer_w.mp3}}
\end{frame}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%% X
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
\mbox{}\hfill\visible<1->{\myaudio{./audio/quiz/quiz_x.mp3}}
...
\large
\mbox{}\hfill\visible<1->{\myaudio{./audio/quiz/answer_x.mp3}}
\end{frame}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%% Y
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
\mbox{}\hfill\visible<1->{\myaudio{./audio/quiz/quiz_y.mp3}}
...
\large
\mbox{}\hfill\visible<1->{\myaudio{./audio/quiz/answer_y.mp3}}
\end{frame}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%% Z
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
\mbox{}\hfill\visible<1->{\myaudio{./audio/quiz/quiz_z.mp3}}
...
\large
\mbox{}\hfill\visible<1->{\myaudio{./audio/quiz/answer_z.mp3}}
\end{frame}
\end{document}

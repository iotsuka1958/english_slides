...
\begin{frame}<1-27>[plain]\frametitle{「AはBだ」という表現}
 % \setbeamercovered{transparent}
  \begin{enumerate}
   \item<1-> I \textbf{\textcolor{red}{am}} a student. \onslide*<2>{わたしは生徒です。}\onslide*<14-20>{(I $=$ a student)}\onslide*<21-26>{\footnotesize 　a:１つの、1人の　student: 生徒、学生}
...
\onslide<27>{%
\myaudio{audio/002_be-01.mp3}\,\,{}Listen carefully.(注意して聞いてください)

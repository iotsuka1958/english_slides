...
$\longrightarrow$
\onslide<12->{有声音なら\textipa{/z/}\hspace{5pt} 無声音なら\textipa{/s/}}
...
\subsection{注意すべき複数形}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\begin{frame}[plain]{yで終わる単語の複数形}\Large
\begin{enumerate}
 \item<1-> boy $\rightarrow$ \visible<2->{boys}
 \item<3-> day $\rightarrow$ \visible<4->{days}
 \item<5-> toy $\rightarrow$ \visible<6->{toys}
 \item<7-> city $\rightarrow$ \visible<8->{cities (*citys)}
 \item<9-> country $\rightarrow$ \visible<10->{countries (*countrys)}
 \item<11-> baby $\rightarrow$ \visible<12->{babies (*babys)}
\end{enumerate} 
\end{frame}
%%%%%%%%%%%%%%%%%

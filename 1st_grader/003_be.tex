...
% Embed the sound file
\hfill{\tiny 0251}\,{\tiny \myaudio{audio/002_be_01.mp3}01}
\end{frame}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
% Embed the sound file
\hfill{\tiny 0250}\,{\tiny \myaudio{./audio/002_be_02.mp3}02}
...
\normalsize
{\tiny 0137}\,{\tiny \myaudio{audio/002_be_021.mp3}021}
\hfill{}%
{\tiny 0136}\,{\tiny \myaudio{audio/002_be_022.mp3}022}
...
\begin{frame}[plain,label=youare,t]\frametitle{You are 〜.}
 % \setbeamercovered{transparent}
  \begin{enumerate}
   \item<1-> \textbf{\color{Maroon}{You are}}\onslide*<10->{($=$You're)} my friend. \visible<2->{{\scriptsize あなたはわたしのともだちです。}}\hfill\visible<1->{\scriptsize 　friend \textipa{/fr\'end/} ともだち、友人}
   \item<1-> \textbf{\color{Maroon}{You are}}\onslide*<10->{($=$You're)}  very kind. \visible<3->{{\scriptsize あなたはとても親切だ。}}\hfill\visible<1->{\scriptsize 　kind \textipa{/k\'aInd/} 親切だ}
   \item<1-> \textbf{\color{Maroon}{You are}}\onslide*<10->{($=$You're)}  a good student. \visible<4->{{\scriptsize あなたはいい生徒です。}}\hfill\visible<1->{\scriptsize 　student: 生徒}
   \item<1-> \textbf{\color{Maroon}{You are}}\onslide*<10->{($=$You're)}  good at baseball. \visible<5->{{\scriptsize あなたは野球がうまい。}}\hfill\visible<1->{\scriptsize 　good at 〜がうまい、得意だ}
   \item<1-> \textbf{\color{Maroon}{You are}}\onslide*<10->{($=$You're)}  busy. \visible<6->{{\scriptsize あなたは忙しい。}}\hfill\visible<1->{\scriptsize 　busy \textipa{/b\'Izi/} 忙しい}
   \item<1-> \textbf{\color{Maroon}{You are}}\onslide*<10->{($=$You're)}  from Chiba. \visible<7->{{\scriptsize あなたは千葉の出身です。}}\hfill\visible<1->{\scriptsize 　from 〜の出身だ}
  \end{enumerate}
...
\begin{itemize}\setbeamertemplate{items}[square]
 ...
 \item<9-> \textbf{You are $=$ You're}\tikzmark{target1}\\
\mbox{}\hfill{}\tikzmark{pointer1}%
\visible<7->{{\scriptsize 短縮形といいます。 \Circled[fill color=white]{~'~}\,をapostrophy\,(アポストロフィ)といいます\phantom{あ}}}
\end{itemize}
     \end{block}
...
% Embed the sound file
\hfill{\tiny you\_are 0245}\,{\tiny \myaudio{audio/002_be_03.mp3}03}

\hfill{\tiny you're 0245}\,{\tiny \myaudio{audio/002_be_03a.mp3}03a}

\begin{tikzpicture}[remember picture,overlay]
 \visible<9->{\draw[<-,opacity=.4,line width=2pt] ([yshift=-2pt]pic cs:target1) to[out=-15, in=180] ([xshift=-2pt, yshift=2pt] pic cs:pointer1);}
\end{tikzpicture}
\end{frame}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
% Embed the sound file
\hfill{\tiny 0158}\,{\tiny \myaudio{audio/002_be_031.mp3}031}
...
% Embed the sound file
\hfill{\tiny 0248}\,{\tiny \myaudio{audio/002_be_04.mp3}04}
...
\hfill{\tiny 0200}\,{\tiny \myaudio{audio/002_be_041.mp3}041}\\
...
\hfill{\tiny 0248}\,{\tiny \myaudio{audio/002_be_05.mp3}05}
...
\hfill{\tiny 0135}\,{\tiny \myaudio{audio/002_be_051.mp3}051}\\
\hfill{\scriptsize それぞれ2行目の短縮形の練習です}
...
\mbox{}\hfill{\tiny 0239}\,{\tiny \myaudio{audio/002_be_06.mp3}06}
...
% 9枚目に「be」の真下に（原形）を表示
\visible<9->{\node[below] at (0,-1.2) {(原形)};}
% 9枚目：各ノードの周りに説明テキストを表示
\visible<10->{
%  \node[below] at (0,-1.2) {(原形)};       % be の真下
  \node[below] at (-6,-1.0) {(現在形)};    % am の真下
  \node[below] at (6,-1.0) {(現在形)};     % is の真下
  \node[right] at (1.2,5) {(現在形)};      % are の右横
}
\end{tikzpicture}
\end{frame}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
\includegraphics[width=1.01\textwidth]{./infographic/003_be_infographic.png}
\hfill{\tiny audio\_overview 1155}\,{\scriptsize \myaudio{./audio/overview/003_be_audio_overview.m4a}}%
\hfill{\tiny eduop\_boys 0422}\,{\scriptsize \myaudio{./audio/manzai/003_be_manzai.mp3
}}
\end{frame}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%
...
\begin{columns}
 \begin{column}{0.4\textwidth}
  \includegraphics[width=1.1\textwidth]{./test_forms/003_be_test.png}
 \end{column}
...
\url{https://forms.gle/eUasXXX6HVJPqT647}
\end{frame}
%%%%%%%%%%%%%%%%%%%

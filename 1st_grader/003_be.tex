...
\begin{exampleblock}<20->{Topics for Today}\small
...
\begin{exampleblock}<14->{Topics for Today}\small
\begin{itemize}\setbeamertemplate{items}[square]
 \item   amはbe動詞
...
% Embed the sound file
\onslide<20>{%
{\scriptsize \myaudio{./audio/002_be_02.mp3}}
}
...
\normalsize
\onslide<1->{%
{\scriptsize \myaudio{audio/002_be_021.mp3}}
}%
\hfill{}%
\onslide<5->{%
{\scriptsize \myaudio{audio/002_be_022.mp3}}
}
...
% Embed the sound file
\onslide<14->{%
{\scriptsize \myaudio{audio/002_be_03.mp3}}
}
\end{frame}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
\begin{itemize}\setbeamertemplate{items}[square]
 \item<6,9> areはbe動詞
 \item<7,9> You are 〜.をひとつのパターンとして覚えよう
...
% Embed the sound file
{\scriptsize \myaudio{audio/002_be_031.mp3}}
\end{frame}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%\againframe{waiting}
%\againframe{title}
...
\begin{exampleblock}<14->{Topic for Today}\small
\begin{itemize}\setbeamertemplate{items}[square]
...
% Embed the sound file
\onslide<14->{%
{\scriptsize \myaudio{audio/002_be_04.mp3}}
}
\end{frame}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%

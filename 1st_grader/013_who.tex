...
\end{frame}
%%%%%%%%%%%%%%%%%%%%%%
\section{Listen, Then Read\,\,\,\,\,\,{\tiny 0032}\,{\scriptsize \myaudio{./audio/013_who_reading.mp3}}}
%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\begin{frame}[plain]
...
\begin{frame}[plain]
\hypertarget{review}{} 
\includegraphics[width=1.01\textwidth]{./infographic/013_who_infographic_2.png}
\hfill{\tiny audio\_overview 1530}\,{\scriptsize \myaudio{./audio/overview/013_wh0_audio_overview.m4a}}%
\hfill{\tiny eduop\_boys 0300}\,{\scriptsize \myaudio{./audio/manzai/013_who_manzai.mp3
}}
\end{frame}
%%%%%%%%%%%%%%%%%%%%%%
...
\begin{columns}
 \begin{column}{0.4\textwidth}
  \includegraphics[width=1.1\textwidth]{./test_forms/013_who_test.png}
 \end{column}
...
\url{https://forms.gle/6LfepNPWFPcznWAVA}
\end{frame}
%%%%%%%%%%%%%%%%%%%
\end{document}

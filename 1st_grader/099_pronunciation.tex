...
\hfill{\tiny 0204}\,{\scriptsize \myaudio{./audio/099_pronunciation_01.mp3}\,01}
\end{frame}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\begin{frame}[plain]{確認}
\Large
...
\large
 \begin{description}
  \item[有声音: ] \onslide<1->{声帯がふるえる音}
                  \onslide<3->{%
                  \begin{itemize}\setbeamertemplate{items}[circle]\small
		   \item \onslide<3->{すべての母音}\hspace{25pt}アイウエオの類
		   \item \onslide<4->{一部の子音}\hspace{35pt}\onslide<5->{{\small たとえば \textipa{/b/}\,\,\,\textipa{/d/}\,\,\,\textipa{/g/}\,\,\,\textipa{/v/}\,\,\,\textipa{/z/}}}
%		   \item \onslide<4->{一部の子音}\hspace{35pt}\onslide<5->{{\small たとえば、バの子音、ガの子音、ザの子音、ダの子音}}
		  \end{itemize}}
  \item[無声音: ] \onslide<2->{声帯がふるえない音}
...
\normalsize
\mbox{}\hfill{\tiny 0449}\,{\scriptsize \myaudio{./audio/099_pronunciation_02.mp3}\,02}
...
\begin{frame}[plain]{まとめ}
 \begin{block}{この単元で学んだこと}
  ...
  \item 母音字と子音字
   ...
   \item 有声音と無声音
        \begin{enumerate}
	 \item<9-> 有声音とはなんですか\hfill\visible<10->{声帯がふるえる音}
	 \item<9-> 無声音とはなんですか\hfill\visible<11->{声帯がふるえない音}
	 \item<9-> 有声音と無声音の見わけ方\hfill\visible<12->{喉に手を当てる}
	\end{enumerate}
   \item 発音記号
        \begin{enumerate}
	 \item<13-> 発音記号とはなんですか\hfill\visible<14->{英語の発音を正しく表すための記号}
	\end{enumerate}
 \end{enumerate}   

...
% この場合は (363pt, 100pt) の位置に 0.4\linewidth の幅のブロックができる．
\begin{textblock*}{0.4\linewidth}(363pt,58pt)
    % TiKZを使った図形の描画
...
\end{frame}
%%%%%%%%%%%%%%%%%%%%%%
\section{Listen, Then Read\,\,\,\,\,{\tiny 0034}\,{\scriptsize \myaudio{./audio/012_can_reading.mp3}}}
%%%%%%%%%%%%%%%%%%%%%%
...
\begin{tcolorbox}[
  ...
  title={Amazing Penguins\hfill{\tiny 0047}\quad{\scriptsize \myaudio{./audio/012_can_reading.mp3}}}
]
  Penguins are very interesting birds.
  They live in cold places like Antarctica.
  Penguins cannot fly high in the sky, but they can swim very fast in the water.
  They can catch many small fish for food.
  Penguins can also walk on ice without falling.
  A mother penguin can find her baby easily in a large group of birds.
  Young penguins can learn to swim quickly with their parents.
  Can you swim like a penguin? They are truly wonderful animals.
\end{tcolorbox}


\vspace{-4pt} \visible<2->{\small 次の各文が本文の内容とあっていればT,そうでなければFと答えましょう} 
\vspace{-11pt}
 \begin{enumerate}\setlength{\itemsep}{-3.2pt}
 \item<2-> Penguins can fly high in the sky.\hfill\visible<3->{F}
 \item<2-> Penguins can swim very fast in the water.\hfill\visible<4->{T}
 \item<2-> Penguins can catch small fish for food.\hfill\visible<5->{T}
 \item<2-> A mother penguin cannot find her baby in a large group.\hfill\visible<6->{F}
 \item<2-> Young penguins can learn to swim quickly.\hfill\visible<7->{T}
 \end{enumerate}
 \end{frame}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\section{助動詞canのまとめ}
...
\begin{block}{能力をあらわす助動詞can \textipa{/k@n/} \textipa{/k\'\ae n/}}
\begin{itemize}\setbeamertemplate{items}[square]\small
...
\includegraphics[width=1.01\textwidth]{./infographic/012_can_infographic.png}
\hfill{\tiny audio\_overview 1003}\,{\scriptsize \myaudio{./audio/overview/012_can_audio_overview.m4a}}%
\hfill{\tiny eduop\_boys 0250}\,{\scriptsize \myaudio{./audio/manzai/012_can_manzai.mp3}}
\end{frame}
%%%%%%%%%%%%%%%%%%%%%%
...
\begin{columns}
 \begin{column}{0.4\textwidth}
  \includegraphics[width=1.1\textwidth]{./test_forms/012_can_test.png}
 \end{column}
...
\url{https://forms.gle/QWnH5eQfYAhtZjyL6}
\end{frame}
%%%%%%%%%%%%%%%%%%%
\end{document}

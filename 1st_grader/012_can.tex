...
\mbox{}\hfill\myaudio{./audio/009_answer_be_09.mp3}

\begin{tabular}{rlcll}
\visible<1->{例}& \visible<1->{Can you skate?}\hspace{2\zw}\scalebox{2}{\twemoji{ice skate}}& \visible<2->{$\rightarrow$}&\visible<3->{(1) Yes, I can.}&\visible<4->{(2) No, I can't.}\\
\visible<1->{1}&\visible<1->{Can she drive a car?\hspace{10pt}\scalebox{2}{\twemoji{automobile}}}&\visible<5->{$\rightarrow$}&\visible<6->{(1) Yes, she can}&\visible<7->{(2) No, she can't.}\\
\visible<1->{2}&\visible<1->{Can they speak French?}&\visible<8->{$\rightarrow$}& \visible<9->{(1) Yes, they can.}&\visible<
10->{(2) No, they can't.}\\
\visible<1->{3}&\visible<1->{Can David and Stephen sing well?}&\visible<11->{$\rightarrow$}&\visible<12->{(1) Yes, they can.}&\visible<13->{(2) No, they can't.}\\
\visible<1->{4}&\visible<1->{Can you read English?\hspace{10pt}\raisebox{-10pt}{\bcbook}}&\visible<14->{$\rightarrow$}&\visible<15->{(1) Yes, I can.}&\visible<16->{(2) No, I can't.}
\end{tabular}

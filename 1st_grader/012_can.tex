...
\begin{itemize}\setbeamertemplate{items}[square]\small
 \item   {\bfseries can} $+$ 原形$\longrightarrow${\,\,\,}「〜することができる」
 \item   主語がなんであっても同じ\\
\hfill{\scriptsize canのように動詞と組み合わせて動詞の意味を補足する語を\kenten{助動詞}といいます}
 \end{itemize}
     \end{exampleblock}
...
\begin{itemize}\setbeamertemplate{items}[square]\small
 ...
 \item 「〜できない」$\longrightarrow${\,\,\,}$\left\{\begin{tabular}{l}\text{\bfseries cannot}\\\text{\bfseries can't}\end{tabular}\right\} + \text{原形}$\hfill{\scriptsize \textipa{/k\'\ae nAt/} \textipa{/k\'\ae nt/}}\pause
 \item 主語がなんであっても同じ
 \end{itemize}
     \end{exampleblock}

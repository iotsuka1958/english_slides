...
\begin{enumerate}
 \item<1-> I \textcolor{Maroon}{\bfseries can} {\bfseries play} the guitar.
 \item<2-> We \textcolor{Maroon}{\bfseries can} {\bfseries speak} English.
 \item<3-> You \textcolor{Maroon}{\bfseries can} {\bfseries sing} very well.
 \item<4-> He \textcolor{Maroon}{\bfseries can} {\bfseries swim}.
 \item<5-> She \textcolor{Maroon}{\bfseries can} {\bfseries read} French.
 \item<6-> They \textcolor{Maroon}{\bfseries can} {\bfseries dance} very well.
\end{enumerate}
...
\begin{itemize}\setbeamertemplate{items}[square]\small
 \item<7->   {\bfseries can} $+$ 原形$\longrightarrow${\,\,\,}「〜することができる」
 \item<8->   主語がなんであっても同じ\\
\hfill\visible<9->{\scriptsize canのように動詞と組み合わせて動詞の意味を補足する語を\kenten{助動詞}といいます}
 \end{itemize}
     \end{exampleblock}
...
\begin{enumerate}
 \item I {\bfseries can} use a computer. \hfill{\scriptsize use: 使う　computer: コンピューター\hspace{10pt}\textipa{/k@n/}}
 \item I \textcolor{orange}{\bfseries cannot} use a computer.\hfill{\scriptsize \textipa{/k\'\ae nAt/}}
 \item I \textcolor{orange}{\bfseries can't} use a computer.\hfill{\scriptsize \textipa{/k\'\ae nt/}}
\end{enumerate}
...
\begin{itemize}\setbeamertemplate{items}[square]\small
 ...
 \item   「〜することができない」$\longrightarrow${\,\,\,}$\left\{\begin{tabular}{l}\text{\bfseries cannot}\\\text{\bfseries can't}\end{tabular}\right\} + \text{原形}$\hfill{\scriptsize \textipa{/k\'\ae nAt/} \textipa{/k\'\ae nt/}}
 \end{itemize}
     \end{exampleblock}
...
\hfill{}I {\bfseries can} play the guitar. \textipa{/k@n/}
...
\hfill{}{\normalsize He {\bfseries can't} play the guitar.}\textipa{/k\'\ae nt/}\\[10pt]

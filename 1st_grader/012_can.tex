...
\begin{enumerate}
 \item<1-> I {\bfseries can} use a computer. \hfill{\scriptsize use: 使う　computer: コンピューター\hspace{10pt}\textipa{/k@n/}}
...
\begin{itemize}\setbeamertemplate{items}[square]\small
 \item<2->  「〜できる」$\longrightarrow$\,\,\, {\bfseries can} $+$ 原形\hfill{\scriptsize \textipa{/k@n/}}

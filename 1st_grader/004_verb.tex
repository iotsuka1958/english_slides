...
{\footnotesize ジョージはネコを2匹飼っています。}\visible<2->{\myCrossedOut{Maroon}{haves}}
   ...
   \item He (\onslide<7->{\textcolor{orange}{~studies~}}) English every day.{\footnotesize 彼は毎日英語を勉強します。} \onslide<8->{\myCrossedOut{Maroon}{studys}}\\
\mbox{}\hfill\onslide<9->{\scalebox{.25}{\includegraphics{./images/dbend.png}}\,\,\,\textcolor{Maroon}{study}の3単現は\textcolor{Maroon}{studies}}
  \end{enumerate}

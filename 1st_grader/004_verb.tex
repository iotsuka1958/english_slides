...
\begin{frame}[plain,label=is_verb]\frametitle{一般動詞って？}
 % \setbeamercovered{transparent}
  \begin{enumerate}
   \item<1-> \myEmph[14-]{Maroon}{I} \myEmph[14-]{NavyBlue}{like} basketball. \onslide*<2-12>{{\small わたしはバスケットボールが好きです。}}\hfill\onslide*<22->{\footnotesize 　like: 好き、好む　basketball: バスケットボール}
   \item<3-> \myEmph[15-]{Maroon}{We} \myEmph[15-]{NavyBlue}{walk} to work. \onslide*<4-12>{{\small われわれは歩いて職場へ行きます。}}\hfill\onslide*<23->{\footnotesize 　walk: 歩く}
   \item<5-> \myEmph[16-]{Maroon}{They} \myEmph[16-]{NavyBlue}{speak} English in Australia. \onslide*<6-12>{{\small オーストラリアでは英語が話されています。}}\hfill\onslide*<24->{\footnotesize 　speak: 話す　Australia:オーストラリア}
   \item<7-> \myEmph[17-]{Maroon}{I} \myEmph[17-]{NavyBlue}{drink} tea every morning. \onslide*<8-12>{{\small わたしは毎朝お茶を飲みます。}}\hfill\onslide*<25->{\footnotesize 　drink: 飲む　tea: お茶　every morning: 毎朝}
   \item<9-> \myEmph[18-]{Maroon}{They} \myEmph[18-]{NavyBlue}{study} math every day. \onslide*<10-12>{{\small 彼らは毎日数学を勉強します。}}\hfill\onslide*<26->{\footnotesize study: 勉強する　math: 数学　every day: 毎日}
   \item<11-> \myEmph[19-]{Maroon}{I} \myEmph[19-]{NavyBlue}{play} the guitar. \onslide*<12>{{\small わたしはギターをひきます。}}\hfill\onslide*<27->{\footnotesize 　play: (楽器などを)演奏する　guitar: ギター}
  \end{enumerate}
...
\begin{frame}<1-20>[plain]\frametitle{主語によって動詞のかたちが定まる}
 % \setbeamercovered{transparent}
  \begin{enumerate}
   \item<1-> \myEmph[2-]{Maroon}{I} \myEmph[2-]{NavyBlue}{like} music. \hfill\onslide*<2->{\scriptsize 　like: 好き、好む　music: 音楽}
   \item<1-> \myEmph[3-]{Maroon}{We} \myEmph[3-]{NavyBlue}{like} music.
   \item<1-> \myEmph[4-]{Maroon}{You} \myEmph[4-]{NavyBlue}{like} music.
   ...
   \item<1-> \myEmph[8-]{Maroon}{They} \myEmph[8-]{NavyBlue}{like} music.
  \end{enumerate}
...
%  \item I~~(\onslide<2,8,9>{\textcolor{orange}{~have~}})~~two cats.
   \item We~~(\onslide<2,8,9>{\textcolor{orange}{~go~}})~~to the park by bus.
...
\begin{frame}[plain,label=exception]\frametitle{s以外の3単現}
  ...
  \begin{enumerate}
   ...
   \item<3-> He \myEmph[3,15,16]{Maroon}{goes} to the station by bus. \hspace{10pt}\onslide<4,19>{(go \textcolor{Maroon}{ $+$ es })}

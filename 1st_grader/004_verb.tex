...
&原形&3単現&発音\\\midrule
\rowcolor{NavyBlue!40} % 1行目：紺
1&\visible<1->{play}&\visible<2->{plays}&\visible<10->{\textipa{/z/}}\\
\rowcolor{yellow!40}   % 2行目：黄
2&\visible<1->{drink}&\visible<3->{drinks}&\visible<11->{\textipa{/s/}}\\
\rowcolor{NavyBlue!40} % 3行目：紺
3&\visible<1->{go}&\visible<4->{goes}&\visible<12->{\textipa{/z/}}\\
\rowcolor{yellow!40}   % 4行目：黄
4&\visible<1->{teach}&\visible<5->{teaches}&\visible<13->{\textipa{/\textsci{}z/}}\\
\rowcolor{NavyBlue!40} % 5行目：紺（ここを修正しました）
5&\visible<1->{wash}&\visible<6->{washes}&\visible<14->{\textipa{/\textsci{}z/}}\\
\rowcolor{yellow!40}   % 6行目：黄
6&\visible<1->{watch}&\visible<7->{watches}&\visible<15->{\textipa{/\textsci{}z/}}\\
\rowcolor{NavyBlue!40} % 7行目：紺
7&\visible<1->{have}&\visible<8->{has}&\visible<16->{\textipa{/z/}}\\
\rowcolor{yellow!40}   % 8行目：黄

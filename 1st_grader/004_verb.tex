...
%% Q
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\begin{frame}<1-6>[plain,label=queen]{Quiz}
 \large
\visible<1->{%
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
{
  \usebackgroundtemplate{\includegraphics[width=\paperwidth]{./images/playing_cards.jpg}}
  \begin{frame}[t]
    \frametitle{}
\tiny
\raggedleft
  \textcolor{white}{``poker'' by shoobydooby is licensed under CC BY 2.0. To view a copy of this license,}\\

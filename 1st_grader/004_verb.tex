...
%% O
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\begin{frame}[plain,label=onion]{Quiz}
 \large
\visible<1->{%
...
\mbox{}\hfill\visible<1->{\myaudio{./audio/quiz/quiz_o.mp3}}
...
\large
\mbox{}\hfill\visible<1->{\myaudio{./audio/quiz/answer_o.mp3}}
\end{frame}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
He live\textcolor{Maroon}{\bfseries s} in Boton.\pause
...
\subsection{s以外の3単現}
\begin{frame}<1-18>[plain]\frametitle{s以外の3単現}

  \begin{enumerate}
   \item<1-> She \myEmph[2,13]{Maroon}{drinks} coffee every morning. \hspace{10pt}\onslide<2>{(drink \textcolor{Maroon}{$+$ s })}
   \item<3-> He \myEmph[3,14]{Maroon}{goes} to school by bus. \hspace{10pt}\onslide<4>{(go \textcolor{Maroon}{ $+$ es })}
  \item<5-> John \myEmph[5,14]{Maroon}{teaches} math. \hspace{10pt}\onslide<6>{(teach \textcolor{Maroon}{ $+$ es })}
    \item<7-> My father \myEmph[7,14]{Maroon}{washes} his car every Sunday. \hspace{10pt}\onslide<8>{(wash \textcolor{Maroon}{ $+$ es })}
   \item<9-> Jane \myEmph[9,14]{Maroon}{watches} television after supper. \hspace{10pt}\onslide<10>{(watch \textcolor{Maroon}{ $+$ es })}
   \item<11-> She \myEmph[11,15]{Maroon}{has} two cats. \hspace{10pt}\onslide<12>{\textcolor{Maroon}{(haveの3単元はhas)}}
  \end{enumerate}
...
\mbox{}\hspace{70pt}\onslide<14->{{\scriptsize 例えば}{\small drinks, eats, likes, lives, plays, speaks, walks\ldots{}}}
 \item<2-> \onslide<15->{\myEmph[15]{Maroon}{一部の動詞：\,\,---es}}\\
\mbox{}\hspace{70pt}\onslide<16->{{\small go, teach, wash, watch}{\small は覚えよう}}
 \item<3-> \onslide<17->{\myEmph[17]{Maroon}{haveの3単現：\,\, has}\hspace{20pt}}\onslide<18>{$\longleftarrow$\, havesではない！}
\end{itemize}
      \end{exampleblock}
...
8&\visible<17->{study}&\visible<17->{{\small studies}}&\visible<17->{\textipa{/z/}}\\
\bottomrule
\end{tabular}%
\end{center}

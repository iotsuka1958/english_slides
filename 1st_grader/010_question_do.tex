...
(*Does he sing\textcolor{red}{s} well?\,\,\dbend)
\end{tabular}
}
...
\begin{itemize}\small
 ...
 \item<13->   文末に\Circled[fill color=yellow!50]{?}をつける（イントネーションは\myRisingPitch{}）\pause\\
...
一般動詞の疑問文のつくり方
\begin{itemize}\small
 \item<3->   先頭に\,\Circled[fill color = yellow!50]{\,\,Do\,\,}\,または\,\Circled[fill color = yellow!50]{\,\,Does\,\,}\hspace{15pt}---DoesをもちいるのはS{\scriptsize ($=\text{主語}$)}が3人称単数のとき---\\
	 \mbox{}\hspace{15pt}\Circled[fill color = yellow!50]{\,\,Do\,\,}\,$+$\,S\,$+$\,V{\scriptsize ($=$\,原形)} \ldots\,\,\,?\\
	 \mbox{}\hspace{15pt}\Circled[fill color = yellow!50]{\,\,Does\,\,}\,$+$\,S\,$+$\,V{\scriptsize ($=$\,原形)} \ldots\,\,\,?
% \item   文末に`?'をつける
\end{itemize}
\end{exampleblock}
\end{frame}

...
\end{frame}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\section{Listen, Then Read\,\,\,\,\,{\tiny 0038}\,{\scriptsize \myaudio{./audio/010_question_do_reading.mp3}}}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
before upper={\setlength{\parindent}{1.25em}},
 title={New Friends at School\hfill{\tiny 0038}\quad{\scriptsize \myaudio{./audio/010_question_do_reading.mp3}}}
]
\noindent{}Ken meets Emma at school on Monday morning.
They talk about their hobbies.

Ken asks, ``Do you like sports, Emma?''
Emma answers, ``Yes, I do.
I play soccer every weekend.''
Ken smiles and asks, ``Do you play tennis, too?''
``No, I do not,'' Emma says.
``Do you play tennis?''
``Yes, I do.
I practice every day,'' Ken says.
``Do you practice at school?'' asks Emma.
``Yes, I do.
Let's play tennis together someday!'' says Ken.
\end{tcolorbox}
...
\item<2-> Ken and Emma talk about their hobbies at school.\hfill\visible<3->{T}
\item<2-> Emma plays soccer every weekend.\hfill\visible<4->{T}
\item<2-> Emma plays tennis, too.\hfill\visible<5->{F}
\item<2-> Ken practices tennis every day at school.\hfill\visible<6->{T}
\item<2-> Ken does not want to play tennis with Emma.\hfill\visible<7->{F}
\end{enumerate}
\end{frame}
%%%%%%%%%%%%%%%%%%%%%
\section{まとめ}%
...
\begin{itemize}\setbeamertemplate{items}[square]
 ...
 \item 主語(S)が3人称単数のときは\,\Circled[fill color=white]{\,\,Does\,\,}\,（それ以外はすべて\,\Circled[fill color=white]{\,\,Do\,\,}\,）\\
	 \Circled[fill color = white]{\,\,Do\,\,}\,$+$\,S\,$+$\,V{\scriptsize ($=$\,原形)} \ldots\,\,\,?\hfill{}\textbf{Do} you like sushi?\\
	 \Circled[fill color = white]{\,\,Does\,\,}\,$+$\,S\,$+$\,V{\scriptsize ($=$\,原形)} \ldots\,\,\,?\hfill{}{\bfseries Does} she play the guitar?\\
\hfill{}*{\bfseries Do\Circled[fill color= white]{es}} she play\Circled[fill color = white]{\textbf{s}} the guitar?\\
\hfill{\scriptsize 三単現はダブらせない！}
 \item  文末に\,\Circled[fill color=white]{?}\,をつける / イントネーションは\myRisingPitch{}{\scriptsize （お尻を\kenten{くいッ}とあげましょう）}
% \item   文末に`?'をつける
\end{itemize}
     \end{block}

\begin{block}{Pronunciation}
\mbox{}\hfill{}\textbf{do} \textipa{/d@/}\hspace{30pt}\textbf{does} \textipa{/d@z/}\hfill\mbox{}
\end{block}
...
\includegraphics[width=1.01\textwidth]{./infographic/010_question_do_infographic.png}
\hfill{\tiny audio\_overview 1809}\,{\scriptsize \myaudio{./audio/overview/010_question_do_audio_overview.mp4}}%
\hfill{\tiny eduop\_boys 0312}\,{\scriptsize \myaudio{./audio/manzai/010_question_do_manzai.mp3}}
\end{frame}
%%%%%%%%%%%%%%%%%%%%%%
%% 確認問題は011_answer_do.texとあわせて次のセクションで実施
\end{document}

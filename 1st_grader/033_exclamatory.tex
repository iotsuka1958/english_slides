...
%\usepackage[grid=true,gridcolor=Maroon,subgridcolor=gray,gridunit=pt,texcoord]{eso-pic} 
%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
\pause
\textbf{What} \textipa{/w\'At/} を用いた感嘆文\hfill{\tiny 0245}\,{\scriptsize \myaudio{./audio/033_exclamatory_01.mp3}}
...
{\small 日本語の意味になるよう空所に適当な単語を補いましょう}
 ...
 \end{enumerate}
\hfill{\tiny 0136}\,{\scriptsize \myaudio{./audio/033_exclamatory_02.mp3}}
\end{frame}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
\begin{block}{Topics for Today}
\pause
\textbf{How} \textipa{/h\'aU/} を用いた感嘆文\hfill{\tiny 0241}\,{\scriptsize \myaudio{./audio/033_exclamatory_03.mp3}}
...
\end{block}
\vspace*{-5pt}
\hfill{\tiny 0227}\,{\scriptsize \myaudio{./audio/033_exclamatory_04b.mp3}}
...
名詞の\\有無が鍵
\end{tabular}},
bubblecolour=white!50!pink,scale=1.1414]
\end{tikzpicture}}
\end{textblock*}
\end{frame}
%%%%%%%%%%%%%%%%%%%%%%%%
...
{\small 日本語の意味になるよう(~~~~~~)内の単語を並べ替えましょう。先頭に来る語は大文字で始めてください}\hfill{\tiny 0157}\,{\scriptsize \myaudio{./audio/033_exclamatory_04.mp3}}
...
{\small 日本語の意味になるよう(~~~~~~)内の語句を並べ替えましょう。先頭に来る語は大文字で書き始めてください。なお $[ +1 ]$とある場合は不足している1語を補ってください。$[ -1 ]$とある場合は余計な1語が含まれています}\hfill{\tiny 0135}\,{\scriptsize \myaudio{./audio/033_exclamatory_05.mp3}}
 \
 \begin{enumerate}
  ...
  \item この本はなんておもしろいのでしょう。\hfill{\scriptsize cf. This book is interesting.}\\
	...
	\visible<3->{How interesting this book is! (✕ an)}
...
{\small 日本語の意味になるよう空所にHowまたはWhatを補いましょう}\hfill{\tiny 0232}\,{\scriptsize \myaudio{./audio/033_exclamatory_06.mp3}}
\begin{enumerate}
 \item  なんて運がいいんだろう。\\
 ...
 \item まあ、きれいな花。\\
       (~~\alt<7->{What}{\phantom{How}}~~) beautiful flowers!
\end{enumerate}

\begin{textblock*}{0.4\linewidth}(300pt,140pt)
...
{\small ひとつ余計なものが含まれています}\hfill{\tiny 0021}\,{\scriptsize \myaudio{./audio/033_exclamatory_07.mp3}}
...
\bigskip
 ...
 \begin{columns}[b]
   \begin{column}[T]{.5\textwidth}
    ...
    \end{tabular}
\footnotetext{$^1$ you see あのね}
\footnotetext{$^2$ rock \textipa{/r\'Ak/}岩}
\footnotetext{$^3$ through a day 1日を通して}
\footnotetext{$^4$ want to ---したい}
   \end{column}
%%%%%%%%%%%%%%%
    ...
    \begin{tcolorbox}[title=選択肢]
     ...
     \CID{7556} How small!\\
     \CID{7557} How strange!\hfill{\tiny strange:奇妙な}\\
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
{
  \usebackgroundtemplate{\includegraphics[width=.875\paperwidth]{./images/ayers_rock.jpg}}
  \begin{frame}[t,plain]
    \frametitle{}
\tiny
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\section{Listen, Then Read\,\,\,\,\,{\tiny 0044}\,{\scriptsize \myaudio{./audio/033_exclamatory_reading.mp3}}}
%%%%%%%%%%%%%%%%%%%%%%
\begin{frame}[plain]
 
\includegraphics[width=1.01\textwidth]{./images/nanobanana-output/033_exclamatory_reading.png}

\vspace{-15pt}

\hfill{\tiny 0044}\,{\scriptsize \myaudio{./audio/033_exclamatory_reading.mp3}}
...
before upper={\setlength{\parindent}{1.25em}},
 title={A Day at the Park}\hfill{\tiny 0047}\,{\scriptsize \myaudio{./audio/hoge_reading.mp3}}
]
\noindent{}Today, I went to a big park with my family.
What a beautiful day it was!
The sun was bright and warm.

We saw many flowers.
How pretty they were!
My brother ran on the grass.
How fast he runs!
We also saw a big dog.
What a cute dog it was!

We ate sandwiches under a tree.
They were very good.
...
\item<2-> The writer went to the park with friends.\hfill\visible<3->{F}
\item<2-> The weather was nice today.\hfill\visible<4->{T}
\item<2-> The writer's brother ran very fast.\hfill\visible<5->{T}
\item<2-> They saw a big cat at the park.\hfill\visible<6->{F}
\item<2-> They ate sandwiches under a tree.\hfill\visible<7->{T}
\end{enumerate}
\end{frame}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\section{感嘆文のまとめ}
...
\hfill{\tiny 0127}\,{\scriptsize \myaudio{./audio/033_exclamatory_08.mp3}}
\end{frame}
\begin{tikzpicture}
...
\begin{columns}
 \begin{column}{0.4\textwidth}
  \includegraphics[width=1.1\textwidth]{./test_forms/033_exclamatory_test.png}
 \end{column}
...
\url{https://forms.gle/9C1YW44gwANxDeb86}
\end{frame}
%%%%%%%%%%%%%%%%%%%
\end{document}

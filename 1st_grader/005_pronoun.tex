...
\item<2-> The friends do not like the robot's dance.\tikzmark{q5}\hfill\visible<7->{F}
\end{enumerate}
...
\begin{enumerate}
 ...
 \item<4-> darkness $=$ dark $+$ ness\hfill{}It was a \textbf{dark} night.
 \item<5-> happiness $=$ happy $+$ ness\hfill{}Dave was \textbf{happy}.

...
hline{3} = {1-7}{ 0.04em },
 ...
 &単数&&&複数&& \\
 & &主格 &目的格 & &主格 &目的格 \\
1人称&私 & \onslide<2->{I}&\onslide<3->{me} &私たち &\onslide<4->{we} &\onslide<5->{us} \\
2人称&あなた & \onslide<6->{you}&\onslide<6->{you} &あなたたち &\onslide<6->{you} &\onslide<6->{you} \\
3人称&彼 & \onslide<7->{he}& \onslide<8->{him}&彼ら &\onslide<12->{they} & \onslide<13->{them}\\
 &彼女 & \onslide<9->{she}& \onslide<10->{her}&彼女たち & &\\
 &それ & \onslide<11->{it}& \onslide<11->{it}&それら & & \\
\end{tblr}
...
\hfill{}itsとit'sは、発音は同じです\hspace*{1\zw}
     \end{exampleblock}
}
\end{frame}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%

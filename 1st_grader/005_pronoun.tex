...
\visible<7->{BillyやDianaは変化しないが、代名詞は変化する！}\hfill{\tiny 0204}\,{\scriptsize \myaudio{./audio/005_pronoun_1.mp3}\,1}
\end{frame}
%%%%%%%%%%%%%%%%%%
\subsection{主格・目的格}
%%%%%%%%%%%%%%%%%%
...
{\small 正しいほうを〇で囲みましょう}\hfill{\tiny 0238}\,{\scriptsize \myaudio{./audio/005_pronoun_2.mp3}\,2}
 \begin{enumerate}
...
\hfill\visible<8->{\raisebox{5pt}{\dbend}\,\,前置詞の後にくるときも\kenten{目的格}をつかいます！}
...
\begin{itemize}\setbeamertemplate{items}[circle]
 \item<5-> 前置詞のあとも\kenten{目的格}をつかいます
       \begin{enumerate}
	\item<6-> I play tennis with my friends.
	\item<7-> I play tennis with \textcolor{Maroon}{\textbf{them}}.\hspace{30pt}\myCrossedOut{Maroon}{with they}
       \end{enumerate}
 \item<8-> 前置詞のあとにくる語を「前置詞の目的語」といいます\hfill{}cf. 動詞の目的語
\end{itemize}
     \end{block}

\hfill{\tiny 0248}\,{\scriptsize \myaudio{./audio/005_pronoun_2a.mp3}\,2a}
\end{frame}
%%%%%%%%%%%%%%%%%%%%%%%%
\subsection{所有格}
\begin{frame}[plain]{所有格}
 \begin{enumerate}
  \item<2-> This is \myEmph[2-]{Maroon}{my} car. That is \myEmph[2-]{Maroon}{your} bike.
  \item<6-> *This is my a car. / *This is a my car.\hfill{\scriptsize * 「まちがった英文です」という記号}
 \end{enumerate}


\begin{block}<3->{Topics for Today}
\begin{itemize}\setbeamertemplate{items}[circle]
 \item \textbf{my}は\textbf{I}が変化したかたちで「わたしの～」の意味\\
\textbf{your}は\textbf{you}が変化したかたちで「あなたの～」の意味
 \item<4-> \textbf{my}や\textbf{your}を\kenten{所有格}の代名詞といいます\hfill{}cf. 主格、目的格
 \item<5-> \Circled[fill color=white]{\,\,所有格 $+$ 名詞\,\,}\,がセットになります
 \item[]<7-> \mbox{}\hfill\dbend\,\,my a carとかa my carとはいいません\hspace{.5\zw}\mbox{}\\
\mbox{}
%\hfill{}my booksはOKです
\end{itemize}
     \end{block}
\hfill{\tiny 0100}\,{\scriptsize \myaudio{./audio/005_pronoun_2b.mp3}\,2b}

\end{frame}
%%%%%%%%%%%%%%%%%%%%%%%%%%
\begin{frame}[plain]{Challenge}
 なんといっていますか？\pause

\begin{enumerate}[<+->]
 \item This is \textbf{my} book.
 \item He is \textbf{our} father.
 \item \textbf{Your} cat is cute.
 \item \textbf{His} bike is new.
 \item This is \textbf{her} cat.
 \item The robot moves \textbf{its} arm.\hfill{}cf. She moves \textbf{her} arm.
 \item \textbf{Their} house is big.
\end{enumerate}

\hfill{\tiny 0304}\,{\scriptsize \myaudio{./audio/005_pronoun_2c.mp3}\,2c}
...
\hfill\onslide<11>{代名詞は、しょっちゅうでてきます}
\hspace{1\zw}{\tiny 0448}\,{\scriptsize \myaudio{./audio/005_pronoun_21.mp3}\,21}
...
\hfill{\tiny 0503}\,{\scriptsize \myaudio{./audio/005_pronoun_3.mp3}\,3}
...
\Large
 \begin{enumerate}
  \item<2-> \textcolor{NavyBlue}{\bfseries It's} a nice car.\hfill{}it's $=$ it is
...
\hfill{\tiny 0112}\,{\scriptsize \myaudio{./audio/005_pronoun_3a.mp3}\,3a}
...
\hfill{}{\scriptsize owner $=$ own $+$ er}\\
	\hfill{}{\scriptsize own \textipa{/\'oUn/} 所有する}
  \item That is a nice car.\,\,\,\,\,(  Its / \alt<3->{\Circled{It's}}{It's} ) very expensive.\hfill{\scriptsize expensive \textipa{/Iksp\'ensIv/} 高価な}
 \end{enumerate}

\vfill

\hfill{\tiny 0121}\,{\scriptsize \myaudio{./audio/005_pronoun_4.mp3}\,4}
\end{frame}
%%%%%%%%%%%%%%%%%%%%%%
\section{Listen, Then Read\,\,\,\,\,{\tiny 0027}\,{\scriptsize \myaudio{./audio/005_pronoun_reading.mp3}\,{\tiny reading}}}
%%%%%%%%%%%%%%%%%%%%%%
\begin{frame}[plain]
...
\hfill{\tiny 0027}\,{\scriptsize \myaudio{./audio/005_pronoun_reading.mp3}\,{\tiny reading}}
...
before upper={\setlength{\parindent}{1.25em}},
 title={{}Our Smart Robot}{}\hfill{\tiny 0027}\,{\scriptsize \myaudio{./audio/005_pronoun_reading.mp3}\,{\tiny reading}}
]
My family has a new robot.
Its name is Robo.\tikzmark{clue1}
It helps us every day.
My father likes it.
It cleans his room.\tikzmark{clue2}
My mother loves Robo, too.
It cooks dinner\tikzmark{clue3} for her.
My sister and I play with it after school.\tikzmark{clue4}
It is our good friend.
We show its funny dance to our friends.
They like it very much.\tikzmark{clue5}
Robo brings \hyperlink{ness}{happiness} to us.
...
\item<2-> The \hyperlink{possessive}{robot's} name is Robo.\tikzmark{q1}\hfill\visible<3->{T}
\item<2-> The robot cleans the \hyperlink{possessive}{father's} room.\tikzmark{q2}\hfill\visible<4->{T}
\item<2-> The mother cooks dinner for the robot.\tikzmark{q3}\hfill\visible<5->{F}
\item<2-> The children play with the robot before school.\tikzmark{q4}\hfill\visible<6->{F}
\item<2-> The friends \hyperlink{DONOT}{don't} like the robot's dance.\tikzmark{q5}\hfill\visible<7->{F}
\end{enumerate}

\hfill{}{\scriptsize bring A to B（AをBに持ってくる、もたらす）}

\begin{tikzpicture}[remember picture,overlay]
 \visible<3>{\draw[<-,opacity=.4,line width=2pt] ([xshift=-15pt,yshift=-2pt]pic cs:clue1) to[bend left] ([xshift=2pt, yshift=2pt] pic cs:q1);}
 \visible<4>{\draw[<-,opacity=.4,line width=2pt] ([yshift=-2pt]pic cs:clue2) to[bend left] ([xshift=2pt, yshift=2pt] pic cs:q2);}
 \visible<5>{\draw[<-,opacity=.4,line width=2pt] ([xshift=-20pt,yshift=-2pt]pic cs:clue3) to[in=0,out=-90] ([xshift=2pt, yshift=2pt] pic cs:q3);}
 \visible<6>{\draw[<-,opacity=.4,line width=2pt] ([xshift=-30pt,yshift=-2pt]pic cs:clue4) to[out=-45, in=0] ([xshift=2pt, yshift=2pt] pic cs:q4);}
 \visible<7>{\draw[<-,opacity=.4,line width=2pt] ([xshift=-30pt,yshift=-2pt]pic cs:clue5) to[out=-90, in=0] ([xshift=2pt, yshift=2pt] pic cs:q5);}
\end{tikzpicture}
\end{frame}
%%%%%%%%%%%%%%%%%%%%
\begin{frame}[plain]{名詞の所有格}
\hypertarget{possessive}{}
\begin{enumerate}[<+->]
 \item He is \textbf{Jane's} father.\hfill{}cf. He is \textbf{her} father.
 \item I know \textbf{Mike's} mother.\hfill{}cf. I know \textbf{his} mother.
 \item This is \textbf{my mother's} car.\hfill{}cf. This is \textbf{her} car.
\end{enumerate}

\begin{block}{Topics for Today}
\begin{itemize}\setbeamertemplate{items}[circle]
 \item 名詞の所有格は、\Circled[fill color=white]{\,\,名詞\textbf\,\textbf{'s}\,\,}\hfill{}cf. 代名詞の所有格
 \item つまり「AのB」は、\textbf{A's B}
\end{itemize}
     \end{block}

\hfill{\tiny 0135}\,{\scriptsize \myaudio{./audio/005_pronoun_5.mp3}\,5}

\hfill\hyperlink{reader}{\beamerbutton{reader}}

\end{frame}
%%%%%%%%%%%%%%%%%%%%%
\begin{frame}[plain]{---ness}
\hypertarget{ness}{}

\begin{enumerate}
 \item<2-> kindness $=$ kind $+$ ness\hfill{}Jack is \textbf{kind}.
 \item<4-> darkness $=$ dark $+$ ness\hfill{}It is a \textbf{dark} night.
 \item<5-> happiness $=$ happy $+$ ness\hfill{}Dave is \textbf{happy}.
 \item<3-> 形容詞 $+$ ness $\longrightarrow$ 名詞
\end{enumerate}
...
\begin{enumerate}[<+->]
 \item I like cheese.
 \item I \textbf{don't} like cheese.
\end{enumerate}

\hfill{\tiny 0110}\,{\scriptsize \myaudio{./audio/005_pronoun_6.mp3}\,6}
...
\hfill{\tiny 0413}\,{\tiny\myaudio{./audio/005_pronoun_word.mp3}\,word}
\pause
\vspace{-10pt}
\large
 ...
 \item subject \textipa{/s\'2bdZIkt/}\hfill\visible<4->{{\scriptsize \Circled{\,名\,} 科目、教科}}
 ...
 \item bring \textipa{/br\'IN/}\hfill\visible<10->{{\scriptsize \Circled{\,動\,} ～を持ってくる、もたらす}}
 \end{enumerate}

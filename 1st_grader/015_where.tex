...
\begin{enumerate}\setlength{\itemsep}{-2pt}
 \item<2-> The cap is under the table.\hfill\visible<3->{T}
 \item<2-> The cap is under the table.\hfill\visible<4->{F}

...
\end{frame}
%%%%%%%%%%%%%%%%%%%%%%
\section{聞いてみよう、読んでみよう{\tiny 0037}\,{\scriptsize \myaudio{./audio/015_where_reading.mp3}}}
%%%%%%%%%%%%%%%%%%%%%%
\begin{frame}[plain]
...
\hfill{\tiny 0037}\,{\scriptsize \myaudio{./audio/015_where_reading.mp3}}
...
before upper={\setlength{\parindent}{1.25em}},
 title=Ken's Busy Morning\mbox{}\hfill{\tiny 0037}\,{\scriptsize \myaudio{./audio/015_where_reading.mp3}}
]
...
\begin{enumerate}
 \item<3-> The mother asks, ``Can you help me?''
 \item<4-> ``Can you help me?'' the mother asks.
 \item<5-> ``Can you help me?'' asks the mother.
\end{enumerate} 
...
say \textipa{/s\'eI/}\hspace{20pt}\visible<2->{三単現はsays \textipa{/s\'ez/}}
 ...
 \begin{enumerate}
  \item<3-> The boy says, ``I'm hungry.''
  \item<4-> ``I'm hungry,'' the boy says.
  \item<5-> ``I'm hungry,'' says the boy.
 \end{enumerate}
\end{frame}

...
%\UseTblrLibrary{booktabs} % for \toprule, \midrule, \bottomrulex
...
\begin{enumerate}
   \item<1-> \myEmph[9,17]{Maroon}{I} \myEmph[9,17]{NavyBlue}{like} music. \hfill{\scriptsize 　like \textipa{/l\'aIk/} 好き、好む　music \textipa{/mj\'u:zIk/} 音楽}
...
\begin{enumerate}
 ...
 \item<5-> \begin{enumerate}
	\item She walks to work every day.\hfill{}{\scriptsize work \textipa{/w\'\textrhookschwa :k/} 職場}
...
{\small つぎの(~~~~~~~~~~)に下の枠から適当な動詞を選び、適当な形にして補いましょう}

\begin{enumerate}
	\item I~~(\visible<2->{~~studied~~}) math last night. %
\hfill\visible<2->{\myCrossedOut{Maroon!50}{studyed}}        
 \item The baby~~(\visible<3->{~~cried~~}) on the bus yesterday.%
\hfill\visible<3->{\myCrossedOut{Maroon!50}{cryed}}
	\item The train (\visible<4->{~~stopped~~}) at every station two years ago.%
\hfill\visible<4->{\myCrossedOut{Maroon!50}{stoped}}
\end{enumerate}
...
\begin{block}<6->{yで終わる動詞の過去形}\small
 \begin{enumerate}
  \item<7-> \Circled[fill color = white]{\,子音字\,} $+$ y $\longrightarrow$ yをiに変えてedをつける%
...
\hfill{}car\Circled[fill color=white]{r}y $\rightarrow$ carr\textcolor{NavyBlue}{\bfseries ied}
  \item<8-> \Circled[fill color = white]{\,母音字\,} $+$ y $\longrightarrow$ edをつける\hfill{}pl\Circled[fill color=white]{a}y $\rightarrow$ play\textcolor{Maroon}{\bfseries ed}\\
...
\hfill\visible<10->{\textdbend\,\,細かく見るといろいろありますが、でも語尾はみんな\textbf{ed}!}
...
\end{frame}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\section{Listen, Then Read\,\,\,\,\,{\tiny 0031}\,{\scriptsize \myaudio{./audio/025_past_do_reading.mp3}}}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
before upper={\setlength{\parindent}{1.25em}},
 title={A Busy Saturday\hfill{\tiny 0034}\quad{\scriptsize \myaudio{./audio/025_past_do_reading.mp3}}}
]
Last Saturday, Ken visited his grandparents in the countryside. He arrived at their house at ten in the morning.

In the morning, Ken helped his grandfather in the garden. They planted some flowers and watered the vegetables together.

At noon, his grandmother cooked delicious pasta for lunch. They talked about his school life and laughed a lot.

In the afternoon, Ken walked in the park near the house. He played soccer with local children. He enjoyed his day very much.
\end{tcolorbox}

\vspace{-5pt}
%\visible<2->{\small 次の各文が本文の内容とあっていればT,そうでなければFと答えましょう}
%\vspace{-12pt}
\begin{enumerate}\small\setlength{\itemsep}{-3.5pt}
\item<2-> Ken visited his grandparents last Sunday.\hfill\visible<3->{F}
\item<2-> Ken helped his grandfather in the garden.\hfill\visible<4->{T}
\item<2-> His grandfather cooked pasta for lunch.\hfill\visible<5->{F}
\item<2-> Ken played soccer with local children in the afternoon.\hfill\visible<6->{T}
\item<2-> Ken enjoyed his day very much.\hfill\visible<7->{T}
\end{enumerate}
\end{frame}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
\includegraphics[width=1.01\textwidth]{./infographic/025_past_do_infographic.png}
\hfill{\tiny audio\_overview 1444}\,{\scriptsize \myaudio{./audio/overview/025_past_do_audio_overview.m4a}}%
\hfill{\tiny eduop\_boys 0459}\,{\scriptsize \myaudio{./audio/manzai/025_past_do_manzai.mp3}}
\end{frame}
%%%%%%%%%%%%%%%%%%%%%%
...
\begin{columns}
 \begin{column}{0.4\textwidth}
  \includegraphics[width=1.1\textwidth]{./test_forms/025_past_do_test.png}
 \end{column}
...
\url{https://forms.gle/WmvvDUFyNW2qUtkYA}
\end{frame}
%%%%%%%%%%%%%%%%%%%
\end{document}

...
でも、つぎの動詞に注意\pause
       \begin{enumerate}
	\item --eで終わる動詞はdだけつける\hfill{}lik\Circled{e} $\rightarrow$ like\textcolor{OliveGreen}{\bfseries d}\pause
	\item --yで終わる動詞\pause
\begin{itemize}
...
\hfill{}enj\Circled{o}y $\rightarrow$ enjoy\textcolor{Maroon}{\bfseries ed}\pause
	...
	\item stopは最後のｐを重ねてed\,\,\,\,\,stop$\longrightarrow$ stopped
       \end{enumerate}\pause
 \item go, come, eat, have, makeなど不規則な変化をする動詞もあります
\end{enumerate}
...
\end{frame}
%%%%%%%%%%%%%%%%%%%%%%
\againframe<21>{tableofirregularverb}
\end{document}

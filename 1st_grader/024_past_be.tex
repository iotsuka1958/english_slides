...
\visible<2->{\begin{block}{否定文のつくり方}
\small
\setbeamertemplate{items}[circle]
\begin{itemize}
 \item 否定文にするには、be動詞の直後に\,\Circled[fill color = white]{\,\,not\,\,}\,を置きます(現在形のときと同じです)\\
...
\setbeamertemplate{items}[circle]
\begin{itemize}
 \item 疑問文にするには、be動詞を先頭に置きます(現在形のときと同じです)\\

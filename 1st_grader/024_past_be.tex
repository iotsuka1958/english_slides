...
\end{frame}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\section{Listen, Then Read\,\,\,\,\,{\tiny 0031}\,{\scriptsize \myaudio{./audio/024_past_be_reading.mp3}\,07a}}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
before upper={\setlength{\parindent}{1.25em}},
 title={A Rainy Sunday at Home\hfill{\tiny 0031}\quad{\scriptsize \myaudio{./audio/024_past_be_reading.mp3}}}
]
Yesterday, the weather was not good. It was very rainy and cold all day.

My brother and I were not at school because it was Sunday. We were at home with our cat, Leo.

In the morning, Leo was on the sofa. He was very quiet and sleepy.
My parents were in the kitchen. They were busy with cooking lunch.
The soup was warm and delicious. It was a peaceful and happy Sunday for our family.
\end{tcolorbox}
...
\item<2-> The weather was sunny yesterday.\hfill\visible<3->{F}
\item<2-> The children were at home on Sunday.\hfill\visible<4->{T}
\item<2-> Leo was noisy in the morning.\hfill\visible<5->{F}
\item<2-> The parents were busy in the kitchen.\hfill\visible<6->{T}
\item<2-> The soup was warm and delicious.\hfill\visible<7->{T}
\end{enumerate}
\end{frame}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\section{まとめ}
...
\begin{numcases}{\text{主語できまります\,\,\,\,}}
 ...
 \text{\mbox{}\,\,{}複数(2人、2つ以上)}&$\longrightarrow$\,\,\,\,\,\,{}\text{were}
\end{numcases}
}
\end{block}
...
\includegraphics[width=1.01\textwidth]{./infographic/024_past_be_infographic.png}
\hfill{\tiny audio\_overview 1655}\,{\scriptsize \myaudio{./audio/overview/024_past_be_audio_overview.m4a}}%
\hfill{\tiny eduop\_boys 0444}\,{\scriptsize \myaudio{./audio/manzai/024_past_be_manzai.mp3}}
\end{frame}
%%%%%%%%%%%%%%%%%%%%%%
...
\begin{columns}
 \begin{column}{0.4\textwidth}
  \includegraphics[width=1.1\textwidth]{./test_forms/024_past_be_test.png}
 \end{column}
...
\url{https://forms.gle/kMn3zJgawy8FHyhH9}
\end{frame}
%%%%%%%%%%%%%%%%%%%
\end{document}

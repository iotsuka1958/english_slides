...
\begin{tikzpicture}[remember picture,overlay]
 \visible<2->{\draw[->,opacity=0.4,line width=2pt] ([xshift=8pt,yshift=-2pt]pic cs:were) to[bend right] ([xshift=10pt, yshift=8pt] pic cs:q_were);}
 \visible<3->{\draw[->,opacity=0.4,line width=2pt] ([xshift=8pt,yshift=-2pt]pic cs:was) to[bend right] ([xshift=10pt, yshift=8pt] pic cs:q_was);}
\end{tikzpicture}

...
\end{frame}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\section{Listen, Then Read\,\,\,\,\,{\tiny 0037}\,{\scriptsize \myaudio{./audio/027_past_dd_you_reading.mp3}}}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
before upper={\setlength{\parindent}{1.25em}},
 title={A Weekend in the Park\hfill{\tiny 0037}\quad{\scriptsize \myaudio{./audio/027_past_did_you_reading.mp3}}}
]
\noindent{}Did you have a busy weekend? Ken and his sister Emi went to the city park on Saturday morning.

Did Ken ride his new bicycle? Yes, he rode it around the large pond. Emi played badminton with her friends near the trees.

At noon, did they eat lunch there? Yes, their mother made delicious sandwiches for them. They drank cold orange juice and ate apples.

Did they stay until evening? No, they did not. They went home at three. They had a very good time.
\end{tcolorbox}

\vspace{-5pt}
%\visible<2->{\small 次の各文が本文の内容とあっていればT,そうでなければFと答えましょう}
%\vspace{-11pt}
\begin{enumerate}\setlength{\itemsep}{-3.35pt}
\item<2-> Ken and Emi went to the city park on Sunday.\hfill\visible<3->{F}
\item<2-> Ken rode his new bicycle around the pond.\hfill\visible<4->{T}
\item<2-> Emi played tennis with her friends.\hfill\visible<5->{F}
\item<2-> Their mother made delicious sandwiches for them.\hfill\visible<6->{T}
\item<2-> Ken and Emi stayed at the park until evening.\hfill\visible<7->{F}
\end{enumerate}
\end{frame}
%%%%%%%%%%%%%%%%%%%%%%5
...
\includegraphics[width=1.01\textwidth]{./infographic/027_past_did_you_infographic.png}
\hfill{\tiny audio\_overview 1651}\,{\scriptsize \myaudio{./audio/overview/027_past_did_you_audio_overview.m4a}}%
\hfill{\tiny eduop\_boys 0308}\,{\scriptsize \myaudio{./audio/manzai/027_past_did_you_manzai.mp3}}
\end{frame}
%%%%%%%%%%%%%%%%%%%%%%
...
\begin{columns}
 \begin{column}{0.4\textwidth}
  \includegraphics[width=1.1\textwidth]{./test_forms/027_past_did_you_test.png}
 \end{column}
...
\url{https://forms.gle/pqkrRDTndz1tsdqp6}
\end{frame}
%%%%%%%%%%%%%%%%%%%

...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\section{Listen, Then Read\,\,\,\,\,{\tiny 0044}\,{\scriptsize \myaudio{./audio/052_svoo_09.mp3}}}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\begin{frame}[plain]{Exercises}
\small
\begin{tcolorbox}[colframe=ForestGreen,
  ...
  title=英文を読んで、問に答えましょう\hfill{\tiny 0044}{\scriptsize \myaudio{./audio/052_svoo_09.mp3}}
]
...
\includegraphics[width=1.01\textwidth]{./infographic/052_svoo_infographic.png}
\hfill{\tiny audio\_overview 0948}\,{\scriptsize \myaudio{./audio/overview/052_svoo_audio_overview.m4a}}%
\hfill{\tiny eduop\_boys 0311}\,{\scriptsize \myaudio{./audio/manzai/052_svoo_manzai.mp3}}
\end{frame}
%%%%%%%%%%%%%%%%%%%%%%
...
\begin{columns}
 \begin{column}{0.4\textwidth}
  \includegraphics[width=1.1\textwidth]{./test_forms/052_svoo_test.png}
 \end{column}
...
\url{https://forms.gle/7vLwGeeJkWa64T4w6}
\end{frame}
%%%%%%%%%%%%%%%%%%%
\end{document}

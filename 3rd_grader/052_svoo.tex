...
\hfill\tikzmark{AAA}{\scriptsize 間接目的語}\\
\hfill\tikzmark{BBB}{\scriptsize 直接目的語}
\end{block}

\begin{tikzpicture}[remember picture,overlay]
 \visible<4->{\draw[<-] ([xshift=9pt,yshift=-4pt]pic cs:aaa) |- ([xshift=-2pt, yshift=2pt] pic cs:AAA);}
 \visible<4->{\draw[<-] ([xshift=12pt,yshift=-4pt]pic cs:bbb) |- ([xshift=-2pt, yshift=2pt] pic cs:BBB);}
\end{tikzpicture}
...
\begin{tikzpicture}[remember picture,overlay]
 ...
 \visible{\draw[<-] ([xshift=28pt,yshift=4pt]pic cs:bbb) -| ([xshift=12pt, yshift=-2pt] pic cs:BB);}
\end{tikzpicture}

...
He has lost his English dictionary\footnotemark[1], so he is looking for\footnotemark[2] it there.

I have just finished my lunch.
I am full\footnotemark[3] now.
I have already done my math homework.
It was easy.
However, I haven't started my English report yet.
It is due\footnotemark[4] tomorrow!
Have you finished your homework yet?

\vspace*{8pt}

\scriptsize
$^{1}$dictionary \textipa{/d\'IkS@n\`eri/}\,\,辞書\hfill{}$^{2}$look for ～をさがす\hfill$^{3}$full：おなかがいっぱいで

$^{4}$due \textipa{/dj\'u:/}\,\,期日の、提出日で
\end{tcolorbox}

...
\begin{block}{If S $+$ 仮定法過去($=$ V)\mbox{}\hfill{\myaudio{./audio/043_mood_if_01.mp3}} }
\small
...
\begin{frame}[plain]{Exercises}
 日本文の意味になるように、適切なものを選びましょう\hfill{\myaudio{./audio/043_mood_if_02.mp3}} 
...
%%%%%%%%%%%%%%%%%%%%%%%%%%
\begin{frame}[plain]{Exercises}
日本文の意味になるよう(~~~~~~~~)内の語句を並べ替えましょう\hfill{\myaudio{./audio/043_mood_if_03.mp3}} 
 \begin{enumerate}

...
\end{frame}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\section{Listen, Then Read\,\,\,\,\,{\tiny 0136}\,{\scriptsize \myaudio{./audio/054_v_that_clause_04.mp3}}}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
before upper={\setlength{\parindent}{1.25em}},
  title={次の英文を読みましょう\mbox{}\hfill{\tiny 0136}\,{\scriptsize \myaudio{./audio/054_that_clause_04.mp3}}}]
...
\includegraphics[width=1.01\textwidth]{./infographic/054_v_that_clause_infographic.png}
\hfill{\tiny audio\_overview 0949}\,{\scriptsize \myaudio{./audio/overview/054_v_that_clause_audio_overview.m4a}}%
\hfill{\tiny eduop\_boys 0314}\,{\scriptsize \myaudio{./audio/manzai/054_v_that_clause_manzai.mp3}}
\end{frame}
%%%%%%%%%%%%%%%%%%%%%%
...
\begin{columns}
 \begin{column}{0.4\textwidth}
  \includegraphics[width=1.1\textwidth]{./test_forms/054_v_that_clause_test.png}
 \end{column}
...
\url{https://forms.gle/KLSdjtULKgRW77qX7}
\end{frame}
%%%%%%%%%%%%%%%%%%%
\end{document}

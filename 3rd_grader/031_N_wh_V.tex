...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\section{Listen, Then Read\,\,\,\,\,{\tiny 0030}\,{\scriptsize \myaudio{./audio/031_N_wh_V_reading.mp3}}}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
before upper={\setlength{\parindent}{1.25em}},
 title={A Friendly Neighbor Who Helps Everyone\hfill{\tiny 0030}\quad{\scriptsize \myaudio{./audio/031_N_wh_V_reading.mp3}}}
]
\noindent{}Mr. Davis is an active man who lives next to my house.
He is a retired firefighter who knows everything about our town.

Every weekend, he works with young volunteers who clean the local park.

He also helps elderly people who cannot carry heavy bags from the supermarket.

Yesterday, he fixed a broken bicycle for a little girl who was crying on the street.

Everyone in our town loves this kind gentleman who always has a warm smile.
\end{tcolorbox}
\end{spacing}
...
\item<2-> Mr. Davis lives next to the writer's house.\hfill\visible<3->{T}
\item<2-> Mr. Davis cleans the local park alone every weekend.\hfill\visible<4->{F}
\item<2-> Mr. Davis helps elderly people carry heavy bags from the supermarket.\hfill\visible<5->{T}
\item<2-> A little girl on the street helped Mr. Davis fix his bicycle.\hfill\visible<6->{F}
\item<2-> People in our town love Mr. Davis because he is kind.\hfill\visible<7->{T}
\end{enumerate}
\end{frame}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\section{まとめ}
...
\includegraphics[width=1.01\textwidth]{./infographic/031_N_wh_V_infographic.png}
\hfill{\tiny audio\_overview 2256}\,{\scriptsize \myaudio{./audio/overview/0311_N_wh_V_audio_overview.m4a}}%
\hfill{\tiny eduop\_boys 0308}\,{\scriptsize \myaudio{./audio/manzai/031_N_wh_V_manzai.mp3}}
\end{frame}
%%%%%%%%%%%%%%%%%%%%%%
...
\begin{columns}
 \begin{column}{0.4\textwidth}
  \includegraphics[width=1.1\textwidth]{./test_forms/031_N_wh_V_test.png}
 \end{column}
...
\url{https://forms.gle/SDnXq9QMSQNwExvb9}
\end{frame}
%%%%%%%%%%%%%%%%%%%
\end{document}

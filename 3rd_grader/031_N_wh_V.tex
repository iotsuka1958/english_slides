...
\mbox{}\hfill{\scriptsize \myaudio{./audio/031_N_wh_V_01.mp3}}
\end{frame}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
\mbox{}\hfill{\scriptsize \myaudio{./audio/031_N_wh_V_02.mp3}}
...
\mbox{}\hfill{\scriptsize \myaudio{./audio/031_N_wh_V_03.mp3}}
\begin{enumerate}
...
\mbox{}\hfill{\scriptsize \myaudio{./audio/031_N_wh_V_04.mp3}}
 \begin{enumerate}
...
\mbox{}\hfill{\scriptsize \myaudio{./audio/031_N_wh_V_05.mp3}}
...
\mbox{}\hfill{\scriptsize \myaudio{./audio/031_N_wh_V_07.mp3}}
\end{frame}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\begin{frame}[plain]{Exercises}
日本語の意味になるよう(~~~~~~)の語句を並べ替えましょう%
\mbox{}\hfill{\scriptsize \myaudio{./audio/031_N_wh_V_08.mp3}}
 \begin{enumerate}
  \item 彼女は賞を獲得した本を読んだ。%
...
\mbox{}\hfill{\scriptsize \myaudio{./audio/031_N_wh_V_09.mp3}}
	\begin{enumerate}
...
\mbox{}\hfill{\scriptsize \myaudio{./audio/031_N_wh_V_10.mp3}}

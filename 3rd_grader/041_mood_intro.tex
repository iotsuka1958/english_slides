...
%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\section{Listen, Then Read\,\,\,\,\,{\tiny 0032}\,{\scriptsize \myaudio{./audio/041_mood_intro_reading.mp3}}}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\begin{frame}[plain,t]{Exercises --- True orFalse? ---}
\vspace*{-8pt}
\begin{spacing}{1}
...
before upper={\setlength{\parindent}{1.25em}},
 title={If I Were a Bird\hfill{\tiny 0032}\quad{\scriptsize \myaudio{./audio/041_mood_intro_reading.mp3}}}
]
\noindent{}Ken looks out the window at the sky. He sees many birds. They fly freely and look very happy.

Ken says to his friend, ``I wish I could fly like a bird. If I were a bird, I would fly to many places around the world.''

He thinks about his big dream. ``If I had wings, I could visit my grandmother in Canada easily. I could also see high mountains and the blue sea from the sky.''

Ken smiles and opens his notebook.
\end{tcolorbox}
\end{spacing}
...
\item<2-> Ken looks at the birds from the window.\hfill\visible<3->{T}
\item<2-> Ken can fly in the sky now.\hfill\visible<4->{F}
\item<2-> Ken wants to visit his grandmother in Canada.\hfill\visible<5->{T}
\item<2-> Ken wants to swim in the ocean.\hfill\visible<6->{F}
\item<2-> Ken opens his notebook at the end.\hfill\visible<7->{T}
\end{enumerate}
\end{frame}
%%%%%%%%%%%%%%%%%%%%%%%%%
\section{まとめ}
...
\includegraphics[width=1.01\textwidth]{./infographic/041_mood_intro_infographic.png}
\hfill{\tiny audio\_overview 1058}\,{\scriptsize \myaudio{./audio/overview/041_mood_intro_audio_overview.m4a}}%
\hfill{\tiny eduop\_boys 0259}\,{\scriptsize \myaudio{./audio/manzai/041_mood_intro_manzai.mp3}}
\end{frame}
%%%%%%%%%%%%%%%%%%%%%%
...
\begin{columns}
 \begin{column}{0.4\textwidth}
  \includegraphics[width=1.1\textwidth]{./test_forms/041_mood_intro_test.png}
 \end{column}
...
\url{https://forms.gle/7Aq7qd7zFLPHVvUk8}
\end{frame}
%%%%%%%%%%%%%%%%%%%
\end{document}

...
\begin{itemize}\setbeamertemplate{items}[square]\small
 \item<8-> 形容詞は名詞の前に置きます
 \item<9-> \fcolorbox{black}{white}{\,$\text{(冠詞)}+\text{形容詞}+\text{名詞}$\,\,}\,\,\,は意味のかたまりになります
 \end{itemize}
     \end{block}
...
\hfill{\scriptsize 「過去分詞」は\kenten{過去}の意味ではなく「される」という\kenten{受け身}の意味でしたね}
 \end{itemize}
     \end{block}
\vspace*{-5pt}
...
\end{frame}
%%%%%%%%%%%%%%%%%%%%%%
\section{Listen, Then Read\,\,\,\,\,{\tiny 0036}\,{\scriptsize \myaudio{./audio/021_N_ing_06.mp3}}}
%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\begin{frame}[plain]
 
\includegraphics[width=1.01\textwidth]{./images/nanobanana-output/021_N_ing_reading.png}

\vspace{-15pt}

\hfill{\tiny 0038}\,{\scriptsize \myaudio{./audio/021_N_ing_06.mp3}}
...
before upper={\setlength{\parindent}{1.25em}},
 title=次の英文を読みましょう\mbox{}\hfill{\tiny 0031}\,{\scriptsize \myaudio{./audio/021_N_ing_06.mp3}}
]
\noindent{}It was a sunny Saturday.
I visited the large City Park.
I saw many interesting\footnotemark[1] things.

Children were playing soccer on the green grass.
The girl running with a small dog was my friend, Lisa.

Near the fountain\footnotemark[2], a man sitting on a bench was reading an interesting book. 
The white birds flying in the blue sky were very beautiful. 
The park was full\footnotemark[3] of smiling people.
I was very happy.
\end{tcolorbox}

\vspace*{40pt}
\scriptsize
$^{1}$interesting: おもしろい\hfill{}$^{2}$fountain: 噴水\hfill{}%
$^{3}$be full of ～: ～でいっぱいの
\end{frame}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
　緑の芝生の上では、子どもたちがサッカーをしていました。
小さな犬と一緒に走っている女の子は、私のともだちのリサでした。

　噴水の近くでは、ベンチに座った男性がおもしろい本を読んでいました。
青い空を飛んでいる白い鳥がとてもきれいでした。
公園は笑顔の人たちでいっぱいでした。
私はとても幸せな気持ちになりました。
\end{tcolorbox}
\end{frame}
...
\hfill{\tiny 0419}\,{\scriptsize \myaudio{./audio/021_N_ing_07.mp3}}
\end{frame}
%%%%%%%%%%%%%%%%%%%
\begin{frame}[plain]
 
\includegraphics[width=1.01\textwidth]{./infographic/021_N_ing_infographic.png}
\hfill{\tiny audio\_overview 2636}\,{\scriptsize \myaudio{./audio/overview/021_N_ing_audio_overview.m4a}}%
\hfill{\tiny eduop\_boys 0259}\,{\scriptsize \myaudio{./audio/manzai/012_will_manzai.mp3}}
\end{frame}
%%%%%%%%%%%%%%%%%%%%%%
...
\begin{columns}
 \begin{column}{0.4\textwidth}
  \includegraphics[width=1.1\textwidth]{./test_forms/021_N_ing_test.png}
 \end{column}
...
\url{https://forms.gle/3R7eyQASLoH3haq89}
\end{frame}
%%%%%%%%%%%%%%%%%%%
\end{document}

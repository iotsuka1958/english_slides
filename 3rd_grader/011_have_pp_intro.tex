...
\begin{itemize}\setbeamertemplate{items}[square]
 \item  \visible<8->{$\text{現在完了形(}=\textcolor{NavyBlue}{\text{\bfseries have} + \text{過去分詞}}$\,\,)%
は「過去と現在にまたがる表現」です}\\
\hfill\visible<9->{{\scriptsize 過去分詞は\kenten{受け身}とならんで\kenten{完了}の意味をあらわします}}
 \item \visible<10->{主語が三人称単数のときは$\textcolor{NavyBlue}{\text{\bfseries has} + \text{過去分詞}}$}\mbox{}\hfill\myaudio{./audio/011_have_pp_intro_01.mp3}
\end{itemize}
      \end{exampleblock}
\end{frame}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
\visible<1->{\begin{enumerate}
 \item $\left\{\begin{tabular}{rl}
(A)& Jane \textcolor{Maroon}{\bfseries stayed} in London two years ago.\hspace{7\zw}{\scriptsize stay \textipa{/st\'eI/} 滞在する}\\
(B)& Jane \textcolor{NavyBlue}{\bfseries has stayed} in London for six years.
\end{tabular}
\right.$
\end{enumerate}}
...
\visible<4->{過去のある時から現在までの「継続」を表しています}\mbox{}\hfill\myaudio{./audio/011_have_pp_intro_03.mp3}
\end{frame}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
\visible<1->{\begin{enumerate}\setcounter{enumi}{1}
 \item $\left\{\begin{tabular}{rl}
		(A)& I \textcolor{Maroon}{\bfseries watched} the movie two years ago.\hspace{5\zw}{\scriptsize movie \textipa{/m\'u:vi/} 映画}\\
(B)& I \textcolor{NavyBlue}{\bfseries have watched} the movie three times.
\end{tabular}
\right.$
\end{enumerate}}
...
\mbox{}\hfill{\scriptsize \myaudio{./audio/011_have_pp_intro_04.mp3}}
\end{frame}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\begin{frame}[plain]{Exercises}
...
\visible<8->{過去に起こした動作の現在での「結果」を表しています}\mbox{}\hfill\myaudio{./audio/011_have_pp_intro_05.mp3}
\end{frame}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\section{まとめ}

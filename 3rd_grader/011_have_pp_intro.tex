...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\section{Listen, Then Read\,\,\,\,\,{\tiny 0035}\,{\scriptsize \myaudio{./audio/011_have_pp_intro_reading.mp3}}}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\begin{frame}[plain,t]{Exercises}
\vspace*{-8pt}
\begin{spacing}{1}
...
before upper={\setlength{\parindent}{1.25em}},
  title={Living in Green Town\hfill{\tiny 0035}\quad{\scriptsize \myaudio{./audio/011_have_pp_intro_reading.mp3}}}
]
\vspace*{-2pt}
\noindent{}Ken moved to Green Town five years ago. He has lived here with his family since then.

He loves this town because it is quiet and beautiful. He has made many good friends at his school.

Ken likes music very much. He has played the guitar for two years. He practices every day.

Recently, Ken and his friends have started a band. They have practiced together many times.

Ken has already written two songs for the band. He is very happy now.
\end{tcolorbox}
\end{spacing}
...
\item<2-> Ken has lived in Green Town for five years.\hfill\visible<3->{T}
\item<2-> Ken does not have many friends at his school.\hfill\visible<4->{F}
\item<2-> Ken has played the guitar for two years.\hfill\visible<5->{T}
\item<2-> Ken and his friends have never practiced together.\hfill\visible<6->{F}
\item<2-> Ken has written three songs for the band.\hfill\visible<7->{F}
\end{enumerate}
\end{frame}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\section{まとめ}
...
%%%%%%%%%%%%%%%%%%%%%%%%
\begin{frame}[plain]
\includegraphics[width=1.01\textwidth]{./infographic/011_have_pp_intro_infographic.png}
\hfill{\tiny audio\_overview 1453}\,{\scriptsize \myaudio{./audio/overview/011_have_pp_intro_audio_overview.m4a}}%
\hfill{\tiny eduop\_boys 0324}\,{\scriptsize \myaudio{./audio/manzai/011_have_pp_intro_manzai.mp3}}
\end{frame}
%%%%%%%%%%%%%%%%%%%%%%
...
\begin{columns}
 \begin{column}{0.4\textwidth}
  \includegraphics[width=1.1\textwidth]{./test_forms/011_have_pp_intro_test.png}
 \end{column}
...
\url{https://forms.gle/ofajnNvoaFtfoL7eA}
\end{frame}
%%%%%%%%%%%%%%%%%%%
\end{document}

...
\hfill\visible<9->{{\scriptsize 主語が三人称単数のときは$\textcolor{NavyBlue}{\text{\bfseries has} + \text{過去分詞}}$}}
 \item \visible<10->{過去分詞は\kenten{受け身}とならんで\kenten{完了}の意味をあらわします}%
...
\visible<1->{\begin{enumerate}
 \item $\left\{\begin{tabular}{rl}
(A)& Jane \textcolor{Maroon}{\bfseries stayed} in London two years ago.%
...
\hfill{\tiny 0120}\<{\scriptsize \myaudio{./audio/011_have_pp_intro_03.mp3}}
\end{frame}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%

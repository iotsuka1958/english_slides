...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\section{Listen, Then Read\,\,\,\,\,{\tiny 0112}\,{\scriptsize \myaudio{./audio/062_it_for_to_05.mp3}}}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\begin{frame}[plain]{Exercises --- True or False? ---}
\scriptsize
\mbox{}\hfill{\tiny 0112}\,{\scriptsize \myaudio{./audio/062_it_for_to_05.mp3}}
...
\begin{tikzpicture}[remember picture,overlay]
 ...
 \visible<9->{\draw[<-,opacity=0.4,line width=2pt] ([yshift=-2pt]pic cs:clue4) to[bend left] ([xshift=2pt, yshift=2pt] pic cs:q4);}
\end{tikzpicture}
\end{frame}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\section{まとめ}
...
\hfill{\scriptsize \textbf{It is} dangerous \textbf{for} kids \textbf{to} swim alone.}
 \item to不定詞の\kenten{意味上の主語}といいます
\end{itemize}
\end{block}
\vspace{-10pt}
\hfill{\scriptsize \myaudio{./audio/062_it_for_to_06.mp3}}
\end{frame}
%%%%%%%%%%%%%%%%%%%%%%%%
\begin{frame}[plain]
 
\includegraphics[width=1.01\textwidth]{./infographic/062_it_for_to_infographic.png}
\hfill{\tiny audio\_overview 0738}\,{\scriptsize \myaudio{./audio/overview/062_it_for_to_audio_overview.m4a}}%
\hfill{\tiny eduop\_boys 0424}\,{\scriptsize \myaudio{./audio/manzai/062_it_for_to_manzai.mp3}}
\end{frame}
%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
\begin{columns}
 \begin{column}{0.4\textwidth}
  \includegraphics[width=1.1\textwidth]{./test_forms/062_it_for_to_test.png}
 \end{column}
...
\url{https://forms.gle/5FxaKDtHegFmWHGt9}
\end{frame}
%%%%%%%%%%%%%%%%%%%
\end{document}

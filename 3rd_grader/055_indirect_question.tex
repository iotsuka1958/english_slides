...
\end{frame}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\section{Listen, Then Read\,\,\,\,\,{\tiny 0101}\,{\scriptsize \myaudio{./audio/055_indirect_question_06.mp3}}}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\begin{frame}[plain]{Exercises}
\small
\begin{tcolorbox}[colframe=ForestGreen,
  ...
  title=英文を読んで、問に答えましょう\hfill{\tiny 0101}{\scriptsize \myaudio{./audio/055_indirect_question_06.mp3}}
]
...
\begin{tikzpicture}[remember picture,overlay]
 \visible<3->{\draw[<-,opacity=0.4,line width=2pt] ([yshift=-2pt]pic cs:clue1) to ([xshift=2pt, yshift=2pt] pic cs:q1);}
 ...
 \visible<11->{\draw[<-,opacity=0.4,line width=2pt] ([yshift=-2pt]pic cs:clue5) to[out=-90,in=0] ([xshift=2pt, yshift=2pt] pic cs:q5);}
\end{tikzpicture}
\end{frame}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\section{まとめ}
...
\includegraphics[width=1.01\textwidth]{./infographic/055_indirect_question_infographic.png}
\hfill{\tiny audio\_overview 0947}\,{\scriptsize \myaudio{./audio/overview/055_indirect_question_audio_overview.m4a}}%
\hfill{\tiny eduop\_boys 0304}\,{\scriptsize \myaudio{./audio/manzai/055_indirect_question_manzai.mp3}}
\end{frame}
%%%%%%%%%%%%%%%%%%%%%%
...
\begin{columns}
 \begin{column}{0.4\textwidth}
  \includegraphics[width=1.1\textwidth]{./test_forms/055_indirect_question_test.png}
 \end{column}
...
\url{https://forms.gle/1FJ38py3c6makEmi6}
\end{frame}
%%%%%%%%%%%%%%%%%%%
\end{document}

...
\begin{frame}[plain]{間接疑問文}\large
 \begin{enumerate}
  ...
  \item \begin{enumerate}
	 ...
	 \item<7-> *I know where does she live.
	\end{enumerate}
 \end{enumerate}

\begin{block}<8->{Topics for Today}\small
 \begin{itemize}\setbeamertemplate{items}[square]
  \item 疑問詞ではじまる疑問文をほかの文と組み合わせることができます\\
\mbox{}\hfill{\scriptsize これを\kenten{間接疑問文}といいます}
  \item このとき\Circled[fill color=white]{ 疑問詞 S $+$ V }となります
 \end{itemize}
\end{block}
...
\begin{frame}[plain]{be動詞のとき}
 \begin{enumerate}
  ...
  \item<2-> I know \visible<3->{where the station is.}
  \item *I know where is the station.
 \end{enumerate}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\section{ここに注意}
\begin{frame}[plain]{間接疑問文}
 \begin{enumerate}
  \item \begin{enumerate}
	 \item<1-> She was born in Tokyo.
	 \item<2-> I know \visible<3->{that she was born in Tokyo.} 
	 \item<4-> I know she was born in Tokyo.
	\end{enumerate}
  \item \begin{enumerate}
	 \item<5-> Where was she born?
	 \item<6-> I know \visible<7->{where she was born.}

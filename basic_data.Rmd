...
work_log.csvとbasic_data.csvの双方にmp3列があるので、work_log.csvのmp3列を削除して、mp3の情報はbasic_data.csvだけに格納すること
それに伴い、以下の進捗管理に係るコードを修正すること
具体的には、work_log.csvのmp3列を削除したうえで、たとえば1年進捗状況の2行目と9行目を修正すること（進捗状況の表にmp3の情報は不要との判断）

...
\scalebox{1}{\begin{tikzpicture}
  \node[fill=white] {Solar System:\hspace{12pt}My Very Educated Mother Just Served Us Noodles};
\end{tikzpicture}}
}
\end{textblock*}
\end{frame}
...
\begin{tblr}{
 ...
 cells={cmd=\onslide<\arabic{rownum}->} %%%%tabularrayとpauseが衝突することを回避する方法→https://github.com/lvjr/tabularray/issues/226
        ...
        日本語名 & 英語名 \\
        \midrule
        宇宙    & universe \textipa{/j\'u:n@v\`\textrhookschwa :s/}\\
...
\hfill{\scriptsize 0350\,\myaudio{./audio/002_day_month_season_stars.mp3}}

...
名詞は文の主語($=$ S)になったり動詞の目的語($=$ O)になったりします


\begin{enumerate}
 \item<2-> \begin{enumerate}
	\item<2-> Cats are cute.\hfill{}Cats $=$ S
	\item<4-> \fbox{To study math} is important.\hfill{}\fbox{To study math} $=$ S
       \end{enumerate}
% \item \begin{enumerate}
%	\item They are black cats.
%	\item The plan is \fbox{to make a hospital}.
%       \end{enumerate}
 \item<3-> \begin{enumerate}
	\item<3-> I like cats.\hfill{}cats $=$ O
	\item<5-> to不定詞が目的語になることはあるかしら？\hfill{}\fbox{To不定詞} $=$ O
       \end{enumerate}
\end{enumerate}

\begin{textblock*}{0.4\linewidth}(310pt,130pt)
...
\hfill\textdbend\,\,{\small 名詞的用法のto不定詞が一般動詞の目的語（$=$ O）になります}
...
\hfill{\tiny 0209}\,{\scriptsize \myaudio{./audio/032_infinitive_noun_02b.mp3}}

\begin{enumerate}
 \item {\small その計画は、病院をつくることでした。}
The plan was ( hospital / to  / a / make ).\\
\visible<3->{The plan was to make a hospital.}%
       \hfill\visible<2->{cf.\,\,The plan was a success.}
 \item {\small 数学を勉強することはたいせつです。}
( math / is / study / to ) important.\\
\visible<5->{To study math is important.}%
       \hfill\visible<4->{cf.\,\,Math is important.}
 \item {\small わたしは寝る前に本を読むのが好きだ。}
( books / like / to / I / read ) before bed.\\
\visible<7->{I like to read books before bed.}%
       \hfill\visible<6->{cf.\,\,I like books.}
 \item {\small わたしは夕食前に宿題を終える必要がある。}\\
( my homework / need / finish / to / I ) before dinner.\\
\visible<9->{I need to finish my homework before dinner.}%
       \hfill\visible<8->{cf.\,\,I need your help.}
\end{enumerate}
\end{frame}
%%%%%%%%%%%%%%%%%%%%%%
\section{Listen, Then Read\,\,\,\,\,{\tiny 0536}\,{\scriptsize \myaudio{./audio/032_infinitive_noun_03.mp3}}}
%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\begin{frame}[plain,t]
...
After the trip, they {\bfseries continued}\footnotemark[10] {\bfseries to talk} about their memories\footnotemark[11].
\end{tcolorbox}
...
$^{9}$during: ～の間\\
$^{10}$continue: 続ける\hspace{20pt}$^{11}$memory: 記憶、思い出
...
\begin{tcolorbox}
　毎年夏になると、ジェーンと友人たちは楽しい活動の計画を立てました。
 ジェーンはたくさんの国を訪れたいと思っており、
トムは訪れた場所の絵を描くのが好きでした。
メアリーは早めにかばんに荷物を詰めはじめ、ジョンは旅行の本を読みはじめました。
みんな、とてもワクワクしていました。

\smallskip

　彼らは旅行のためにお金を貯めることにしました。
旅行中は、新しい食べ物に挑戦してみる必要がありました。
そして旅行が終わった後も、彼らは旅の思い出を語り続けました。
\end{tcolorbox}
...
\mbox{}\hfill{\tiny audio\_overview\,1352}\,{\scriptsize \myaudio{./audio/overview/032_infinitive_noun_audio_overview.m4a}}  
\end{frame}
%%%%%%%%%%%%%%%%%%%%%%%%
\begin{frame}[plain]
 
\includegraphics[width=1.01\textwidth]{./infographic/032_infinitive_noun_infographic.png}
\hfill{\tiny audio\_overview 1352}\,{\scriptsize \myaudio{./audio/overview/032_infinitive_noun_audio_overview.m4a}}%
\hfill{\tiny eduop\_boys 0316}\,{\scriptsize \myaudio{./audio/manzai/032_infinitive_noun_manzai.mp3}}
\end{frame}
%%%%%%%%%%%%%%%%%%%%%%
...
\begin{columns}
 \begin{column}{0.4\textwidth}
  \includegraphics[width=1.1\textwidth]{./test_forms/032_infinitive_noun_test.png}
 \end{column}
...
\url{https://forms.gle/Fi5ztfVLd4oJt1av8}
\end{frame}
%%%%%%%%%%%%%%%%%%%
\end{document}

...
\begin{itemize}\setbeamertemplate{items}[square]\small
 ...
 \item 具体的には次の場合があります
      \begin{enumerate}\setbeamertemplate{items}[circle]
       \item 文全体の主語\hfill{\footnotesize \fbox{To play tennis} is fun.}
       \item be動詞の直後\hfill{\footnotesize The plan was \fbox{to climb Mt. Fuji.}}
       \item 一般動詞の直後\hfill{\footnotesize He began \fbox{to write a letter}.}
      \end{enumerate}
 \end{itemize}
     \end{block}

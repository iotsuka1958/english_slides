...
\begin{tcolorbox}
　毎年夏になると、ジェーンと友人たちは楽しい活動の計画を立てました。 ジェーンはたくさんの国を訪れたいと思っており、トムは訪れた場所の絵を描くのが好きでした。 メアリーは早めに荷造りを始め、ジョンは旅行の本を読み始めました。 みんな、とてもワクワクしていました。

\smallskip

　彼らは旅行のためにお金を貯めることにしました。 旅行中は、新しい食べ物に挑戦してみる必要がありました。 そして旅行が終わった後も、彼らは旅の思い出を語り続けました。
\end{tcolorbox}

...
\hfill{\scriptsize \myaudio{./audio/032_infinitive_noun_01.mp3}}
  ...
  \item \begin{enumerate}
	...
	\end{enumerate}
  \item \begin{enumerate}
	 \item<7-> The plan was a success.\mbox{}\hfill{\scriptsize success\textipa{/s\'@kses/}: 成功}
...
\hfill{\scriptsize \myaudio{./audio/032_infinitive_noun_02.mp3}}
...
つぎの英文を読みましょう%
\hfill{\scriptsize \myaudio{./audio/032_infinitive_noun_03.mp3}}

...
%%%%%%%%%%%%%%%%%%%%%%%%%
\begin{frame}[plain,t]{have to---の疑問文}
 \large
...
\hspace{80pt}\visible<4->{\myAnch{txt2}{white}{\scriptsize 文末に`?'}}%
\visible<5->{{\scriptsize イントネーションは上昇調}}
...
speech={\tiny  \begin{tabular}{c}いつもの\\haveと同じ\end{tabular}
},
...
\begin{textblock*}{0.4\linewidth}(340pt,85pt)
    % TiKZを使った図形の描画
...
\hfill\visible<2->{{\scriptsize get up 起きる}}
...
\hfill\visible<5->{{\scriptsize mustn't \textipa{/m\'2snt/}}}
...
\visible<2->{\dnote{have to--- とmustは\kenten{義務}（～しなければならない）をあらわすという点でおなじです。いっぽう、don't have to---（～しなくてもいい）とmust not（～してはいけない）はまったく異なる意味ですから、しっかり区別することがだいじです}}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\section{Listen, Then Read\,\,\,\,\,{\tiny 0030}\,{\scriptsize \myaudio{./audio/014_have_to_reading.mp3}}}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
before upper={\setlength{\parindent}{1.25em}},
 title={Taking Care of Lucky\hfill{\tiny 0030}\quad{\scriptsize \myaudio{./audio/014_have_to_reading.mp3}}}
]
\noindent{}Ken and his sister, Yuka, have a cute dog named Lucky. Every morning, Ken has to wake up early and walk Lucky in the park.

Lucky likes walking, but he does not like rain. On rainy days, Ken does not have to walk him, but he has to play with Lucky in the house.

Yuka has to give Lucky food and fresh water every day. She also brushes his soft hair.

Ken and Yuka have to do many chores for Lucky, but they love him very much.
\end{tcolorbox}
...
\item<2-> Ken has to walk Lucky in the park every morning.\hfill\visible<3->{T}
\item<2-> Ken has to walk Lucky on rainy days.\hfill\visible<4->{F}
\item<2-> Ken has to play with Lucky in the house on rainy days.\hfill\visible<5->{T}
\item<2-> Yuka does not have to give food to Lucky.\hfill\visible<6->{F}
\item<2-> Ken and Yuka love Lucky very much.\hfill\visible<7->{T}
\end{enumerate}
\end{frame}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\section{まとめ}
...
\kenten{義務}をあらわす\,\Circled[fill color=white]{\bfseries \,have to\,}\,\,\,\,「〜しなければならない」\hfill{}cf. \textbf{must} \textipa{/m\'2st/}
\begin{itemize}\setbeamertemplate{items}[square]\small
...
\includegraphics[width=1.01\textwidth]{./infographic/014_have_to_infographic.png}
\hfill{\tiny audio\_overview 1457}\,{\scriptsize \myaudio{./audio/overview/014_have_to_audio_overview.m4a}}%
\hfill{\tiny eduop\_boys 0250}\,{\scriptsize \myaudio{./audio/manzai/014_have_to_manzai.mp3}}
\end{frame}
%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%
...
\begin{columns}
 \begin{column}{0.4\textwidth}
  \includegraphics[width=1.1\textwidth]{./test_forms/014_have_to_test.png}
 \end{column}
...
\url{https://forms.gle/d7CGfvaVzxxSCp9K9}
\end{frame}
%%%%%%%%%%%%%%%%%%%
\end{document}

...
$^{5}$favorite：お気に入りの\hfill{}$^{6}$weekend：週末\hfill$^{7}$do homework：宿題をする

$^{8}$live a healthy life：健康な生活を送る

$^{9}$make 人 happy：～を幸せにする\hspace{20pt}She made him happy.（彼女は彼を幸福にした）
\end{tcolorbox}
...
私は昨年、朝にランニングを始めました。
私の一番の趣味はサッカーをすることです。
私は放課後に公園で友達と（サッカーを）するのを楽しみます。
週末には、家族のために夕食を作るのが好きです。
私の仕事は、台所で母を手伝うことです。
私はたいてい、夕食の前に宿題をやり終えます。
健康的な生活を送ることは、私を幸せにしてくれます。
\end{tcolorbox}
\end{frame}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\section{動名詞のまとめ}

...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\section{動名詞gerund\hspace{80pt}{\tiny 2013}\,{\scriptsize \myaudio{./audio/overview/036_gerund_audio_overview.mp4}}
}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
\item <9-> 名詞のはたらきをする \Circled[fill color= white]{\,\,--ing\,\,}\,を「動名詞」gerundといいます
\item<10-> \Circled[fill color= white]{\,\,--ing\,\,}\,が
      \begin{itemize}\setbeamertemplate{items}[circle]\small
       \item<10-> 文全体の主語になることがあります
       \item<14-> be動詞の直後にくることがあります
      \end{itemize}
 \end{itemize}
     \end{block}
...
\hspace{92pt}\visible<2->{{($=$ O)}}\hfill{\scriptsize business \textipa{/b\'Izn@s/} 商売}
...
\begin{enumerate}
 \item<1-> \begin{enumerate}
	\item To speak English is difficult for me.\hfill{\scriptsize difficult \textipa{/d\'IfIk\`2lt/} 難しい}
...
\end{frame}
%%%%%%%%%%%%%%%%%%%%%%
\section{聞いてみよう、読んでみよう{\tiny 0032}\,{\scriptsize \myaudio{./audio/036_gerund_reading.mp3}}}
%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\begin{frame}[plain]
...
\hfill{\tiny 0032}\,{\scriptsize \myaudio{./audio/036_gerund_reading.mp3}}
...
before upper={\setlength{\parindent}{1.25em}},
 title=次の英文を読みましょう\mbox{}\hfill{\tiny 0032}\,{\scriptsize \myaudio{./audio/036_gerund_reading.mp3}}
]

Eating vegetables is good for your health.
I try to eat them every day.
Also, running outside is fun.
...
On weekends, I like cooking dinner for my family.
My job is helping my mother in the kitchen.
I usually finish doing my homework before dinner.
Living a healthy life makes me happy.
\vspace*{15pt}

\scriptsize
$^{1}$vegetable：野菜\hfill{}$^{2}$health：健康

%
$^{3}$also：また\hspace{40pt}$^{4}$outside：戸外で

$^{5}$favorite：お気に入りの\hfill{}weekend：週末

$^{6}$do homework：宿題をする\hfill{}$^{7}$live a healthy life：健康な生活を送る
\end{tcolorbox}
...
\hfill{\tiny audio overview 2013}\,{\scriptsize \myaudio{./audio/overview/036_gerund_audio_overview.mp4}}

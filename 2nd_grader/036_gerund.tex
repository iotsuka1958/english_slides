...
\end{frame}
%%%%%%%%%%%%%%%%%%%%%%
\section{Listen, Then Read\,\,\,\,\,{\tiny 0037}\,{\scriptsize \myaudio{./audio/036_gerund_reading.mp3}}}
%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\begin{frame}[plain]
...
\hfill{\tiny 0229}\,{\scriptsize \myaudio{./audio/036_gerund_081.mp3}}
...
動名詞のことを英語ではgerund \textipa{/dZ\'er@nd/} といいます\\
\hfill {\tiny audio\_overview 2013}\,{\scriptsize \myaudio{./audio/overview/036_gerund_audio_overview.m4a}}
\end{frame}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%
\begin{frame}[plain]
...
\includegraphics[width=1.01\textwidth]{./infographic/036_gerund_infographic.png}
\hfill{\tiny audio\_overview 201}\,{\scriptsize \myaudio{./audio/overview/036_gerund_audio_overview.m4a}}%
\hfill{\tiny eduop\_boys 0227}\,{\scriptsize \myaudio{./audio/manzai/036_gerund_manzai.mp3}}
\end{frame}
%%%%%%%%%%%%%%%%%%%%%%
...
\begin{columns}
 \begin{column}{0.4\textwidth}
  \includegraphics[width=1.1\textwidth]{./test_forms/036_gerund_test.png}
 \end{column}
...
\url{https://forms.gle/qxDhHqncaPenvTLw8}
\end{frame}
%%%%%%%%%%%%%%%%%%%
\end{document}

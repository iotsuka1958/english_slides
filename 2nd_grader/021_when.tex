...
\alt<6->{\myAnch{y_5}{Maroon}{when he came}}{\myAnch{Y_5}{white}{when he came}}.\hfill{}\visible<9->{S $+$ V\,\,\Circled[fill color = white]{ when S $+$ V }}
	 \item \alt<7->{\myAnch{y_6}{Maroon}{When he came}}{\myAnch{Y_6}{white}{When he came}},\,\, I \myAnch{x_6}{white}{\myEmph[6-]{NavyBlue}{was sleeping}}.\hfill{}\visible<9->{\Circled[fill color = white]{ when S $+$ V }, S $+$ V}
	\end{enumerate}
 \end{enumerate}
...
\begin{exampleblock}<8->{Topics for Today}
\begin{itemize}

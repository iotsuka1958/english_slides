...
\Large
 \begin{enumerate}
  \item I \myAnch{a_1}{white}{\myEmph[2-]{NavyBlue}{was watching}} television \alt<2->{\myAnch{b_1}{Maroon}{then}}{\myAnch{B_1}{white}{then}}.%
\hfill{}\visible<2->{then{\small (副詞)}}
  \item I \myAnch{a_2}{white}{\myEmph[3-]{NavyBlue}{was watching}} television  \alt<3->{\myAnch{b_2}{Maroon}{at that time}}{\myAnch{B_2}{white}{at that time}}.
  \item I \myAnch{a_3}{white}{\myEmph[4-]{NavyBlue}{was watching}} television   \alt<4->{\myAnch{b_3}{Maroon}{when he came}}{\myAnch{B_3}{white}{when he came}}.
\end{enumerate}
...
{\begin{tikzpicture}[remember picture, overlay]
 ...
 \visible<3->{\draw[thick, Maroon, ->] (B_2.north west) to[out=170, in=10] (a_2.north);} 
 \visible<4->{\draw[thick, Maroon, ->] (B_3.north west) to[out=170, in=10] (a_3.north);} 
\end{tikzpicture}}

\begin{exampleblock}{Topics for Today}\small
\begin{itemize}
 \item   \Circled[fill color = white]{ when S $+$ V }\,は「～するとき」という意味
...
\large
 \begin{enumerate}
  ...
  \item \begin{enumerate}
	...
	\end{enumerate}
  \item \begin{enumerate}
	 \item I \myAnch{x_5}{white}{\myEmph[6-]{NavyBlue}{was sleeping}}
\alt<6->{\myAnch{y_5}{Maroon}{when he came}}{\myAnch{Y_5}{white}{when he came}}.\hfill{}\visible<9->{S $+$ V\,\,\Circled[fill color = white]{ when S $+$ V }}
	 \item \alt<7->{\myAnch{y_6}{Maroon}{When he came}}{\myAnch{Y_6}{white}{When he came}},\,\, I \myAnch{x_6}{white}{\myEmph[7-]{NavyBlue}{was sleeping}}.\hfill{}\visible<9->{\Circled[fill color = white]{ when S $+$ V }, S $+$ V}
	\end{enumerate}
 \end{enumerate}
...
\begin{itemize}\setbeamertemplate{items}[square]
 \item   \visible<8->{\Circled[fill color = white]{ when S $+$ V }\,は「～するとき」という意味}%
\mbox{}\hfill{\scriptsize \myaudio{./audio/021_when_03.mp3}}
 ...
 \item   \visible<9->{\Circled[fill color = white]{ when S $+$ V }\,は、前にも後ろにも位置します}
	 \begin{enumerate}
	  \item<9-> S $+$ V\,\,\Circled[fill color = white]{ when S $+$ V }
	  \item<9-> \Circled[fill color = white]{ When S $+$ V },\,\,S $+$ V
-	 \end{enumerate}
\end{itemize}
     \end{exampleblock}
\end{frame}
...
\begin{itemize}\setbeamertemplate{items}[square]\small
 \item   \visible<5->{\Circled[fill color = white]{ when S $+$ V }\,は「～するとき」という意味}
 \item   \visible<5->{\Circled[fill color = white]{ when S $+$ V }\,は全体で「副詞」の役割}
 \item   \visible<5->{\Circled[fill color = white]{ when S $+$ V }\,は、前にも後ろにも位置します}
	 \begin{enumerate}
	  \item<5-> S $+$ V\,\,\Circled[fill color = white]{ when S $+$ V }
	  \item<5-> \Circled[fill color = white]{ When S $+$ V },\,\,S $+$ V
-	 \end{enumerate}
\end{itemize}
     \end{exampleblock}
\end{frame}

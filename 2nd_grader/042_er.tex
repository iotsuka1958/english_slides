...
before upper={\setlength{\parindent}{1.25em}},
 title={{}The Rivers of Our World}{}\hfill{\tiny 0034}\,{\scriptsize \myaudio{./audio/hoge_reading.mp3}}
]
...
\large
\begin{enumerate}
 \item cheap \textipa{/t\'\i:p/}\hfill\visible<2->{{\scriptsize \Circled{\,形\,} （品物などが）安い}}
 ...
 \item near \textipa{/n\'I\textrhookschwa /}\hfill\visible<7->{{\scriptsize \Circled{\,前\,} ～の近くに}}
 \item need \textipa{/n\'\i:d/}\hfill\visible<8->{{\scriptsize \Circled{\,動\,} ～を必要とする}}
 \item get up \textipa{/g\`et \'2p/}\hfill\visible<9->{{\scriptsize \Circled{\,動\,} 起床する}}
 \item important \textipa{/Imp\'O\textrhookschwa tnt/}\hfill\visible<10->{{\scriptsize \Circled{\,形\,} 重要な}}

...
\begin{itemize}\setbeamertemplate{items}[square]\small
 \item 最後がeのときは\,\Circled{r}\,だけつける\\\hfill{}large -- larger / wide -- wider / nice -- nicer / fine -- finer　
 \item 最後のyをiにして\,\Circled{er}\,をつける\\\hfill{}easy -- easier / heavy -- heavier / busy -- busier / happy -- happier / early -- earlier　
 \item 最後の文字を重ねて\,\Circled{er}\,をつける\hfill{}hot -- hotter /  big -- bigger　
 \end{itemize}
     \end{block}
\end{frame}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%

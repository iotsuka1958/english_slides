...
\begin{itemize}\setbeamertemplate{items}[square]\small
 ...
 \item must \textipa{/m\'\textturnv st/}
 \end{itemize}
     \end{exampleblock}
}
...
\visible<9->{\small {\bfseries will}や{\bfseries must}のように動詞と組み合わせて使用することで、$+\alpha$(プラスアルファ)の意味を付け加える語を\textcolor{BurntOrange}{助動詞}といいます}
\end{frame}
%%%%%%%%%%%%%%%%%%%%

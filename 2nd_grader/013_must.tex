...
%%%%%%%%%%%%%%%%%%%%%%%%%%%
\title{English is fun.\,\,{}--- I must get up early tomorrow. ---}
\author{}
\institute[]{}
\date[]
...
\begin{itemize}\small
 \item   「わたしは〜しなければならない」$\longrightarrow${\,\,\,}I must $+$ 動詞($=\text{そのままの形}$)
 \end{itemize}
     \end{exampleblock}
}
...
\visible<1->{%
He \textcolor{Green}{\bfseries study}\textcolor{BurntOrange}{s} math every day.}
...
\visible<7->{He \alt<1-7>{\myAnch{aux2}{white}{must}}{\myAnch{AUX2}{Orange}{must}}  \textcolor{Green}{\bfseries study} math hard.}\hfill\visible<8->{義務}
...
\begin{exampleblock}{Topics for Today}
\begin{itemize}\small
 \item   主語がなんであっても$\longrightarrow${\,\,\,}$\text{S}+\text{must}+\text{動詞(}=\text{そのままの形}$)\\
\mbox{}\hfill{}*He must studys.とはいわない\hspace{1\zw}\mbox{}
 \end{itemize}
     \end{exampleblock}
}
...
\visible<6->{\phantom{You }($=$\textcolor{NavyBlue}{\bfseries must}\textcolor{Maroon}{\bfseries n't})}

...
\end{frame}
%%%%%%%%%%%%%%%%%%%%%%
\section{Listen, Then Read\,\,\,\,\,{\tiny 0037}\,{\scriptsize \myaudio{./audio/013_must_reading.mp3}}}
%%%%%%%%%%%%%%%%%%%%%%
...
before upper={\setlength{\parindent}{1.25em}},
 title={{Rules at the Zoo}\hfill{\tiny 0047}\quad{\scriptsize \myaudio{./audio/013_must_reading.mp3}}}
]
Welcome to the city zoo! We have many animals here. You can see lions, monkeys, and colorful birds.
When you visit the zoo, you must follow some rules. First, you must keep the zoo clean. Second, you must be quiet near the animals.
Third, you must not give food to the animals. It is bad for their health. Finally, you must not touch the cages. Please enjoy your time and stay safe at the zoo!
\end{tcolorbox}
\vspace{-4pt}
\visible<2->{\small 次の各文が本文の内容とあっていればT,そうでなければFと答えましょう}
\vspace{-11pt}
\begin{enumerate}\setlength{\itemsep}{-3.2pt}
\item<2-> You can see many animals at the city zoo.\hfill\visible<3->{T}
\item<2-> There are no rules at the zoo.\hfill\visible<4->{F}
\item<2-> You must be quiet near the animals.\hfill\visible<5->{T}
\item<2-> You can give food to the animals.\hfill\visible<6->{F}
\item<2-> You must not touch the cages.\hfill\visible<7->{T}
\end{enumerate}
\end{frame}
%%%%%%%%%%%%%%%%%%%%%%%%%%%
\section{助動詞mustのまとめ}
...
\includegraphics[width=1.01\textwidth]{./infographic/013_must_infographic.png}
\hfill{\tiny audio\_overview 0803}\,{\scriptsize \myaudio{./audio/overview/013_must_audio_overview.m4a}}%
\hfill{\tiny eduop\_boys 0313}\,{\scriptsize \myaudio{./audio/manzai/013_must_manzai.mp3
}}
\end{frame}
%%%%%%%%%%%%%%%%%%%%%%
...
\begin{columns}
 \begin{column}{0.4\textwidth}
  \includegraphics[width=1.1\textwidth]{./test_forms/013_must_test.png}
 \end{column}
...
\url{https://forms.gle/v1qNUqJ22KGwmU989}
\end{frame}
%%%%%%%%%%%%%%%%%%%
\end{document}

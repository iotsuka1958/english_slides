...
\hfill{\scriptsize \myaudio{./audio/043_est_01.mp3}}
...
\hfill{\scriptsize \myaudio{./audio/043_est_02.mp3}}
...
\hfill{\scriptsize \myaudio{./audio/043_est_03.mp3}}
  \begin{enumerate}
   \item ナイル川は世界でいちばん長い。\\
...
\hfill{\scriptsize \myaudio{./audio/043_est_04.mp3}}
...
{\scriptsize \myaudio{./audio/043_est_05.mp3}}
\end{frame}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\begin{frame}[plain]{Exercises}
日本語の意味になるよう(~~~~~~)に適語を補いましょう%
\hfill{\scriptsize \myaudio{./audio/043_est_06.mp3}}
 \begin{enumerate}

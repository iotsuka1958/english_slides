...
\,\,\,\,\,を\kenten{最上級}といいます\hfill{\scriptsize cf. 原級、比較級}
 \item<9-> \fcolorbox{white}{white}{\textbf{the} $+$ 最上級}には\,\,$\left\{
\begin{tabular}{l}
...
ただし、つぎの3パターンに注意}
\begin{itemize}\setbeamertemplate{items}[square]\small
 \item<9-> 最後がeのときは--stだけつける\\\hfill{}large -- largest, wide -- widest, nice --nicest, fine --finest　
 \item<10-> 最後のyをiにして--estをつけるもの\\\hfill{}easy -- easiest, heavy -- heaviest, busy -- busiest, happy -- happiest, early -- earliest　
 \item<11-> 最後の文字を重ねて --estをつけるもの\hfill{}hot -- hottest, big -- biggest　
...
\hfill{\tiny 0309}\,{\scriptsize \myaudio{./audio/043_est_06.mp3}\,06}
 \begin{enumerate}
  ...
  \item 砂漠(desert)は地球上でもっとも暑い場所です。\hfill{\scriptsize desert \textipa{/d\'ez\textrhookschwa t/}}\\
	The desert is the (~~\alt<5->{\textcolor{Maroon}{\bfseries hottest}}{\phantom{hottest}}~~) place on Earth.\hfill{\scriptsize cf. dessert \textipa{/dIz\'\textrhookschwa :t/} デザート}

...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\section{理由をあらわすbecause\\{\tiny audio\_overview603 1655}\,{\scriptsize \myaudio{./audio/overview/023_because_audio_overview.mp4}}}
...
\hfill\visible<7->{{\tikzmark{pointer}カンマに注意！}}
	 \end{enumerate}
\item<8-> {\bfseries if}は2組の\,\,\Circled[fill color=white]{\,主語と動詞の組合せ\,}\,\,をつないでいます\visible<9->{$\longrightarrow$\kenten{接続詞}{\scriptsize （\textbf{when, if}のなかまです）}}
\end{itemize}
     \end{block}

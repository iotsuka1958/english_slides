...
\hfill{\scriptsize \myaudio{./audio/033_infinitive_adj_01.mp3}}\\
	       \mbox{}
...
\visible<10->{%
\begin{exampleblock}{Topic for Today ---形容詞的用法---}
\begin{itemize}\small
 \item \Circled[fill color= white]{\,$\text{to} + \text{動詞の原形}$\,} が、名詞を後ろから修飾することがある
 \end{itemize}
     \end{exampleblock}
}
\end{frame}
...
\hfill{\scriptsize \myaudio{./audio/033_infinitive_adj_02.mp3}}
 \begin{enumerate}

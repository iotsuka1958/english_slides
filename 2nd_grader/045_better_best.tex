...
\begin{frame}[plain]{many --- more --- most / much --- more --- most}
 \begin{enumerate}
  \item \begin{enumerate}
	 ...
	 \item<2-> Bob has \myEmph[2-]{Maroon}{more} books than John.
...
\visible<7->{%
\begin{exampleblock}{Topics for Today}\small
形容詞many（多数の）、形容詞much（多量の）は不規則な変化をします
\begin{itemize}\setbeamertemplate{items}[square]\small
 \item many --- more --- moste
 \item much --- more --- most
 \end{itemize}
     \end{exampleblock}
}
...
%
\hfill{\scriptsize \myaudio{./audio/045_better_best_05.mp3}}
\end{frame}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\end{document}

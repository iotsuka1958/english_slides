...
\end{frame}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\section{Listen, Then Read\,\,\,\,\,{\tiny 0036}{\scriptsize \myaudio{./audio/045_better_best_10.mp3}}}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\begin{frame}[plain]
 
\includegraphics[height=1.125\textheight]{./images/045_better_best.png}

\vspace{-30pt}

\hfill{\tiny 0036}\,{\scriptsize \myaudio{./audio/045_better_best_10.mp3}}
...
\begin{tcolorbox}[colframe=ForestGreen,
  ...
  title=次の英文を読み、あとの設問に答えましょう\mbox{}\hfill{\tiny 0036}\,{\scriptsize \myaudio{./audio/045_better_best_10.mp3}}
]
...
{\tiny 0134}\,{\scriptsize \myaudio{./audio/045_better_best_12.mp3}}

...
\hfill{\scriptsize \myaudio{./audio/045_better_best_01.mp3}}
	\end{enumerate}
  \item \begin{enumerate}
...
\hfill{\scriptsize \myaudio{./audio/045_better_best_02.mp3}}
	\end{enumerate}
 \end{enumerate}
%
\visible<7>{%
...
\hfill{\scriptsize \myaudio{./audio/045_better_best_03.mp3}}
...
\hfill{\scriptsize \myaudio{./audio/045_better_best_04.mp3}}
\begin{enumerate}
...
\hfill{\scriptsize \myaudio{./audio/045_better_best_07.mp3}}
...
\hfill{\scriptsize \myaudio{./audio/045_better_best_08.mp3}}
 \begin{enumerate}
  \item \begin{enumerate}
	 \item<1-> Paul ate too ( \alt<2->{\Circled[outer color = BurntOrange]{many}}{ many } / much ) hotdogs.
	 \item<1-> Paul drank too ( many / \alt<3->{\Circled[outer color = BurntOrange]{much}}{ much }) water.
	\end{enumerate}
  \item \begin{enumerate}
...
%
\hfill{\scriptsize \myaudio{./audio/045_better_best_09.mp3}}
\end{frame}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\section{まとめ}

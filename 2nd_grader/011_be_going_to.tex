...
\visible<1->{They \myAnch{aux1}{Maroon}{{\bfseries are going to}} \textcolor{OliveGreen}{\bfseries play} tennis after school.}\hfill\visible<2->{{\scriptsize after school:放課後に}}

\visible<3->{They \myAnch{aux2}{Maroon}{\bfseries are} \textcolor{Maroon}{\bfseries not}\,\, \myAnch{aux3}{Maroon}{\bfseries going to} \textcolor{OliveGreen}{\bfseries play} tennis after school.} 
...
\visible<1->{They \fbox{\alt<1-3>{\myAnch{be1}{white}{\bfseries are}}{\myAnch{BE1}{orange}{\bfseries are}} \alt<1-3>{\myAnch{going1}{white}{\bfseries going to}}{\myAnch{GOING1}{orange}{\bfseries going to}}} {\bfseries visit} France this summer.}\hfill\visible<2->{{\scriptsize visit:訪問する}}

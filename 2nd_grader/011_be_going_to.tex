...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\section{Listen, Then Read\,\,\,\,\,{\tiny 0023}\,{\scriptsize \myaudio{./audio/011_be_going_to_reading.mp3}}}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
before upper={\setlength{\parindent}{1.25em}},
 title={A Busy Weekend\hfill{\tiny 0023}\quad{\scriptsize \myaudio{./audio/011_be_going_to_reading.mp3}}}
]
Next Saturday is going to be a busy day for Ken.
In the morning, he is going to clean his room with his brother.

After lunch, they are going to visit the science museum in the city.
Ken is going to see the new robot show there.

In the evening, his family is going to cook dinner together.
Ken is not going to play video games because he has a lot of homework.
\end{tcolorbox}
...
\item<2-> Ken is going to clean his room in the morning.\hfill\visible<3->{T}
\item<2-> Ken and his brother are going to visit the art museum after lunch.\hfill\visible<4->{F}
\item<2-> Ken is going to see a robot show at the museum.\hfill\visible<5->{T}
\item<2-> Ken's family is going to eat dinner at a restaurant.\hfill\visible<6->{F}
\item<2-> Ken is going to play video games in the evening.\hfill\visible<7->{F}
\end{enumerate}
\end{frame}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
\includegraphics[width=1.01\textwidth]{./infographic/011_be_going_to_infographic.png}
\hfill{\tiny audio\_overview 0954}\,{\scriptsize \myaudio{./audio/overview/011_be_going_to_audio_overview.m4a}}%
\hfill{\tiny eduop\_boys 0303}\,{\scriptsize \myaudio{./audio/manzai/011_be_going_to_manzai.mp3}}
\end{frame}
%%%%%%%%%%%%%%%%%%%%%%
...
\begin{columns}
 \begin{column}{0.4\textwidth}
  \includegraphics[width=1.1\textwidth]{./test_forms/011_be_going_to_test.png}
 \end{column}
...
\url{https://forms.gle/3xWjAAZRJyJNoLdP7}
\end{frame}
%%%%%%%%%%%%%%%%%%%
\end{document}
%%%%%%%%%%%%%%%%%%%%%%%%%%
...
\visible<4->{What time are you going to start the meeting?}

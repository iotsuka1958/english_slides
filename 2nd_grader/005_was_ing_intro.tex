...
{\small 1は正しい方を選びましょう。2〜４は日本語の意味になるよう(~~~~~)内の語句を並べ替えましょう。先頭に来る語は大文字で書き始めてください}
 \begin{enumerate}
...
3～５は疑問文に書き換え、さらにそれに対する答えを「はい」と「いいえ」の2とおりつくりましょう}\hfill{\tiny 0524}\,{\scriptsize \myaudio{./audio/005_was_ing_intro_07.mp3}}

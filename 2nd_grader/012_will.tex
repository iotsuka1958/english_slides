...
\end{frame}
%%%%%%%%%%%%%%%%%%%%%
\section{Listen, Then Read\,\,\,\,\,{\tiny 0034}\,{\scriptsize \myaudio{./audio/012_will_reading.mp3}}}
%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%
\begin{frame}[plain,t]{Exercises}
    ...
    before upper={\setlength{\parindent}{1.25em}},
     title={Next Weekend's Camping Trip\hfill{\tiny 0047}\quad{\scriptsize
  \myaudio{./audio/012_will_reading.mp3}}}
    ]
    Next Saturday, Ken and his family will go on a camping trip in the
  mountains.
    The weather forecast says it will be sunny and warm all day.
    In the morning, they will pitch their tent near a clear river.
    Later, Ken's father will cook delicious hamburgers for lunch.
    In the evening, they will make a bonfire and look at the beautiful stars.
    Ken is very excited because he will try fishing for the first time.
    It will be a fun weekend!
    \end{tcolorbox}

    \vspace{-4pt}
    \visible<2->{\small 次の各文が本文の内容とあっていればT,
  そうでなければFと答えましょう}
    \vspace{-11pt}
    \begin{enumerate}\setlength{\itemsep}{-3.2pt}
    \item<2-> Ken will go camping with his family next Saturday.
  \hfill\visible<3->{T}
    \item<2-> The weather forecast says it will rain all day.
  \hfill\visible<4->{F}
    \item<2-> Ken's father will cook delicious hamburgers for lunch.
  \hfill\visible<5->{T}
    \item<2-> They will look at the stars in the morning.\hfill\visible<6-
  >{F}
    \item<2-> Ken has gone fishing many times before.\hfill\visible<7->{F}
    \end{enumerate}
    \end{frame}
%%%%%%%%%%%%%%%%%%%%%%%%%
\section{まとめ}
...
\small
\begin{itemize}\setbeamertemplate{items}[square]\small
 \item<2-> \Circled[fill color=white]{\,$\text{\bfseries will}+\text{原形}$\,}\,は\kenten{未来}のことを表します\hfill{\bfseries will} \textipa{/w\'Il/}
 \item<3-> \textbf{will}は\kenten{助動詞}です%
\hfill{\scriptsize 動詞と組み合わせて動詞の意味を補足する語}\\
\hfill\visible<4->{\scriptsize \textbf{can}も助動詞です。I \textbf{can} swim.}
 \item<5->   {\bfseries will}も短縮形があります\hfill{}\Circled[fill color=white]{\,S\,} $+$ will $\longrightarrow$ \Circled[fill color=white]{\,S\,}\,'ll\hfill\hfill\mbox{}\\
...
\hfill{\scriptsize 発音はあいまいな音になります。たとえば\textbf{I'll}は「アイル」でなく「アォ」のようになります}
 \item<6->   {\bfseries will}の否定$\longrightarrow${\,\,\,}$\left\{\begin{tabular}{l}\text{{\bfseries will not}}\\\text{{\bfseries won't}}\end{tabular}\right\} + \text{原形}$\hfill{\bfseries will not} \textipa{/w\'Il n\'At/}\hspace{15pt}{\bfseries won't} \textipa{/w\'oUnt/}
...
\includegraphics[width=1.01\textwidth]{./infographic/012_will_infographic.png}
\hfill{\tiny audio\_overview 1145}\,{\scriptsize \myaudio{./audio/overview/012_will_audio_overview.m4a}}%
\hfill{\tiny eduop\_boys 0240}\,{\scriptsize \myaudio{./audio/manzai/012_will_manzai.mp3}}
\end{frame}
%%%%%%%%%%%%%%%%%%%%%%
...
\begin{columns}
 \begin{column}{0.4\textwidth}
  \includegraphics[width=1.1\textwidth]{./test_forms/012_will_test.png}
 \end{column}
...
\url{https://forms.gle/JoeE3QfjtBgSwhMD7}
\end{frame}
%%%%%%%%%%%%%%%%%%%
\end{document}

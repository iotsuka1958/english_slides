...
\mbox{}\hfill\visible<10->{ほかにもありますが、きょうはこれだけとりあげます}
\end{frame}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
\Large
 \begin{enumerate} 
  \item \begin{enumerate}
	 ...
	 \item<2-> Dave is my classmate. \myEmph[2-]{Maroon}{He} likes basketball.
	\end{enumerate}  \item \begin{enumerate}
	 \item<3-> I ate an apple. The apple was delicious.
	 \item<4-> I ate an apple. \myEmph[4-]{Maroon}{It} was delicious.
	\end{enumerate}
 \end{enumerate}
\end{frame}
%%%%%%%%%%%%%%%%%%%%%%%%

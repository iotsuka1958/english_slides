...
\hfill{\scriptsize be動詞は、主語と\kenten{とき}によって決まります}

\end{frame}
%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\section{Listen, Then Read\,\,\,\,\,{\tiny 0031}\,{\scriptsize \myaudio{./audio/001_there_is_reading.mp3}}}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
before upper={\setlength{\parindent}{1.25em}},
 title={A Visit to the City Library\hfill{\tiny 0031}\quad{\scriptsize \myaudio{./audio/001_there_is_reading.mp3}}}
]
\vspace*{-4pt}
\noindent{}There is a large library in the center of our town. Many students, teachers, and children visit it every week.

On the first floor, there are thousands of interesting books and magazines. There is also a quiet room for studying English.

Last year, there was only an old reading room, and there were not many desks for students.

Now, there is a new computer area with ten computers, and there are many comfortable chairs. There is always something wonderful to discover there.
\end{tcolorbox}
\end{spacing}
...
\item<2-> The library is in the center of the town.\hfill\visible<3->{T}
\item<2-> There are books and magazines on the first floor.\hfill\visible<4->{T}
\item<2-> Last year, there were many desks for students in the library.\hfill\visible<5->{F}
\item<2-> There are ten computers in the new computer area now.\hfill\visible<6->{T}
\item<2-> There is no room for studying English in the library.\hfill\visible<7->{F}
\end{enumerate}
\end{frame}
%%%%%%%%%%%%%%%%%%%
\section{まとめ}
...
\includegraphics[width=1.01\textwidth]{./infographic/001_there_is_infographic.png}
\hfill{\tiny audio\_overview  1446}\,{\scriptsize \myaudio{./audio/overview/001_there_is_audio_overview.m4a}}%
\hfill{\tiny eduop\_boys 0532}\,{\scriptsize \myaudio{./audio/manzai/001_there_is_manzai.mp3
}}
\end{frame}
%%%%%%%%%%%%%%%%%%%%%%
...
\begin{columns}
 \begin{column}{0.4\textwidth}
  \includegraphics[width=1.1\textwidth]{./test_forms/001_there_is_test.png}
 \end{column}
...
\url{https://forms.gle/X5M22a2q3BCKceAo9}
\end{frame}
%%%%%%%%%%%%%%%%%%%
\end{document}

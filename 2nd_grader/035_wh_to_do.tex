...
\begin{frame}[plain]{how to --}
 ...
 \end{enumerate}
%
\hfill{\scriptsize \myaudio{./audio/035_wh_to_do_01.mp3}}
\visible<5->{%
...
\hfill{\scriptsize \myaudio{./audio/035_wh_to_do_02.mp3}}
 \begin{enumerate}
...
\hfill{\scriptsize \myaudio{./audio/035_wh_to_do_03.mp3}}
...
\item<6-> Tell me \fcolorbox{NavyBlue}{white}{\textcolor{Maroon}{which to} choose}.\hfill{\scriptsize tell me: 教えて　choose: 選ぶ}
\end{enumerate}
...
\hfill{\scriptsize \myaudio{./audio/035_wh_to_do_04.mp3}}
...
\bigskip
 ...
 \begin{enumerate}
  ...
  \item<2-> Tell me \fcolorbox{NavyBlue}{white}{\textcolor{Maroon}{which to} choose}.\hfill{\scriptsize choose: 選ぶ}
 ...
 \end{enumerate}
%
\hfill{\scriptsize \myaudio{./audio/035_wh_to_do_05.mp3}}
\vfill

...
\begin{frame}[plain]{Wh $+$ to --}
 \begin{tblr}{colspec={ll}}
  \Circled[fill color=yellow!20]{ how to $+$ 動詞の原形 }&どのように～したらいいか、～する方法\\
  \Circled[fill color=yellow!20]{ when to $+$ 動詞の原形 }&いつ～したらいいか\\
  \Circled[fill color=yellow!20]{ where to $+$ 動詞の原形 }&どこで（どこへ）～したらいいか\\
  \Circled[fill color=yellow!20]{ what to $+$ 動詞の原形 }&なにを～したらいいか\\
  \Circled[fill color=yellow!20]{ who to $+$ 動詞の原形 }&だれを～したらいいか\\
  \Circled[fill color=yellow!20]{ which to $+$ 動詞の原形 }&どちら（どれ）を～したらいいか
   \end{tblr}
\end{frame}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\begin{frame}[plain]{Exercises}

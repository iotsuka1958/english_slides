...
\end{frame}
%%%%%%%%%%%%%%%%%%%%%%
\section{Listen, Then Read\,\,\,\,\,{\tiny 0034}\,{\scriptsize \myaudio{./audio/035_wh_to_do_reading.mp3}}}
%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\begin{frame}[plain]
...
\includegraphics[width=1.01\textwidth]{./infographic/035_wh_to_do_infographic.png}
\hfill{\tiny audio\_overview 1715}\,{\scriptsize \myaudio{./audio/overview/035_wh_to_do_audio_overview.m4a}}%
\hfill{\tiny eduop\_boys 0246}\,{\scriptsize \myaudio{./audio/manzai/035_wh_to_do_manzai.mp3}}
\end{frame}
%%%%%%%%%%%%%%%%%%%%%%
...
\begin{columns}
 \begin{column}{0.4\textwidth}
  \includegraphics[width=1.1\textwidth]{./test_forms/035_wh_to_do_test.png}
 \end{column}
...
\url{https://forms.gle/KsSSsLUN3FpQaFiSA}
\end{frame}
%%%%%%%%%%%%%%%%%%%
\end{document}

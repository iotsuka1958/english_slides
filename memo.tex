...
さて、昨日7日は、
千葉県にレベル4大雨危険警報とレベル4土砂災害危険警報が発表されました。
県内では大網白里市などで8月に続き再び冠水が起きたほか、館山市では複数箇所で土砂崩れの被害が確認されました。
きょうも内房線や外房線など一部の区間で運転見合わせとなっているようです。
今後も雨が降り、雷を伴うおそれがあるとのことです。
風が強く吹く地域もあるようです。
まだまだ天気が悪い日が続きそうです。
...
また、現在、気温も30度を超えて蒸し暑くなっており、熱中症対策をしっかり行ってください。

\bigskip

大雨の影響は、わたしたちの授業にもおよんで、一部授業が休講になりました。
きょうは、いつもどおり、
この英語の時間は、千葉市の幕張からお送りしたいと思います。

...
きのうから英語の授業がスタートしましたが、
いかがでしたか。

まだペースがつかめないという人もいるとおもいます。
実はわたしもそのひとりです。
...
\newpage
%%%%%%%%%%%%%%%%%%%
ffmpeg -i hoge.mp4 -vf "subtitles=hoge.srt:charenc=UTF-8" -c:v libx264 -crf 18 -preset slow -c:a copy hoge\_with\_subtitle.mp4

...
それでは、きょうの一コマ目、「{\gtfamily\bfseries 熱中症対策講座}」を始めます。
まず、本日の講師の先生をご紹介します。
...
それでは、\ruby{中塚}{なか|つか}\ruby{雄大}{ゆう|だい}先生、どうぞ
よろしくお願いします。

※講師がチャット上の質問を取り上げて対応する場合あり。
講師によっては、読み上げを頼まれる可能性も

\subsection*{講座終了後}
\ruby{中塚}{なか|つか}\ruby{雄大}{ゆう|だい}先生、ありがとうございました。

みなさん、お礼の気持ちを込めて拍手をお願いします。
...
それでは、\ruby[g]{佐々木}{ささき}\ruby{純子}{じゅん|こ}先生、
どうぞよろしくお願いします。

\subsection*{講座終了後}
\ruby[g]{佐々木}{ささき}\ruby{純子}{じゅん|こ}先生、ありがとうございました。

...
さて、いつもは千葉市の幕張からお送りしているこの時間ですが、
きょうは千葉市の中央区からお送りしています。
こちらの音声はちゃんと届いていますか。
...
台風6号が近づいていますね。
今日の昼過ぎにかけて関東に接近する見込みで、強まる雨風に厳重な警戒が必要です。

千葉県内各地で、停電が発生しているとの情報もあります。
2,000軒弱でしょうか停電しているようです。
どうかみなさん安全第一でお過ごしください。


配信状況も悪くなるかもしれません。
なにか、おかしいなというようなことがあったら、
メッセージで教えてください。
%朝から暑くなっています。
%湿度も高くなってきました。
%本格的な夏に向かうこの時期、
...
%きょうで今週も終わりです。あともう少しで週末に突入です。それをたよりに、のりきっていければいいなとおもっています。
%といいますか、この時間は3時間目。
%ということは、これがみなさんにとって今週最後の授業というわけです。あともう少しですね。
%週末はすぐそこまできています。
...
あまり無理をせずに、
安全第一に参加ください。
もちろん授業はたいせつですが、いちばんだいじなのはみなさんの安全です。
そのことを確認したうえで、授業をスタートします。
%ご自身のペースで参加してください。
これまで同様、気負わず、肩の力を抜いて、

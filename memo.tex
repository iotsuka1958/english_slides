...
ところで、あすは立春です。「春が立つ」と書いて\kenten{立春}。旧暦で春が始まる日が立春ですよね。きょうはその前日、つまり立春の前日にあたります。ですから、きょうは\kenten{節分}です。文字どおり「季節の分かれ目」ということですね。古くから、季節の変わり目には邪気や災いがやってくると考えられてきました。

そんなことで、豆まきが思い浮かぶ人もいるでしょう。
「鬼は外、福は内」という掛け声と共に豆をまくことで、家庭の中に悪いものが入らないように祈ると同時に、年齢の数だけ豆を食べることで、健康を祈るという風習です。
昔の風習ですから今は廃れたかと思いきやそうでもないようです。
スーパーマーケットに行くと、節分の豆とか鬼のお面とかがセットになった商品が売られています。

でも、鬼が平和に暮らしているのであれば、鬼には少し気の毒な感じがしなくもありません。

最近は恵方巻を食べるご家庭もあるようですね。

きょうは立春の前日、節分だというお話でした。


幕張はきれいに日が射していますが、
それでもあいかわらず寒いです。
空気が乾燥しています。
加湿器やハンドクリームを活用するなど乾燥対策はシッカリと行ってください。
暦の上では季節の分かれ目でも、冬の寒さが続きます。
万全な防寒でお過ごしください。


%インフルエンザも流行しているそうです。
%ということで、どうか、みなさん、かぜなどひかぬよう、あたたかくして参加してください。
%引き続き、健康管理にはじゅうぶんお気をつけください。
...
%きょうは水曜日ですから、折り返し地点です。今週の授業はきょうをいれてあと3日です。
%なんとか今週の折り返し地点まできましたね。

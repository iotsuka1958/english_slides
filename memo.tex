...
%今日は雨の降りやすい天気のようです。
きょうの幕張は、
朝は雨が降っていましたが、いまはやんでいます。
%きのうほど気温は高くありませんが、湿度が高く、不快な感じがします。

気温はそれほど高いというわけではありませんが、
湿度が高く、
%きょうの幕張は気温があまり高くありません。
すこし蒸し暑く感じます。
...
%なんとか今週の折り返し地点まできましたね。今週の授業はきょうをいれてあと3日です。
%なかなか微妙な日ですよね。
...
あ、ところできょう\mytoday{}、数字にすると20260609、ニセンニジュウロクマン・ロッピャクキュウですが、
実はprime number、素数です。これをたよりに、わたしはきょうを乗り切ろうとおもいます。
これまで同様、気負わず、肩の力を抜いて、

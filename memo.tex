...
\paragraph{sampling rate変更} \verb|multi_format_converter.sh wav mp3|
...
気温もこの時期にしては低めで、肌寒い感じです。
気圧も低めなので、体調がいまひとつという方もいらっしゃるかもしれません。。

%インフルエンザも流行しているそうです。
%いま雨は降っていませんが、
%地域によっては雨が降っているところもあるかもしれません。
%朝はかなり低く寒かったですが、今は寒さも少し和らいでいます。
%みなさんのお住まいの地域はいかがでしょうか。
%花粉症にお悩みの方いらしゃるとおもいますが、
%万全の対策をお願いします。
%外出した際には衣類などについた花粉を家の中に持ち込まないこともたいせつです。
気温が高い日もあれば低いもあるということで、
どうか体調管理を万全に行ってください。

%みなさんのお住まいの地域はいかがでしょうか
%何か温かい飲み物でも用意するのもいいとおもいます。

%これを頼みに、今週を乗り切れればいいなとおもっています。

さて、今週からスタートしましたが。
みなさんいかがでしょうか。
ちょっと疲れたなという人もいるとおもいます。
わたしも、第1週ということで、緊張しました。

\bigskip


でも、きょうが終われば5連休が待っています。
授業が始まり、お疲れの人もいることとおもいます。
このゴールデンウィークは、ぜひのんびりと心と体を休めて、
おいしいものでも食べて、
リラックスしておすごしください。
つかれた心と体をリフレッシュするいい機会にしてください。
...
ところで、ひとつ事務的な連絡です。
あすから連休がスタートしますが、
連休明けの5月7日の木曜日の授業について、連絡します。

5月7日は木曜日ですが、
月曜の時間割になりますので注意してください。
...
（1・2年のみ）
曜日変更だけでもまちがいやすいのですが、
さらに、みなさんに注意してほしいことがあります。

通常は、月曜日は英語の時間はないので、
5月7日木曜日は月曜日課なら、5月7日は英語の授業がないはずですよね。

ところが、
5月7日については、社会の時間が英語に変更になります。
授業の変更があるので注意してください。

\hrulefill


なお、このことは毎朝アップされる掲示板にも掲載されています。
毎日、授業の前に掲示板を覗くようにお願いします。
ためになる、おもしろい情報がのっています。

事務的な連絡を申し上げました。

では、みなさん、肩の力を抜いて、ゆったりとした気持ちで、参加してください。
それでは、そろそろきょうの英語の時間、スタートしましょう。
40分間おつきあいください。

\bigskip

\noindent{}1年：pronunciation\_vowel.pdf(授業の進め方) $+$ orientation\_2.pdf\\
2年：pronunciation\_vowel.pdf(授業の進め方 $+$ /ae/) $+$ 018\_why\\
3年：pronunciation\_{}tips $+$ 041\_as\_as
...
%今週の授業もきょうと明日の2日となりました。ちょっぴり先が見えてきた感じ。あともう一息というところです。
...
%なんだかやる気がでないという人もいるとおもいますが、
%いまここに参加しているだけでもうじゅうぶん。
...
\paragraph{資料準備}
\begin{enumerate}
 \item AdobeでスライドをFull Screenに
 \item Opening VideoをChromeのTabへ
 \item あいさつ読み原稿(Evince)
 \item スライド手持ち(Sumatrapdf)
\end{enumerate}
...
\paragraph{資料の共有準備}
\begin{enumerate}
 \item 共有でスライドのwindowを共有
 \item 共有でOpening VideoのTabを選択
 \item Tab Audioの共有をOFF
 \item このまま待機
 \item 開始時刻直前にShare、MicをON
 \item Opening Videoをrun
\end{enumerate}

\begin{enumerate}
 \item Opening Videoが流れたら
 \item 共有でスライドを選択、待機
 \item Opening Videoが終わったら
 \item スライドをShare、CameraをON
 \item 話し始める
\end{enumerate}

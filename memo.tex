...
今季最強・最長寒波が襲来するとのことですね。
今回の寒波は長く居座ることが特徴で、気象庁によると
数年に一度レベルの長さとなる恐れがあるそうです。
あす21日(水)から25日(日)頃にかけて強い冬型の気圧配置が続き、
日本海側では大雪が5日以上続く見込みだそうです。
また、太平洋側にも雪雲が流れ込み、
関東地方でも雪の降る可能性があるそうです。
風も強いと寒さがこたえそうですね。
...
さて、
遠い昔の1265年の今日1月20日、
イギリスで現代の議会制度の基礎となる最初の議会がロンドンのウェストミンスター・ホールで開かれました。
これは、様々な立場の人々が協力して国の未来を話し合う、
民主主義の原点ともいえる大切な一歩といわれています。
日本は鎌倉時代ですね。
いまから761年前のできごとでした。

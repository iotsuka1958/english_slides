...
この時間は、いつもどおり千葉市の幕張からお送りしていますが、
こちらの音声は届いていますか？
音声が届いていることが確認できて、一安心です。

%なかなか天気が安定しませんね。
%きょうも幕張は朝からしっかり雨が降っています。
%きょうはこのあともずーっと雨の予報です。
きょうは、雨は降っていませんが、
雲が広がっています。
にわか雨もありそうな感じです。
...
%みなさんも油断することなく、引き続きニュースや自治体の避難情報にご注意ください。
%万が一、避難が必要な状況になったり、危険を感じたりした場合は、
%自分の安全を最優先にしてすぐに避難してください。
%熱中症対策をしっかり行ってください。
気温は23度くらいですが、湿度が高いようです。
季節の変わり目ということで体調を崩しやすい時期です。
引き続き、体調管理をよろしくお願いします。
...
%きょうの幕張ですが、
%朝からどんよりとくもっています。
%みなさん、熱中症対策、しっかりおこないましょう。
%エアコンを適切に利用して、
%喉が渇いたなとおもうまえに、こまめな水分補給も忘れずにお願いします。


\bigskip


%さあ、今週から2学期の授業がはじまりましたが、
%やっと金曜日、ということで、
%第1週もきょうで終わりです。
%あともう少し。
%英語は、この時間を含めて、あと2時間ということになりました。
さて、きょうは\DOWjpn{}曜日。
%今週の折り返し地点まできましたね。
%今週もきょうと明日の2日ということになりました。
%今週もきのうはじまったばかりで、この先が長い感じがしますね。
今週も今日でおわりです。
それにあすから5連休ですね。
ただ、この連休、台風が接近することにより、天気が荒れそうです。
どうぞお気をつけつつも、楽しくお過ごしください。
%それをたよりに今週を乗り切れればいいとおもいます。
%ただ、わたしたちの授業も今週で一段落ですね。
%ということはきょうをいれて、今学期の授業はあと2日ということになりました。
%今週の授業はきょうをいれてあと2日です。
%なかなか微妙な日ですよね。
%これは3時間目ですから、この時間が終われば、あと1日です。
%今週の授業もきょうと明日の2日となりました。%
%これは木曜日の3時間目ですから、この時間が終われば、あと1日です。
%ちょっぴり先が見えてきた感じ。あともう一息というところです。
%きょうで今週も終わりです。
%それをたよりに、のりきっていければいいなとおもっています。
%といいますか、この時間は3時間目。
%これがみなさんにとって今週最後の授業というわけです。あともう少しですね。
%週末はすぐそこまできています。
%みなさんもこれが今週最後の時間ですね。
%待ちに待っていた、かどうかまではわかりませんが、
%この時間で今週の授業も終わりということです。
%あともう少しで週末に突入です。
%やる気があまり出ないという人もいるかとおもいますが、この授業を聞いているみなさんは、いまここに参加しているだけでじゅうぶん。りっぱです。

%さあ、最後のあと二日、あせることなく、ゆっくりと取り組んでいけばいいですね。
...
それでは、そろそろ、ゆるゆるとスタートします。
画面を切り替えるのでお待ちください。


{\jfontspec{Batang} A quick brown fox jumps over the lazy dog.\UTF{c544}아뇨하세요}

{\fontspec{Comic Neue Regular} A quick brown fox jumps over the lazy dog.}

{\fontspec{Times New Roman} A quick brown fox jumps over the lazy dog.}

{\fontspec{Georgia} A quick brown fox jumps over the lazy dog.}

{\fontspec{Garamond} A quick brown fox jumps over the lazy dog.}
%{\fontspec{Palatino} A quick brown fox jumps over the lazy dog.}\\[1.5em]

{\fontspec{Arial} A quick brown fox jumps over the lazy dog.}

%{\fontspec{Helvetica} A quick brown fox jumps over the lazy dog.}\\[1em]
{\fontspec{Segoe UI} A quick brown fox jumps over the lazy dog.}
%{\fontspec{Futura} A quick brown fox jumps over the lazy dog.}\\[1.5em]

% --- 等幅フォント (Monospace) ---
{\fontspec{Courier New} A quick brown fox jumps over the lazy dog.}

{\fontspec{Consolas} A quick brown fox jumps over the lazy dog.}

% --- スクリプト・手書き風 (Script / Decorative) ---
{\fontspec{Comic Sans MS} A quick brown fox jumps over the lazy dog.}
%{\fontspec{Brush Script MT} A quick brown fox jumps over the lazy dog.}

%{\fontspec{Roboto-Regular.ttf} A quick brown fox jumps over the lazy dog.}
\bigskip
...
\noindent{}%
\begin{tabular}{ll}
1年：&\url{999quiz_full_version.pdf} $+$ 003\_be.pdf\\
&{\url{video/slide/1_003_be_slides.mp4(0821)}}\\
&{\url{audio/manzai/003_be_manzai.mp3(0422)}}\\
&{\url{audio/overview/003_be_audio_overview.m4a(1155)}}\\
&テスト\\
2年：&pronunciation\_vowel.pdf(\textipa{/\textscripta /}) $+$ 019\_what.pdf\\
&{\url{video/slide/1_019_what_slides.mp4(0855)}}\\
&\textcolor{red}{\sout{\url{audio/overview/018_why_audio_overview.m4a(1519)}}}\\
&\url{audio/manzai/018_why_manzai.mp3(0244)}\\
&{テスト}\\
3年：&pronunciation\_{}tips.pdf $+$ 041\_as\_as.pdf\\
&\textcolor{red}{\sout{\url{video/slide/2_041_as_as_slides.mp4(0707)}}}\\
&\url{audio/overview/041_as_as_audio_overview.mp4(1305)}\\
&\url{audio/manzai/041_as_as_manzai.mp3(0256)}\\
&テスト\\
\end{tabular}

%
%卒業式を英語ではcommencementといいます。
%commencementはもともとは「最後、しめくくり」という意味で、
%だから卒業式---というのはまちがいです。
%
%実はcommencementの本来の意味は「開始、はじまり」です。
%
%卒業をもって、これから新しい生活が始まるという、きわめて前向きな発想なのです。
%みなさんの新しい生活が素敵なものになるよう祈っています。
%
%それではみなさんごきげんよう
...
%\begin{itemize}\large
% \item meetを開くタイミングは？
% \item 講師とは、事前のやりとりはないということでいいか（講座のはじまりにいきなり、こちらが口火を切るということでいいか）
% \item そのことは講師も承知しているのか
% \item 講座のクロージングについて、案では、講義終了後、講師に一言お礼をいってから、生徒へのアンケート案内、続く講座の紹介があって、その後講師への、再度お礼という流れ
% \item アンケート案内や次の講座紹介のあいだ、講師を待たせることになるが、講義終了後、講師にはお礼をしっかり述べて退出いただき、そのあと、生徒へのアンケート依頼および次の講座案内ではいけないか（アレンジ不可なのか、そこはうまくやれよということでいいのか）
% \item アンケートのリンクをチャットで送るんだけど、
% \item meet自体を閉じるタイミングは？
%\end{itemize}
%
%始業式10:05開始
%
...
%%%%%%%%%%%%%%%%%%
%\newpage
\subsection*{2026-08-26午前の部11:00}
みなさん、こんにちは！
「エデュオプちば」夏期特別講座にご参加ありがとうございます。

%特別講座では、みなさんの``気になること''や``興味あること''を集めた内容となっています。
\bigskip

それでは、きょうの一コマ目は、「{\gtfamily\bfseries 熱中症対策講座}」です。

まず、本日の講師の先生をご紹介します。

{\gtfamily\bfseries 大塚製薬ニュートラ\kenten{シュ}ーティカルズ事業グループ \ruby{中塚}{なか|つか}\ruby{雄大}{ゆう|だい}} 先生です。

地域や学校で、健康づくりや熱中症予防について伝える活動に取り組んでいらっしゃいます。
みなさんが残暑を元気に過ごせるよう、熱中症を防ぐためのポイントや、
上手な水分補給の方法などをわかりやすくお話ししてくださいます。

それでは、{\gtfamily\bfseries \ruby{中塚}{なか|つか}\ruby{雄大}{ゆう|だい}} 先生、どうぞ
よろしくお願いします。

\vspace{20pt}

\subsection*{講座終了後}
{\gtfamily\bfseries \ruby{中塚}{なか|つか}\ruby{雄大}{ゆう|だい}} 先生、ありがとうございました。
熱中症を防ぐためのポイントや、
上手な水分補給の方法などをわかりやすくお話しくださいました。

みなさん、拍手やチャットでのお礼のことばをお願いします。

先生、どうもありがとうございました。

\bigskip

さて、みなさんには、引き続き2つ連絡があります。

みなさんの感想を教えてください。チャットで送ったリンクから、アンケートにご協力をお願いします。
urlはストリームにも掲載しています。

2点目です。
午後の講座についてですが、
タイトルは「{\gtfamily\bfseries 社会についてくわしく学ぼう!
～世の中のサービスや会社の取り
組みから学んでみよう!～}」です。
開始時刻は午後1時です。

アンケートが終わった人は、退室してください。

みなさん、ご参加ありがとうございました。

\begin{itemize}
%    \item （小学生講座）\\
%    \url{https://docs.google.com/forms/d/e/1FAIpQLSdbyyMrphv-VeIQ_g4KylZsCgXZZyUTC5hM_u-LsFAecsx8JA/viewform?usp=header}
    \item （中学生講座）\\
    \url{https://docs.google.com/forms/d/e/1FAIpQLSf2zOHWW8i_vWztF0kO7TAJAtAZJN2T8V4sRg2r28TmqOGWmQ/viewform?usp=header}
...
\subsection*{2026-08-26午後の部13:00}
みなさん、こんにちは！
「エデュオプちば」夏期特別講座にご参加ありがとうございます。

%この特別講座は、みなさんの``気になること''や``興味あること''を集めた内容となっています。
\bigskip

それでは、午後の講座「{\gtfamily\bfseries 社会についてくわしく学ぼう!
～世の中のサービスや会社の取り
組みから学んでみよう!～}」を始めます。

まず、本日の講師の先生をご紹介します。

{\gtfamily\bfseries 株式会社Values Fusionの\ruby[g]{佐々木}{ささき}\ruby{純子}{じゅん|こ}} 先生です。
会社や仕事の世界を全国の学校に届けていらっしゃいます。
本日は、身近な例をもとに、世の中のサービスのしくみをわかりやすく紹介くださいます。

それでは、{\gtfamily\bfseries \ruby[g]{佐々木}{ささき}\ruby{純子}{じゅん|こ}} 先生、
どうぞよろしくお願いします。

\vspace{20pt}

\subsection*{講座終了後}
{\gtfamily\bfseries \ruby[g]{佐々木}{ささき}\ruby{純子}{じゅん|こ}} 先生、ありがとうございました。
身近な例をもとに、世の中のサービスや会社の取り組みという角度から、
社会のしくみをわかりやすく紹介いただきました。
さまざまな発見があったこととおもいます。

みなさん、お礼の気持ちを込めて拍手をお願いします。チャットでもお礼のことばをお願いします。

{\gtfamily\bfseries 株式会社Values Fusionの\ruby[g]{佐々木}{ささき}\ruby{純子}{じゅん|こ}} 先生でした。
先生、ありがとうございました。

\bigskip

さて、みなさんには、引き続き2点連絡があります。

みなさんの感想を教えてください。チャットで送ったリンクからアンケートにご協力をお願いします。

2点目です。
明日の講座についてですが、
「{\gtfamily\bfseries みんなでSNSの話をしよう}」、
「{\gtfamily\bfseries 千葉市動物公園オンライン授業 飼育員のお仕事}」
の\ruby{二}{ふた}講座です。
あすの開始時刻は午後1時です。

アンケートが終わった人から、退室してください。
...
\verb*|npm view @google/gemini-cli version|

\verb*|npm install -g @google/gemini-cli@latest|

\verb*|gemini extensions list|

\verb*|gemini extensions update nanobanana|

\subsection*{audio関係}

\paragraph{音声ファイル全般作成} inputファイルはssmlファイル。モデルはNeural2系のみ

\verb|google_text2speech.py input.txt output.mp3|

\verb|gsay input.txt output.mp3|

\paragraph{発音練習用音声ファイル作成}inputファイルはプレーンテキスト

\verb|lesson_audio_generator.py input.txt output.mp3|

\verb|-v en-US-Neural2-C|

\verb|-r 1.0|

\verb|-b 1.5s|

\paragraph{音声ファイルの情報表示} sampling rateとdurationを表示

\verb|get_audio_info.sh|

\paragraph{音声・動画ファイル再生} \verb|my_media_player.sh|

\paragraph{mp3ファイルのsampling rateを22050に変更} \verb|mp3_resample_22k.sh|

\paragraph{音声ファイルの形式変更} \verb|multi_format_converter.sh wav mp3|

\paragraph{Google TTSの音声一覧} 　
...
音声名 (Name) & 性別 \\
\texttt{en-US-Neural2-A} & \textbf{男性} \\
\texttt{en-US-Neural2-C} & \textbf{女性} \\
\texttt{en-US-Neural2-D} & \textbf{男性} \\
\texttt{en-US-Neural2-E} & \textbf{女性} \\
\texttt{en-US-Neural2-F} & \textbf{女性} \\
\texttt{en-US-Neural2-G} & \textbf{女性} \\
\texttt{en-US-Neural2-H} & \textbf{女性} \\
\texttt{en-US-Neural2-I} & \textbf{男性} \\
\texttt{en-US-Neural2-J} & \textbf{男性} \\
\end{tblr}
\hspace{10pt}%
\begin{tblr}{
  colspec = {l l},
...
音声名 (Name) & 性別 \\
\texttt{ja-JP-Neural2-B} & \textbf{女性} \\
\texttt{ja-JP-Neural2-C} & \textbf{男性} \\
\texttt{ja-JP-Neural2-D} & \textbf{女性} \\
\end{tblr}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\newpage
...
\begin{tabular}{llll}\toprule
 ...
 be動詞&be&
    ...
    $\left.\begin{tabular}{l}
     I\\
     you / （\,I / you以外の）複数\\
     \hspace{28.4pt}（\,I / you以外の）単数\\
    \end{tabular}\right.$ \\\midrule
 一般動詞&like&
    $\left\{\begin{tabular}{ll}
     like\,\,\,($=$\,原形と同じ)& \\
     likes\,($=$\,原形 $+$ s\,)& \\
...
\paragraph{資料準備}
\begin{enumerate}
 \item Adobeでスライドを読み込みFull Screenに
 \item Opening動画をChromeのTabへ \url{my_chrome opening/opening_scene_whole.mp4}
 \item あいさつ読み原稿を表示 \url{evince memo.pdf\&} 
 \item スライド手持ちを表示(Sumatrapdf)
 \item 時計表示
\end{enumerate}

\paragraph{Classroom準備}
\begin{enumerate}
 \item ClassroomからMeetのページへ
 \item 自分のCameraをOFF
 \item Micは生きているか、audio音声が流れるか確認$\longrightarrow$\,MicをOFF
 \item 会議に参加
 \item 参加者の画面共有・Mic・CameraをすべてOFF
 \item MeetでOpening動画のTabを共有(Audioの共有をOFF)してShare
 \item Opening動画のTABに移動
 \item picture in pictureをlaptopの画面へ
\end{enumerate}

\paragraph{Opening}
\begin{enumerate}
 \item 開始時刻直前にMicをON、Opening動画をrun
 \item (Opening動画が終わったら)CameraをON、あいさつ
 \item あいさつが終わったらCameraをOFF、スライドを共有
\end{enumerate}
\end{document}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\newpage
...
%%%%%%%%%%%%%%%%%%%%%
\newpage
「不測かつ突発的な事故による、フローリングの破損・汚損についてのご報告です。

事故が起きたのは昨年、2025年の10月20日頃です。
留守中にペットが大型の水飲みボウルをひっくり返してしまい、
フローリングに大量の水をこぼすという突発的な事故がありました。
すぐに拭き取りましたが、数日経って該当箇所の床がブカブカとたわんでいることに気づきました。
すぐに修繕業者のウェブサイトから調査依頼の連絡をし、
10月23日に業者から返信メールを受け取っています。
これが事故直後に手配へ動いた客観的な証拠として残っています。

その後、11月6日に業者の現地調査が行われ、フローリングのたわみが確認されました。
修繕工事の日程調整に入りましたが、年末年始を挟んだことや双方のスケジュール都合により、
実際の作業開始は年明けの1月19日となりました。
1月19日の作業で業者がたわんだフローリングを剥がしたところ、床下に多量の水分が残っていることが判明しました。

1月19日の初回の作業で、業者がたわんだフローリングを剥がしたところ、床下に多量の水分が残っていることが判明しました。

その際、現場の業者から『これだけ濡れている以上、配管からの漏水がないか確認してからでないと、張り替えても再発する可能性がある。本日の作業はここで中断し、漏水調査の結果を待ってから再度工事に入りましょう』と、作業の中断を告げられました。

つまり、漏水調査を行わなければ修繕工事そのものが進められない状況になったため、
同日、管理組合手配の漏水調査会社に緊急で調査を依頼しました。

耐圧検査の結果、配管に異常はなく、
修繕業者からも『10月にこぼれた生活水が床下に回り込んで抜けずに溜まっていたことによる、突発的な水濡れ・たわみである』と推測され、2月2日に無事、修繕工事が完了しました。

つきましては、修繕費用の66,000円と、
修繕を完了させるための必須工程として業者の指示で実施した漏水調査費用、自己負担分45,100円について、免責金額の5万円を踏まえたうえで、保険金の請求をお願いいたします。

\begin{tcolorbox}[title=調査費用は対象外]
【回答の鉄則：業者の指示による『復旧の必須要件』であることを突きつける】

「いいえ、今回の調査費用はフローリングを復旧させるための必須費用として請求させていただきます。1月19日に床を開口した際、業者が『これだけ濡れている以上、配管漏水の有無をクリアにしない限り、張り替えても再発の恐れがあるため工事は進められない』と作業を中断しました。
つまり、この漏水調査は私が念のため行ったのではなく、プロの業者が原状回復工事を行うための『絶対条件』として指示した必須工程です。結果論として漏水がなかっただけで、この調査を経なければ修繕が完了しなかった以上、実質的な修繕費用の一部として認めていただくべきものです。」
\end{tcolorbox}

\begin{tcolorbox}[title=日付の曖昧さと被害拡大（放置）の疑いについて]
査定担当者: 「業者へネットで連絡をした正確な日付はいつですか？ 事故から連絡、そして実際の着工（1月19日）までに日数が大きく空いているため、放置による被害拡大とみなされる可能性があります。」

あなたの回答: 「フォームから送信した正確な日付は失念しましたが、10月22日頃で、たわみに気づいてすぐに連絡を入れました。その証拠として、翌10月23日付で業者から届いた返信メールが手元にあります。また、11月6日には業者の現地調査を受け、修繕範囲は確定していました。その後の着工が1月になったのは業者側のスケジュール都合等であり、私自身が放置して損害を拡大させた事実はありません。」
\end{tcolorbox}

\begin{tcolorbox}[title= 経年劣化の疑いについて]
査定担当者: 「10月の事故なのに、1月の時点でまだ水が残っているのは不自然です。ペットの水ではなく、日常的なお風呂上がりの水濡れ（経年劣化）が原因の蓄積ではないですか？」


あなたの回答: 「日常的な水濡れの蓄積ではありません。マンションの直貼りフローリングのサネ（隙間）から裏側へ大量の水が流れ込むと、密閉状態になるため数ヶ月経っても自然乾燥しません。1月19日の開口時に水が多量に残っていたのは、あの日一気に大量の水が入り込んで抜け道がなかった証拠です。業者の見積書にもプロの見解として『生活水等のこぼれによる突発的な水濡れ』と明記されています
\end{tcolorbox}
...
%\fbox{%
\scalebox{1.2}{\bfseries%
\begin{tblr}{
  colspec = {|[1pt]Q[r,0.9cm]|Q[r,0.9cm]|Q[r,0.9cm]|Q[r,0.9cm]|Q[r,0.9cm]|Q[r,0.9cm]|Q[r,0.9cm]|[1pt]}, 
  column{1} = {fg=Tomato},       % Sunday column default
  column{7} = {fg=DodgerBlue},   % Saturday column default
  hline{3-6} = {0.5pt},
  hline{1,2,Z} = {1pt},
}
  Sun & Mon & Tue & Wed & Thu & Fri & Sat \\
  \textcolor{Tomato}{3/1} &   2 &   3 &   4 &   5 &   6 &   \textcolor{DodgerBlue}{7} \\
  \textcolor{Tomato}{8} &   9 &   10 &   11 &   12 &   13 &   \textcolor{DodgerBlue}{14} \\
  \textcolor{Tomato}{15} &   16 &   17 &   18 &   19 &   \textcolor{Tomato}{20} &   \textcolor{DodgerBlue}{21} \\
  \textcolor{Tomato}{22} &   23 &   24 &   25 &   26 &   27 &   \textcolor{DodgerBlue}{28} \\
  \textcolor{Tomato}{29} &   30 &   31 &   4/1 &   2 &   3 &   \textcolor{DodgerBlue}{4} \\
\end{tblr}
}}%}
...
\begin{tblr}{
  ...
  Sun & Mon & Tue & Wed & Thu & Fri & Sat \\
  \textcolor{Tomato}{3/29} &   30 &   31 &   4/1 &   2 &   3 &   \textcolor{DodgerBlue}{4} \\
  \textcolor{Tomato}{5} &   6 &   7 &   8 &   9 &   10 &   \textcolor{DodgerBlue}{11} \\
  \textcolor{Tomato}{12} &   13 &   14 &   15 &   16 &   17 &   \textcolor{DodgerBlue}{18} \\
  \textcolor{Tomato}{19} &   20 &   21 &   22 &   23 &   24 &   \textcolor{DodgerBlue}{25} \\
  \textcolor{Tomato}{26} &   27 &   28 &   \textcolor{Tomato}{29} &   30 &   5/1 &   \textcolor{DodgerBlue}{2} \\
\end{tblr}
}}%}
...
\begin{tblr}{
  ...
  Sun & Mon & Tue & Wed & Thu & Fri & Sat \\
  \textcolor{Tomato}{4/26} &   27 &   28 &   \textcolor{Tomato}{29} &   30 &   5/1 &   \textcolor{DodgerBlue}{2} \\
  \textcolor{Tomato}{3} &   \textcolor{Tomato}{4} &   \textcolor{Tomato}{5} &   \textcolor{Tomato}{6} &   7 &   8 &   \textcolor{DodgerBlue}{9} \\
  \textcolor{Tomato}{10} &   11 &   12 &   13 &   14 &   15 &   \textcolor{DodgerBlue}{16} \\
  \textcolor{Tomato}{17} &   18 &   19 &   20 &   21 &   22 &   \textcolor{DodgerBlue}{23} \\
  \textcolor{Tomato}{24} &   25 &   26 &   27 &   28 &   29 &   \textcolor{DodgerBlue}{30} \\
  \textcolor{Tomato}{31} &   6/1 &   2 &   3 &   4 &   5 &   \textcolor{DodgerBlue}{6} \\
\end{tblr}
}}%}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\end{document}
...
% 金星
\draw[fill=yellow!50!orange] (5,0) circle (0.4);

% 地球
\draw[fill=blue] (7,0) circle (0.5);

% 火星
\draw[fill=red] (9,0) circle (0.4);

% 木星
\draw[fill=brown] (12,0) circle (0.8);

% 土星
\draw[fill=yellow!70!orange] (15,0) circle (0.7);
\draw[fill=gray] (15,0) ellipse (1.2 and 0.4); % 土星の輪

% 天王星
\draw[fill=LightBlue] (18,0) circle (0.6);

% 海王星
\draw[fill=blue!70] (21,0) circle (0.5);
...
連絡のありました年末調整関係の書類を提出します。

なお、併せて、公立学校共済組合の「予防接種補助金請求書」を提出するので、
お手数ですが、手続きについてよろしくお願いします。
...
%%%%%%%%%%%%%%%
\newpage
文教の先生がたには、日ごろから応援いただき心強く思っております。

現状において、特段こまっているようなことはない。

議会で取り上げていただくことは、われわれスタッフにとっては励みとなるのはもちろんだが、
わたくしどもの試みについてひろく県民のみなさまに知っていただくこととなり、いろいろなお子さんがいるなかで、微力ながらもそういったお子さんへの支援につながるとおもうので、引き続き応援いただけるとありがたい
%%%%%%%%%%%%%%%%%%%
\newpage
...
- *登場人物 A：** 明るく元気で、解説のメイン進行役。非常にポジティブで、生徒を励ますのが得意なアメリカ育ちのお兄さん。
- **登場人物B：** ノリが良く、生徒の目線に立って「それってどういうこと？」「ここが分からない！」といった素朴な疑問を投げかけたり、登場人物Aの解説に面白いツッコミを入れたりする日本育ちのお姉さん。
...
# 制約条件
- **台本構成：**
    - 登場人物Aがメインで解説を進め、もうひとりの登場人物Bが相槌や生徒の代弁者としての質問、ツッコミを入れる掛け合い形式で進行してください。
...
- **解説の内容：**
    - 正解の説明だけでなく、そのテーマで中学生が陥りがちな間違いをわざと間違えてみせ、相方がそれを正すといった形で具体的に指摘してください。（例：受動態ならbe動詞を忘れる、現在完了形ならhave/hasを忘れるなど）
- **モチベーション向上：**
...
- **英語の品質：** 標準的なアメリカ英語を基準とし、中学生が聞き取りやすいよう、少しゆっくり、かつ明瞭な発音を想定してください。
- どぎつい原色は使わず、落ち着いた色調で作成してください。イラストは雑誌The new YorkerやVogueのように、都会風のしゃれたクールなイラストにしてください
# 入力
【テーマ】疑問詞which

...
あすから時間割が変更になります。
詳細については学年の掲示板の授業のタブに
変更後の時間割がアップされるので、
そちらを参照してください。

あわせて、学年の掲示板にはいろいろな情報が掲載されるので、
毎日確認するといいとおもいます。
わたしはその日のはじめに掲示板を確認するようにしています。

あすからの時間割変更のお知らせでした。

\bigskip

午前４時37分銚子地方気象台の発表によると、
「関東甲信地方は、高気圧に覆われています。
千葉県は、高気圧に覆われますが、
気圧の谷や湿った空気の影響を受けるため、曇り時々晴れとなるでしょう---とのことです。
みなさんのお住まいの地域の天気はいかがでしょうか。

また、気温もだいぶ高めになってきましたから、
水分補給もお忘れなく。
授業中だからと遠慮する必要はありません。


さて、きょうは水曜日、週のまんなかですね。
あまり無理をしないで、
ご自身のペースでやってください。
気負わず、肩の力を抜いて、
リラックスして参加してください

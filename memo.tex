...
11月4日（火）から7日（金）の4日間、秋の特別講座を実施します。

テーマはいろいろで、落花生についての話、お金の話、
宇宙についての話や海外での貴重な経験談などさまざまです。
千葉県立公立高等学校入学者選抜についての講座も用意されています。

詳しいことは掲示板をご覧ください。

途中入室・退出OKです。自分のペースで参加できますので、
興味関心のある講座があったら、参加してください。

秋の特別講座についてのご案内でした。

さて、きょうは\DOWjpn{}曜日。
%まだ今週もはじまったばかりで、この先が長い感じがしますね。
%今週の折り返し地点ですが、
なんとか今週の折り返し地点まできましたね。
%今週もきょうと明日の2日となりました。ちょっぴり先が見えてきた感じ。あともう一息というところです。
%みなさん、待ちに待っていた、かどうかまではわかりませんが、
